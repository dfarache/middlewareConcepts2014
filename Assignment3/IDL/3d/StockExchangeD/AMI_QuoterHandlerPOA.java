...
public abstract class AMI_QuoterHandlerPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, StockExchangeD.AMI_QuoterHandlerOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 1: // getQuote
			{
				StockExchangeD.Quote _arg0=StockExchangeD.QuoteHelper.read(_input);
				_out = handler.createReply();
				getQuote(_arg0);
				break;
			}
