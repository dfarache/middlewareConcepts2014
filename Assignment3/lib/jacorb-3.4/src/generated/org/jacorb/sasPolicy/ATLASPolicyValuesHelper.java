...
public abstract class ATLASPolicyValuesHelper
{
	...
	{
		java.lang.String tmpResult1276 = s.atlasURL;
out.write_string( tmpResult1276 );
		java.lang.String tmpResult1277 = s.atlasCache;
out.write_string( tmpResult1277 );
	}
}
