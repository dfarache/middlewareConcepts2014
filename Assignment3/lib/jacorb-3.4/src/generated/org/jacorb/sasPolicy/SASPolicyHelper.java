...
public abstract class SASPolicyHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(SASPolicyHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_local_interface_tc("IDL:org/jacorb/sasPolicy/SASPolicy:1.0", "SASPolicy");
				}
			}
		}
		return _type;
	...
	public static org.jacorb.sasPolicy.SASPolicy narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof org.jacorb.sasPolicy.SASPolicy)
		{
