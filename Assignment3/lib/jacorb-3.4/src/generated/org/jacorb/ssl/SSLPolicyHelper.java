...
public abstract class SSLPolicyHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(SSLPolicyHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_local_interface_tc("IDL:org/jacorb/ssl/SSLPolicy:1.0", "SSLPolicy");
				}
			}
		}
		return _type;
	...
	public static org.jacorb.ssl.SSLPolicy narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof org.jacorb.ssl.SSLPolicy)
		{
