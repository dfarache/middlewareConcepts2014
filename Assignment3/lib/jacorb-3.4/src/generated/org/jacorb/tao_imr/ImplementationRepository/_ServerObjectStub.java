...
public class _ServerObjectStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.jacorb.tao_imr.ImplementationRepository.ServerObject
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.jacorb.tao_imr.ImplementationRepository.ServerObjectOperations.class;
	public void ping()
	{
		while(true)
		{
		...
		else
		{
			...
			if( _so == null )
				continue;
			ServerObjectOperations _localServant = (ServerObjectOperations)_so.servant;
			try
			{
				_localServant.ping();
