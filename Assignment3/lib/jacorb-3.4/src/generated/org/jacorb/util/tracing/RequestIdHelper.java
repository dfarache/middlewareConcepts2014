...
/**
 * Generated from IDL alias "RequestId".
 *
 * @author JacORB IDL compiler V @project.version@
 * @version generated at 27-May-2014 20:14:53
 */

public abstract class RequestIdHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(RequestIdHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_alias_tc(org.jacorb.util.tracing.RequestIdHelper.id(), "RequestId",org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.from_int(23)));
				}
			}
		}
		return _type;
	...
	{
		return "IDL:org/jacorb/util/tracing/RequestId:1.0";
	}
