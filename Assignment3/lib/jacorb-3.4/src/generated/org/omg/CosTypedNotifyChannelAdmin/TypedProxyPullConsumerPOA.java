	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosTypedNotifyChannelAdmin.TypedProxyPullConsumerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "offer_change", Integer.valueOf(3));
		m_opsHash.put ( "suspend_connection", Integer.valueOf(4));
		m_opsHash.put ( "obtain_subscription_types", Integer.valueOf(5));
		m_opsHash.put ( "add_filter", Integer.valueOf(6));
		m_opsHash.put ( "disconnect_pull_consumer", Integer.valueOf(7));
		m_opsHash.put ( "remove_filter", Integer.valueOf(8));
		m_opsHash.put ( "remove_all_filters", Integer.valueOf(9));
		m_opsHash.put ( "connect_typed_pull_supplier", Integer.valueOf(10));
	...
	public org.omg.CosTypedNotifyChannelAdmin.TypedProxyPullConsumer _this()
	{
		...
		org.omg.CosTypedNotifyChannelAdmin.TypedProxyPullConsumer __r = org.omg.CosTypedNotifyChannelAdmin.TypedProxyPullConsumerHelper.narrow(__o);
		return __r;
	}
