...
public class _TypedSupplierAdminStub
	...
	implements org.omg.CosTypedNotifyChannelAdmin.TypedSupplierAdmin
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CosTypedNotifyChannelAdmin.TypedSupplierAdminOperations.class;
	public org.omg.CosTypedNotifyChannelAdmin.TypedProxyPushConsumer obtain_typed_notification_push_consumer(java.lang.String supported_interface, org.omg.CORBA.IntHolder proxy_id) throws org.omg.CosTypedEventChannelAdmin.InterfaceNotSupported,org.omg.CosNotifyChannelAdmin.AdminLimitExceeded
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "obtain_typed_notification_push_consumer", true);
					java.lang.String tmpResult1166 = supported_interface;
_os.write_string( tmpResult1166 );
					_is = _invoke(_os);
					org.omg.CosTypedNotifyChannelAdmin.TypedProxyPushConsumer _result = org.omg.CosTypedNotifyChannelAdmin.TypedProxyPushConsumerHelper.read(_is);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "obtain_typed_notification_push_consumer", _opsClass );
			if( _so == null )
				continue;
			TypedSupplierAdminOperations _localServant = (TypedSupplierAdminOperations)_so.servant;
			org.omg.CosTypedNotifyChannelAdmin.TypedProxyPushConsumer _result;
			try
			{
				_result = _localServant.obtain_typed_notification_push_consumer(supported_interface,proxy_id);
	...
	public int[] pull_consumers()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request("_get_pull_consumers",true);
					_is = _invoke(_os);
	...
	public org.omg.CosTypedNotifyChannelAdmin.TypedProxyPullConsumer obtain_typed_notification_pull_consumer(java.lang.String uses_interface, org.omg.CORBA.IntHolder proxy_id) throws org.omg.CosTypedEventChannelAdmin.NoSuchImplementation,org.omg.CosNotifyChannelAdmin.AdminLimitExceeded
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "obtain_typed_notification_pull_consumer", true);
					java.lang.String tmpResult1167 = uses_interface;
_os.write_string( tmpResult1167 );
					_is = _invoke(_os);
					org.omg.CosTypedNotifyChannelAdmin.TypedProxyPullConsumer _result = org.omg.CosTypedNotifyChannelAdmin.TypedProxyPullConsumerHelper.read(_is);
					proxy_id.value = _is.read_long();
					return _result;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "obtain_typed_notification_pull_consumer", _opsClass );
			if( _so == null )
				continue;
			TypedSupplierAdminOperations _localServant = (TypedSupplierAdminOperations)_so.servant;
			org.omg.CosTypedNotifyChannelAdmin.TypedProxyPullConsumer _result;
			try
			{
				_result = _localServant.obtain_typed_notification_pull_consumer(uses_interface,proxy_id);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult1168 = uses_interface;
_os.write_string( tmpResult1168 );
					_is = _invoke(_os);
					org.omg.CosEventChannelAdmin.ProxyPullConsumer _result = org.omg.CosEventChannelAdmin.ProxyPullConsumerHelper.read(_is);
					return _result;
				}
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult1169 = supported_interface;
_os.write_string( tmpResult1169 );
					_is = _invoke(_os);
	...
	public int[] push_consumers()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request("_get_push_consumers",true);
					_is = _invoke(_os);
					return org.omg.CosNotifyChannelAdmin.ProxyIDSeqHelper.read(_is);
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
	...
	public org.omg.CosNotifyChannelAdmin.InterFilterGroupOperator MyOperator()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request("_get_MyOperator",true);
					_is = _invoke(_os);
	...
	public org.omg.CosNotifyChannelAdmin.ProxyConsumer obtain_notification_pull_consumer(org.omg.CosNotifyChannelAdmin.ClientType ctype, org.omg.CORBA.IntHolder proxy_id) throws org.omg.CosNotifyChannelAdmin.AdminLimitExceeded
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "obtain_notification_pull_consumer", true);
	...
	public org.omg.CosNotifyChannelAdmin.ProxyConsumer get_proxy_consumer(int proxy_id) throws org.omg.CosNotifyChannelAdmin.ProxyNotFound
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "get_proxy_consumer", true);
		...
		else
		{
			...
			catch (org.omg.CosNotifyChannelAdmin.ProxyNotFound ex) 
			{
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).exceptionalCompletion(ex);
				throw ex;
	...
	public org.omg.CosNotifyChannelAdmin.ProxyConsumer obtain_notification_push_consumer(org.omg.CosNotifyChannelAdmin.ClientType ctype, org.omg.CORBA.IntHolder proxy_id) throws org.omg.CosNotifyChannelAdmin.AdminLimitExceeded
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "obtain_notification_push_consumer", true);
					org.omg.CosNotifyChannelAdmin.ClientTypeHelper.write(_os,ctype);
					_is = _invoke(_os);
					org.omg.CosNotifyChannelAdmin.ProxyConsumer _result = org.omg.CosNotifyChannelAdmin.ProxyConsumerHelper.read(_is);
					proxy_id.value = _is.read_long();
	...
	public org.omg.CosNotifyChannelAdmin.EventChannel MyChannel()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request("_get_MyChannel",true);
					_is = _invoke(_os);
