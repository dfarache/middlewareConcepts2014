...
public class _TypedProxyPullSupplierStub
	...
	implements org.omg.CosTypedNotifyChannelAdmin.TypedProxyPullSupplier
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CosTypedNotifyChannelAdmin.TypedProxyPullSupplierOperations.class;
	...
	public void connect_typed_pull_consumer(org.omg.CosEventComm.PullConsumer pull_consumer) throws org.omg.CosEventChannelAdmin.AlreadyConnected
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "connect_typed_pull_consumer", true);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "connect_typed_pull_consumer", _opsClass );
			if( _so == null )
				continue;
			TypedProxyPullSupplierOperations _localServant = (TypedProxyPullSupplierOperations)_so.servant;
			try
			{
				_localServant.connect_typed_pull_consumer(pull_consumer);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
