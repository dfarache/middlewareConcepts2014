...
public class _TypedProxyPushSupplierStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosTypedNotifyChannelAdmin.TypedProxyPushSupplier
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CosTypedNotifyChannelAdmin.TypedProxyPushSupplierOperations.class;
	public int[] get_all_filters()
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			TypedProxyPushSupplierOperations _localServant = (TypedProxyPushSupplierOperations)_so.servant;
			int[] _result;
			try
			{
	...
	public void suspend_connection() throws org.omg.CosNotifyChannelAdmin.NotConnected,org.omg.CosNotifyChannelAdmin.ConnectionAlreadyInactive
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "suspend_connection", true);
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
	...
	public void connect_typed_push_consumer(org.omg.CosTypedEventComm.TypedPushConsumer push_consumer) throws org.omg.CosEventChannelAdmin.AlreadyConnected,org.omg.CosEventChannelAdmin.TypeError
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "connect_typed_push_consumer", true);
					org.omg.CosTypedEventComm.TypedPushConsumerHelper.write(_os,push_consumer);
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "connect_typed_push_consumer", _opsClass );
			if( _so == null )
				continue;
			TypedProxyPushSupplierOperations _localServant = (TypedProxyPushSupplierOperations)_so.servant;
			try
			{
				_localServant.connect_typed_push_consumer(push_consumer);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
	...
	public void resume_connection() throws org.omg.CosNotifyChannelAdmin.ConnectionAlreadyActive,org.omg.CosNotifyChannelAdmin.NotConnected
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "resume_connection", true);
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
