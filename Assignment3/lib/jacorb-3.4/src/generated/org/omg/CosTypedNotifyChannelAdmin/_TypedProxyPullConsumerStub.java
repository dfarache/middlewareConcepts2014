...
public class _TypedProxyPullConsumerStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosTypedNotifyChannelAdmin.TypedProxyPullConsumer
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CosTypedNotifyChannelAdmin.TypedProxyPullConsumerOperations.class;
	public org.omg.CosNotifyChannelAdmin.ProxyType MyType()
	{
		while(true)
		{
			...
			else
			{
				...
				if( _so == null )
					continue;
				TypedProxyPullConsumerOperations _localServant = (TypedProxyPullConsumerOperations)_so.servant;
	...
	public void connect_typed_pull_supplier(org.omg.CosTypedEventComm.TypedPullSupplier pull_supplier) throws org.omg.CosEventChannelAdmin.AlreadyConnected,org.omg.CosEventChannelAdmin.TypeError
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "connect_typed_pull_supplier", true);
					org.omg.CosTypedEventComm.TypedPullSupplierHelper.write(_os,pull_supplier);
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "connect_typed_pull_supplier", _opsClass );
			if( _so == null )
				continue;
			TypedProxyPullConsumerOperations _localServant = (TypedProxyPullConsumerOperations)_so.servant;
			try
			{
				_localServant.connect_typed_pull_supplier(pull_supplier);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
