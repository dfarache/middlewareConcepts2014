...
public abstract class TypedProxyPushSupplierPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosTypedNotifyChannelAdmin.TypedProxyPushSupplierOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "connect_typed_push_consumer", Integer.valueOf(4));
		m_opsHash.put ( "_get_MyType", Integer.valueOf(5));
		...
		m_opsHash.put ( "disconnect_push_supplier", Integer.valueOf(10));
	...
	private String[] ids = {"IDL:omg.org/CosTypedNotifyChannelAdmin/TypedProxyPushSupplier:1.0","IDL:omg.org/CosNotifyChannelAdmin/ProxySupplier:1.0","IDL:omg.org/CosNotifyComm/NotifySubscribe:1.0","IDL:omg.org/CosNotifyComm/PushSupplier:1.0","IDL:omg.org/CosNotifyFilter/FilterAdmin:1.0","IDL:omg.org/CosNotification/QoSAdmin:1.0","IDL:omg.org/CosEventComm/PushSupplier:1.0"};
	public org.omg.CosTypedNotifyChannelAdmin.TypedProxyPushSupplier _this()
	{
		org.omg.CORBA.Object __o = _this_object() ;
		org.omg.CosTypedNotifyChannelAdmin.TypedProxyPushSupplier __r = org.omg.CosTypedNotifyChannelAdmin.TypedProxyPushSupplierHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 4: // connect_typed_push_consumer
			{
			try
			{
				org.omg.CosTypedEventComm.TypedPushConsumer _arg0=org.omg.CosTypedEventComm.TypedPushConsumerHelper.read(_input);
				_out = handler.createReply();
				connect_typed_push_consumer(_arg0);
			}
			...
			case 10: // disconnect_push_supplier
			{
				_out = handler.createReply();
