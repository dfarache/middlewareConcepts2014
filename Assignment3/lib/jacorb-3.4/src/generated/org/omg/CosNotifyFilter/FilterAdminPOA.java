	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosNotifyFilter.FilterAdminOperations
{
	...
	static
	{
		m_opsHash.put ( "add_filter", Integer.valueOf(0));
		m_opsHash.put ( "remove_all_filters", Integer.valueOf(1));
		m_opsHash.put ( "get_filter", Integer.valueOf(2));
		m_opsHash.put ( "get_all_filters", Integer.valueOf(3));
		m_opsHash.put ( "remove_filter", Integer.valueOf(4));
	}
