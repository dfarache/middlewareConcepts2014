...
public abstract class URLSeqHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(URLSeqHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.SendingContext.CodeBasePackage.URLSeqHelper.id(), "URLSeq",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.omg.SendingContext.CodeBasePackage.URLHelper.type()));
				}
			}
		}
		return _type;
	...
	public static void write (final org.omg.CORBA.portable.OutputStream _out, java.lang.String[] _s)
	{
		...
		{
			java.lang.String tmpResult1017 = _s[i];
_out.write_string( tmpResult1017 );
		}
