...
public class _DataReaderListenerStub
	...
	implements org.omg.dds.DataReaderListener
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.dds.DataReaderListenerOperations.class;
	public void on_liveliness_changed(org.omg.dds.DataReader reader, org.omg.dds.LivelinessChangedStatus status)
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			DataReaderListenerOperations _localServant = (DataReaderListenerOperations)_so.servant;
			try
			{
