	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.dds.MultiTopicOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult1136 = get_subscription_expression();
_out.write_string( tmpResult1136 );
			...
			{
				_out = handler.createReply();
				java.lang.String tmpResult1137 = get_type_name();
_out.write_string( tmpResult1137 );
				break;
			}
			case 5: // get_name
			{
				_out = handler.createReply();
				java.lang.String tmpResult1138 = get_name();
_out.write_string( tmpResult1138 );
				break;
			}
		}
		return _out;
