...
public abstract class SubscriberQosHelper
{
	...
	public static void insert (final org.omg.CORBA.Any any, final org.omg.dds.SubscriberQos s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.omg.dds.SubscriberQos extract (final org.omg.CORBA.Any any)
	{
	...
	{
		return "IDL:omg.org/dds/SubscriberQos:1.0";
	}
	public static org.omg.dds.SubscriberQos read (final org.omg.CORBA.portable.InputStream in)
	{
		org.omg.dds.SubscriberQos result = new org.omg.dds.SubscriberQos();
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final org.omg.dds.SubscriberQos s)
	{
