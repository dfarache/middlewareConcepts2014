...
public abstract class DomainParticipantFactoryHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(DomainParticipantFactoryHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:omg.org/dds/DomainParticipantFactory:1.0", "DomainParticipantFactory");
				}
			}
		}
		return _type;
