		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult1120 = topic_name;
_os.write_string( tmpResult1120 );
					java.lang.String tmpResult1121 = type_name;
_os.write_string( tmpResult1121 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult1122 = name;
_os.write_string( tmpResult1122 );
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult1123 = topic_name;
_os.write_string( tmpResult1123 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult1124 = name;
_os.write_string( tmpResult1124 );
					java.lang.String tmpResult1125 = type_name;
_os.write_string( tmpResult1125 );
					java.lang.String tmpResult1126 = subscription_expression;
_os.write_string( tmpResult1126 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult1127 = name;
_os.write_string( tmpResult1127 );
					org.omg.dds.TopicHelper.write(_os,related_topic);
					java.lang.String tmpResult1128 = filter_expression;
_os.write_string( tmpResult1128 );
