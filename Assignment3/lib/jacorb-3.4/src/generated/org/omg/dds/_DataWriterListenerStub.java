...
public class _DataWriterListenerStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.dds.DataWriterListener
{
	/** Serial version UID. */
	private static final long serialVersionUID = 1L;
	private String[] ids = {"IDL:omg.org/dds/DataWriterListener:1.0","IDL:omg.org/dds/Listener:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = org.omg.dds.DataWriterListenerOperations.class;
	public void on_offered_deadline_missed(org.omg.dds.DataWriter writer, org.omg.dds.OfferedDeadlineMissedStatus status)
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			DataWriterListenerOperations _localServant = (DataWriterListenerOperations)_so.servant;
			try
			{
