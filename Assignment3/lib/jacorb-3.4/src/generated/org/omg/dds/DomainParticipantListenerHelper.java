...
public abstract class DomainParticipantListenerHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(DomainParticipantListenerHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:omg.org/dds/DomainParticipantListener:1.0", "DomainParticipantListener");
				}
			}
		}
		return _type;
