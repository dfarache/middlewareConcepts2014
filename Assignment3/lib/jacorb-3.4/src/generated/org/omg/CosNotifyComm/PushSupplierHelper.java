...
public abstract class PushSupplierHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(PushSupplierHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:omg.org/CosNotifyComm/PushSupplier:1.0", "PushSupplier");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(org.omg.CosNotifyComm._PushSupplierStub.class));
	}
	...
	public static org.omg.CosNotifyComm.PushSupplier narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof org.omg.CosNotifyComm.PushSupplier)
		{
			return (org.omg.CosNotifyComm.PushSupplier)obj;
		}
		else if (obj._is_a("IDL:omg.org/CosNotifyComm/PushSupplier:1.0"))
		{
