...
public abstract class RequestPriorityPolicyHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(RequestPriorityPolicyHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_local_interface_tc("IDL:omg.org/Messaging/RequestPriorityPolicy:1.0", "RequestPriorityPolicy");
				}
			}
		}
		return _type;
