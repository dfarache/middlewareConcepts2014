...
public abstract class ReplyHandlerHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(ReplyHandlerHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:omg.org/Messaging/ReplyHandler:1.0", "ReplyHandler");
				}
			}
		}
		return _type;
