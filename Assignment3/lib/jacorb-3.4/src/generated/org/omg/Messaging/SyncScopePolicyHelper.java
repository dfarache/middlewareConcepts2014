...
public abstract class SyncScopePolicyHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(SyncScopePolicyHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_local_interface_tc("IDL:omg.org/Messaging/SyncScopePolicy:1.0", "SyncScopePolicy");
				}
			}
		}
		return _type;
