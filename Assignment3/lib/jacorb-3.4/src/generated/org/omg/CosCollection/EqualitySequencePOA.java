...
public abstract class EqualitySequencePOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosCollection.EqualitySequenceOperations
{
	static private final java.util.HashMap<String,Integer> m_opsHash = new java.util.HashMap<String,Integer>();
	static
	{
		m_opsHash.put ( "locate_next_element", Integer.valueOf(0));
		m_opsHash.put ( "contains_element", Integer.valueOf(1));
		m_opsHash.put ( "locate_or_add_element_set_iterator", Integer.valueOf(2));
		m_opsHash.put ( "number_of_different_elements", Integer.valueOf(3));
		...
		m_opsHash.put ( "locate_first_element_with_value", Integer.valueOf(7));
		m_opsHash.put ( "add_element_as_first", Integer.valueOf(8));
		m_opsHash.put ( "equal", Integer.valueOf(9));
		m_opsHash.put ( "add_element_as_previous", Integer.valueOf(10));
		m_opsHash.put ( "is_empty", Integer.valueOf(11));
		m_opsHash.put ( "remove_element_at_position", Integer.valueOf(12));
		m_opsHash.put ( "not_equal", Integer.valueOf(13));
		m_opsHash.put ( "locate_or_add_element", Integer.valueOf(14));
		m_opsHash.put ( "remove_first_element", Integer.valueOf(15));
		m_opsHash.put ( "remove_all_occurrences", Integer.valueOf(16));
		m_opsHash.put ( "retrieve_last_element", Integer.valueOf(17));
		m_opsHash.put ( "locate_last_element_with_value", Integer.valueOf(18));
		m_opsHash.put ( "retrieve_first_element", Integer.valueOf(19));
		m_opsHash.put ( "remove_element", Integer.valueOf(20));
		m_opsHash.put ( "locate_element", Integer.valueOf(21));
		m_opsHash.put ( "add_element", Integer.valueOf(22));
		m_opsHash.put ( "add_element_as_last", Integer.valueOf(23));
		m_opsHash.put ( "replace_element_at", Integer.valueOf(24));
		m_opsHash.put ( "add_element_at_position_set_iterator", Integer.valueOf(25));
		m_opsHash.put ( "add_element_at_position", Integer.valueOf(26));
		m_opsHash.put ( "compare", Integer.valueOf(27));
		m_opsHash.put ( "retrieve_element_at", Integer.valueOf(28));
		m_opsHash.put ( "destroy", Integer.valueOf(29));
		m_opsHash.put ( "replace_last_element", Integer.valueOf(30));
		m_opsHash.put ( "sort", Integer.valueOf(31));
		m_opsHash.put ( "contains_all_from", Integer.valueOf(32));
		m_opsHash.put ( "number_of_elements", Integer.valueOf(33));
		m_opsHash.put ( "add_all_from", Integer.valueOf(34));
		m_opsHash.put ( "create_ordered_iterator", Integer.valueOf(35));
		m_opsHash.put ( "replace_element_at_position", Integer.valueOf(36));
		m_opsHash.put ( "add_element_as_last_set_iterator", Integer.valueOf(37));
		m_opsHash.put ( "locate_previous_element_with_value", Integer.valueOf(38));
		m_opsHash.put ( "remove_element_at", Integer.valueOf(39));
		m_opsHash.put ( "number_of_occurrences", Integer.valueOf(40));
		m_opsHash.put ( "reverse", Integer.valueOf(41));
		m_opsHash.put ( "replace_first_element", Integer.valueOf(42));
		m_opsHash.put ( "remove_all", Integer.valueOf(43));
		m_opsHash.put ( "add_element_set_iterator", Integer.valueOf(44));
		m_opsHash.put ( "add_element_as_next", Integer.valueOf(45));
		m_opsHash.put ( "all_elements_do", Integer.valueOf(46));
		m_opsHash.put ( "remove_last_element", Integer.valueOf(47));
		m_opsHash.put ( "add_element_as_first_set_iterator", Integer.valueOf(48));
		m_opsHash.put ( "locate_next_different_element", Integer.valueOf(49));
	}
	private String[] ids = {"IDL:omg.org/CosCollection/EqualitySequence:1.0","IDL:omg.org/CosCollection/SequentialCollection:1.0","IDL:omg.org/CosCollection/Collection:1.0","IDL:omg.org/CosCollection/OrderedCollection:1.0","IDL:omg.org/CosCollection/EqualitySequentialCollection:1.0","IDL:omg.org/CosCollection/EqualityCollection:1.0"};
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 9: // equal
			{
				org.omg.CosCollection.EqualitySequence _arg0=org.omg.CosCollection.EqualitySequenceHelper.read(_input);
				_out = handler.createReply();
				_out.write_boolean(equal(_arg0));
				break;
			}
			case 10: // add_element_as_previous
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 12: // remove_element_at_position
			{
			try
			{
				int _arg0=_input.read_ulong();
			...
			case 18: // locate_last_element_with_value
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 19: // retrieve_first_element
			{
			try
			{
				org.omg.CORBA.AnyHolder _arg0= new org.omg.CORBA.AnyHolder();
			...
			case 25: // add_element_at_position_set_iterator
			{
			try
			{
				int _arg0=_input.read_ulong();
			...
			case 26: // add_element_at_position
			{
			try
			{
				int _arg0=_input.read_ulong();
			...
			case 33: // number_of_elements
			{
				_out = handler.createReply();
				_out.write_ulong(number_of_elements());
				break;
			}
			case 34: // add_all_from
			{
			try
			{
				org.omg.CosCollection.Collection _arg0=org.omg.CosCollection.CollectionHelper.read(_input);
			...
			case 35: // create_ordered_iterator
			{
				boolean _arg0=_input.read_boolean();
			...
			case 36: // replace_element_at_position
			{
			try
			{
				int _arg0=_input.read_ulong();
			...
			case 37: // add_element_as_last_set_iterator
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 38: // locate_previous_element_with_value
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 48: // add_element_as_first_set_iterator
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
