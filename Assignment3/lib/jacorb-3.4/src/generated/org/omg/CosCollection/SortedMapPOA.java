...
public abstract class SortedMapPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosCollection.SortedMapOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "replace_element_with_key_set_iterator", Integer.valueOf(32));
		m_opsHash.put ( "keys", Integer.valueOf(33));
		m_opsHash.put ( "contains_all_from", Integer.valueOf(34));
		m_opsHash.put ( "number_of_elements", Integer.valueOf(35));
		m_opsHash.put ( "add_all_from", Integer.valueOf(36));
		m_opsHash.put ( "create_ordered_iterator", Integer.valueOf(37));
		m_opsHash.put ( "locate_next_element_with_different_key", Integer.valueOf(38));
		m_opsHash.put ( "remove_element_at", Integer.valueOf(39));
		m_opsHash.put ( "number_of_occurrences", Integer.valueOf(40));
		m_opsHash.put ( "number_of_different_keys", Integer.valueOf(41));
		m_opsHash.put ( "remove_all", Integer.valueOf(42));
		m_opsHash.put ( "replace_element_with_key", Integer.valueOf(43));
	...
	private String[] ids = {"IDL:omg.org/CosCollection/SortedMap:1.0","IDL:omg.org/CosCollection/KeyCollection:1.0","IDL:omg.org/CosCollection/Collection:1.0","IDL:omg.org/CosCollection/EqualityKeySortedCollection:1.0","IDL:omg.org/CosCollection/OrderedCollection:1.0","IDL:omg.org/CosCollection/EqualityCollection:1.0","IDL:omg.org/CosCollection/SortedCollection:1.0"};
	public org.omg.CosCollection.SortedMap _this()
	{
		org.omg.CORBA.Object __o = _this_object() ;
		org.omg.CosCollection.SortedMap __r = org.omg.CosCollection.SortedMapHelper.narrow(__o);
		return __r;
	}
	public org.omg.CosCollection.SortedMap _this(org.omg.CORBA.ORB orb)
	{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 31: // compare
			{
				org.omg.CosCollection.SortedMap _arg0=org.omg.CosCollection.SortedMapHelper.read(_input);
			...
			case 32: // replace_element_with_key_set_iterator
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 35: // number_of_elements
			{
				_out = handler.createReply();
				_out.write_ulong(number_of_elements());
				break;
			}
			case 36: // add_all_from
			{
			try
			{
				org.omg.CosCollection.Collection _arg0=org.omg.CosCollection.CollectionHelper.read(_input);
			...
			case 37: // create_ordered_iterator
			{
				boolean _arg0=_input.read_boolean();
			...
			case 38: // locate_next_element_with_different_key
			{
			try
			{
				org.omg.CosCollection.Iterator _arg0=org.omg.CosCollection.IteratorHelper.read(_input);
			...
			case 41: // number_of_different_keys
			{
				_out = handler.createReply();
			...
			case 43: // replace_element_with_key
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
