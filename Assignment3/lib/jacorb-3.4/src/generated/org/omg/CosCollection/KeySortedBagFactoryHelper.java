...
public abstract class KeySortedBagFactoryHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(KeySortedBagFactoryHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:omg.org/CosCollection/KeySortedBagFactory:1.0", "KeySortedBagFactory");
				}
			}
		}
		return _type;
