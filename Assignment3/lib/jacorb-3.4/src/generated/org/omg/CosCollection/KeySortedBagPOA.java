...
public abstract class KeySortedBagPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosCollection.KeySortedBagOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "compare", Integer.valueOf(11));
		m_opsHash.put ( "locate_or_add_element_with_key_set_iterator", Integer.valueOf(12));
		m_opsHash.put ( "remove_first_element", Integer.valueOf(13));
		m_opsHash.put ( "locate_first_element_with_key", Integer.valueOf(14));
		...
		m_opsHash.put ( "add_element", Integer.valueOf(18));
		m_opsHash.put ( "replace_element_at", Integer.valueOf(19));
		m_opsHash.put ( "add_or_replace_element_with_key", Integer.valueOf(20));
		m_opsHash.put ( "locate_previous_element_with_different_key", Integer.valueOf(21));
		...
		m_opsHash.put ( "add_all_from", Integer.valueOf(28));
		m_opsHash.put ( "create_ordered_iterator", Integer.valueOf(29));
	...
	public org.omg.CosCollection.KeySortedBag _this()
	{
		org.omg.CORBA.Object __o = _this_object() ;
		org.omg.CosCollection.KeySortedBag __r = org.omg.CosCollection.KeySortedBagHelper.narrow(__o);
		return __r;
	}
	public org.omg.CosCollection.KeySortedBag _this(org.omg.CORBA.ORB orb)
	{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 11: // compare
			{
				org.omg.CosCollection.KeySortedBag _arg0=org.omg.CosCollection.KeySortedBagHelper.read(_input);
			...
			case 12: // locate_or_add_element_with_key_set_iterator
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 14: // locate_first_element_with_key
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 20: // add_or_replace_element_with_key
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 21: // locate_previous_element_with_different_key
			{
			try
			{
				org.omg.CosCollection.Iterator _arg0=org.omg.CosCollection.IteratorHelper.read(_input);
			...
			case 29: // create_ordered_iterator
			{
				boolean _arg0=_input.read_boolean();
