...
public class _QueueFactoryStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosCollection.QueueFactory
{
	/** Serial version UID. */
	private static final long serialVersionUID = 1L;
	private String[] ids = {"IDL:omg.org/CosCollection/QueueFactory:1.0","IDL:omg.org/CosCollection/RACollectionFactory:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = org.omg.CosCollection.QueueFactoryOperations.class;
	public org.omg.CosCollection.Queue create(org.omg.CosCollection.Operations ops, int expected_size)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					_is = _invoke(_os);
					org.omg.CosCollection.Queue _result = org.omg.CosCollection.QueueHelper.read(_is);
					return _result;
				}
		...
		else
		{
			...
			if( _so == null )
				continue;
			QueueFactoryOperations _localServant = (QueueFactoryOperations)_so.servant;
			org.omg.CosCollection.Queue _result;
			try
			{
