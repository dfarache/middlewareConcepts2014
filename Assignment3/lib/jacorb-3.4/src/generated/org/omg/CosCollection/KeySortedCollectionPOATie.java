...
public class KeySortedCollectionPOATie
	extends KeySortedCollectionPOA
{
	private KeySortedCollectionOperations _delegate;

	private POA _poa;
	public KeySortedCollectionPOATie(KeySortedCollectionOperations delegate)
	{
		_delegate = delegate;
	}
	public KeySortedCollectionPOATie(KeySortedCollectionOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public KeySortedCollectionOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(KeySortedCollectionOperations delegate)
	{
		_delegate = delegate;
	}
