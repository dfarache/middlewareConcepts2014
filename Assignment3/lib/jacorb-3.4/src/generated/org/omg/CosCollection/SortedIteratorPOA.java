...
public abstract class SortedIteratorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosCollection.SortedIteratorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "remove_element_set_to_previous", Integer.valueOf(23));
	...
	public org.omg.CosCollection.SortedIterator _this()
	{
		...
		org.omg.CosCollection.SortedIterator __r = org.omg.CosCollection.SortedIteratorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 23: // remove_element_set_to_previous
			{
			try
			{
				_out = handler.createReply();
