	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosCollection.EqualityKeySortedCollectionOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "retrieve_element_at_position", Integer.valueOf(9));
		m_opsHash.put ( "create_iterator", Integer.valueOf(10));
		...
		m_opsHash.put ( "create_ordered_iterator", Integer.valueOf(34));
		m_opsHash.put ( "add_all_from", Integer.valueOf(35));
		m_opsHash.put ( "number_of_elements", Integer.valueOf(36));
		...
		m_opsHash.put ( "contains_element_with_key", Integer.valueOf(43));
		m_opsHash.put ( "add_element_set_iterator", Integer.valueOf(44));
		m_opsHash.put ( "remove_last_element", Integer.valueOf(45));
		m_opsHash.put ( "all_elements_do", Integer.valueOf(46));
		m_opsHash.put ( "retrieve_element_with_key", Integer.valueOf(47));
		m_opsHash.put ( "locate_next_different_element", Integer.valueOf(48));
		m_opsHash.put ( "key", Integer.valueOf(49));
	}
	...
	public org.omg.CosCollection.EqualityKeySortedCollection _this()
	{
		...
		org.omg.CosCollection.EqualityKeySortedCollection __r = org.omg.CosCollection.EqualityKeySortedCollectionHelper.narrow(__o);
		return __r;
	}
