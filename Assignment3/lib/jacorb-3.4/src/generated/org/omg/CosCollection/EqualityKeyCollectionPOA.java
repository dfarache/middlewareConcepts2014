...
public abstract class EqualityKeyCollectionPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosCollection.EqualityKeyCollectionOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "locate_element_with_key", Integer.valueOf(10));
		m_opsHash.put ( "number_of_elements_with_key", Integer.valueOf(11));
		m_opsHash.put ( "is_empty", Integer.valueOf(12));
		m_opsHash.put ( "locate_or_add_element_with_key_set_iterator", Integer.valueOf(13));
		m_opsHash.put ( "locate_or_add_element", Integer.valueOf(14));
		m_opsHash.put ( "remove_all_occurrences", Integer.valueOf(15));
		m_opsHash.put ( "locate_or_add_element_with_key", Integer.valueOf(16));
		m_opsHash.put ( "remove_element", Integer.valueOf(17));
		m_opsHash.put ( "locate_element", Integer.valueOf(18));
		m_opsHash.put ( "add_element", Integer.valueOf(19));
		m_opsHash.put ( "replace_element_at", Integer.valueOf(20));
		m_opsHash.put ( "add_or_replace_element_with_key", Integer.valueOf(21));
		m_opsHash.put ( "remove_element_with_key", Integer.valueOf(22));
		m_opsHash.put ( "retrieve_element_at", Integer.valueOf(23));
		m_opsHash.put ( "_get_key_type", Integer.valueOf(24));
		m_opsHash.put ( "destroy", Integer.valueOf(25));
		m_opsHash.put ( "replace_element_with_key_set_iterator", Integer.valueOf(26));
		m_opsHash.put ( "keys", Integer.valueOf(27));
		m_opsHash.put ( "contains_all_from", Integer.valueOf(28));
		m_opsHash.put ( "add_all_from", Integer.valueOf(29));
		m_opsHash.put ( "number_of_elements", Integer.valueOf(30));
		m_opsHash.put ( "locate_next_element_with_different_key", Integer.valueOf(31));
		m_opsHash.put ( "remove_element_at", Integer.valueOf(32));
		m_opsHash.put ( "number_of_occurrences", Integer.valueOf(33));
		...
		m_opsHash.put ( "contains_element_with_key", Integer.valueOf(37));
		m_opsHash.put ( "add_element_set_iterator", Integer.valueOf(38));
		m_opsHash.put ( "all_elements_do", Integer.valueOf(39));
		m_opsHash.put ( "retrieve_element_with_key", Integer.valueOf(40));
		m_opsHash.put ( "locate_next_different_element", Integer.valueOf(41));
		m_opsHash.put ( "key", Integer.valueOf(42));
	}
	private String[] ids = {"IDL:omg.org/CosCollection/EqualityKeyCollection:1.0","IDL:omg.org/CosCollection/KeyCollection:1.0","IDL:omg.org/CosCollection/Collection:1.0","IDL:omg.org/CosCollection/EqualityCollection:1.0"};
	public org.omg.CosCollection.EqualityKeyCollection _this()
	{
		org.omg.CORBA.Object __o = _this_object() ;
		org.omg.CosCollection.EqualityKeyCollection __r = org.omg.CosCollection.EqualityKeyCollectionHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 10: // locate_element_with_key
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 11: // number_of_elements_with_key
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 13: // locate_or_add_element_with_key_set_iterator
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 15: // remove_all_occurrences
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 16: // locate_or_add_element_with_key
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 21: // add_or_replace_element_with_key
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 22: // remove_element_with_key
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 26: // replace_element_with_key_set_iterator
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 37: // contains_element_with_key
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 38: // add_element_set_iterator
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 40: // retrieve_element_with_key
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 41: // locate_next_different_element
			{
			try
			{
				org.omg.CosCollection.Iterator _arg0=org.omg.CosCollection.IteratorHelper.read(_input);
