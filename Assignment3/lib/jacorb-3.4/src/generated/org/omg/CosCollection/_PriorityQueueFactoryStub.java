...
public class _PriorityQueueFactoryStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosCollection.PriorityQueueFactory
{
	/** Serial version UID. */
	private static final long serialVersionUID = 1L;
	private String[] ids = {"IDL:omg.org/CosCollection/PriorityQueueFactory:1.0","IDL:omg.org/CosCollection/RACollectionFactory:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = org.omg.CosCollection.PriorityQueueFactoryOperations.class;
	public org.omg.CosCollection.PriorityQueue create(org.omg.CosCollection.Operations ops, int expected_size)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					_is = _invoke(_os);
					org.omg.CosCollection.PriorityQueue _result = org.omg.CosCollection.PriorityQueueHelper.read(_is);
					return _result;
				}
		...
		else
		{
			...
			if( _so == null )
				continue;
			PriorityQueueFactoryOperations _localServant = (PriorityQueueFactoryOperations)_so.servant;
			org.omg.CosCollection.PriorityQueue _result;
			try
			{
