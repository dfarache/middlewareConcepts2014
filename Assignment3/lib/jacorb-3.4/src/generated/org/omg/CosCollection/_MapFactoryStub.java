...
public class _MapFactoryStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosCollection.MapFactory
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CosCollection.MapFactoryOperations.class;
	public org.omg.CosCollection.Map create(org.omg.CosCollection.Operations ops, int expected_size)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					_is = _invoke(_os);
					org.omg.CosCollection.Map _result = org.omg.CosCollection.MapHelper.read(_is);
					return _result;
				}
		...
		else
		{
			...
			if( _so == null )
				continue;
			MapFactoryOperations _localServant = (MapFactoryOperations)_so.servant;
			org.omg.CosCollection.Map _result;
			try
			{
