...
public abstract class SortedBagPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosCollection.SortedBagOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "locate_previous_different_element", Integer.valueOf(20));
		m_opsHash.put ( "retrieve_element_at", Integer.valueOf(21));
		m_opsHash.put ( "locate_first_element", Integer.valueOf(22));
		m_opsHash.put ( "destroy", Integer.valueOf(23));
		m_opsHash.put ( "contains_all_from", Integer.valueOf(24));
		m_opsHash.put ( "add_all_from", Integer.valueOf(25));
		m_opsHash.put ( "create_ordered_iterator", Integer.valueOf(26));
		m_opsHash.put ( "number_of_elements", Integer.valueOf(27));
		m_opsHash.put ( "remove_element_at", Integer.valueOf(28));
		m_opsHash.put ( "number_of_occurrences", Integer.valueOf(29));
		m_opsHash.put ( "remove_all", Integer.valueOf(30));
		m_opsHash.put ( "add_element_set_iterator", Integer.valueOf(31));
	...
	private String[] ids = {"IDL:omg.org/CosCollection/SortedBag:1.0","IDL:omg.org/CosCollection/Collection:1.0","IDL:omg.org/CosCollection/OrderedCollection:1.0","IDL:omg.org/CosCollection/EqualityCollection:1.0","IDL:omg.org/CosCollection/SortedCollection:1.0","IDL:omg.org/CosCollection/EqualitySortedCollection:1.0"};
	public org.omg.CosCollection.SortedBag _this()
	{
		org.omg.CORBA.Object __o = _this_object() ;
		org.omg.CosCollection.SortedBag __r = org.omg.CosCollection.SortedBagHelper.narrow(__o);
		return __r;
	}
	public org.omg.CosCollection.SortedBag _this(org.omg.CORBA.ORB orb)
	{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 19: // compare
			{
				org.omg.CosCollection.SortedBag _arg0=org.omg.CosCollection.SortedBagHelper.read(_input);
			...
			case 20: // locate_previous_different_element
			{
			try
			{
				org.omg.CosCollection.Iterator _arg0=org.omg.CosCollection.IteratorHelper.read(_input);
			...
			case 26: // create_ordered_iterator
			{
				boolean _arg0=_input.read_boolean();
			...
			case 27: // number_of_elements
			{
				_out = handler.createReply();
				_out.write_ulong(number_of_elements());
				break;
			}
			case 28: // remove_element_at
			{
			try
			{
				org.omg.CosCollection.Iterator _arg0=org.omg.CosCollection.IteratorHelper.read(_input);
			...
			case 31: // add_element_set_iterator
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
