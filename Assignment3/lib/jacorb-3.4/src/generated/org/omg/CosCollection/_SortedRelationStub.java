...
public class _SortedRelationStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosCollection.SortedRelation
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CosCollection.SortedRelationOperations.class;
	public int remove_all_elements_with_key(org.omg.CORBA.Any key) throws org.omg.CosCollection.KeyInvalid
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			SortedRelationOperations _localServant = (SortedRelationOperations)_so.servant;
			int _result;
			try
			{
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					org.omg.CosCollection.SortedRelationHelper.write(_os,collector);
