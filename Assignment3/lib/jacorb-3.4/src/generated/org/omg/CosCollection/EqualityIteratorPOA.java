...
public abstract class EqualityIteratorPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosCollection.EqualityIteratorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "set_to_element_with_value", Integer.valueOf(6));
		m_opsHash.put ( "is_equal", Integer.valueOf(7));
		m_opsHash.put ( "clone", Integer.valueOf(8));
		m_opsHash.put ( "retrieve_element_set_to_next", Integer.valueOf(9));
		m_opsHash.put ( "set_to_first_element", Integer.valueOf(10));
		m_opsHash.put ( "is_in_between", Integer.valueOf(11));
		m_opsHash.put ( "set_to_next_nth_element", Integer.valueOf(12));
		m_opsHash.put ( "set_to_next_element_with_value", Integer.valueOf(13));
		m_opsHash.put ( "not_equal_remove_element_set_to_next", Integer.valueOf(14));
		m_opsHash.put ( "replace_element_set_to_next", Integer.valueOf(15));
		m_opsHash.put ( "not_equal_replace_element_set_to_next", Integer.valueOf(16));
		m_opsHash.put ( "invalidate", Integer.valueOf(17));
		m_opsHash.put ( "set_to_next_element", Integer.valueOf(18));
		m_opsHash.put ( "remove_element", Integer.valueOf(19));
		m_opsHash.put ( "is_for", Integer.valueOf(20));
		m_opsHash.put ( "add_element_set_iterator", Integer.valueOf(21));
		m_opsHash.put ( "is_valid", Integer.valueOf(22));
		m_opsHash.put ( "retrieve_element", Integer.valueOf(23));
		m_opsHash.put ( "is_const", Integer.valueOf(24));
		m_opsHash.put ( "set_to_next_element_with_different_value", Integer.valueOf(25));
		m_opsHash.put ( "add_n_elements_set_iterator", Integer.valueOf(26));
	...
	public org.omg.CosCollection.EqualityIterator _this()
	{
		...
		org.omg.CosCollection.EqualityIterator __r = org.omg.CosCollection.EqualityIteratorHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 6: // set_to_element_with_value
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 9: // retrieve_element_set_to_next
			{
			try
			{
			...
			case 10: // set_to_first_element
			{
				_out = handler.createReply();
				_out.write_boolean(set_to_first_element());
				break;
			}
			case 11: // is_in_between
			{
				_out = handler.createReply();
				_out.write_boolean(is_in_between());
				break;
			}
			case 12: // set_to_next_nth_element
			{
			try
			{
				int _arg0=_input.read_ulong();
			...
			case 13: // set_to_next_element_with_value
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 14: // not_equal_remove_element_set_to_next
			{
			try
			{
				org.omg.CosCollection.Iterator _arg0=org.omg.CosCollection.IteratorHelper.read(_input);
			...
			case 15: // replace_element_set_to_next
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 16: // not_equal_replace_element_set_to_next
			{
			try
			{
				org.omg.CosCollection.Iterator _arg0=org.omg.CosCollection.IteratorHelper.read(_input);
			...
			case 21: // add_element_set_iterator
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 25: // set_to_next_element_with_different_value
			{
			try
			{
				_out = handler.createReply();
			...
			case 26: // add_n_elements_set_iterator
			{
			try
			{
				org.omg.CORBA.Any[] _arg0=org.omg.CosCollection.AnySequenceHelper.read(_input);
