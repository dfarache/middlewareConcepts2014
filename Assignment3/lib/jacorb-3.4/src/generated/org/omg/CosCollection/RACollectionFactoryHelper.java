...
public abstract class RACollectionFactoryHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(RACollectionFactoryHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:omg.org/CosCollection/RACollectionFactory:1.0", "RACollectionFactory");
				}
			}
		}
		return _type;
