...
public class _RACollectionFactoryStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosCollection.RACollectionFactory
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CosCollection.RACollectionFactoryOperations.class;
	public org.omg.CosCollection.RestrictedAccessCollection generic_create(org.omg.CosCollection.NVPair[] parameters) throws org.omg.CosCollection.ParameterInvalid
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			RACollectionFactoryOperations _localServant = (RACollectionFactoryOperations)_so.servant;
