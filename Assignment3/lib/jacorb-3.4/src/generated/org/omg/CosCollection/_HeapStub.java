...
public class _HeapStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosCollection.Heap
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CosCollection.HeapOperations.class;
	public int remove_all()
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			HeapOperations _localServant = (HeapOperations)_so.servant;
			int _result;
			try
			{
