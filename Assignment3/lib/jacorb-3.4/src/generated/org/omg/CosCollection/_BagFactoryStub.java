...
public class _BagFactoryStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosCollection.BagFactory
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CosCollection.BagFactoryOperations.class;
	public org.omg.CosCollection.Bag create(org.omg.CosCollection.Operations ops, int expected_size)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					_is = _invoke(_os);
					org.omg.CosCollection.Bag _result = org.omg.CosCollection.BagHelper.read(_is);
					return _result;
				}
		...
		else
		{
			...
			if( _so == null )
				continue;
			BagFactoryOperations _localServant = (BagFactoryOperations)_so.servant;
			org.omg.CosCollection.Bag _result;
			try
			{
