...
public class _KeySortedIteratorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosCollection.KeySortedIterator
{
	/** Serial version UID. */
	private static final long serialVersionUID = 1L;
	private String[] ids = {"IDL:omg.org/CosCollection/KeySortedIterator:1.0","IDL:omg.org/CosCollection/KeyIterator:1.0","IDL:omg.org/CosCollection/SortedIterator:1.0","IDL:omg.org/CosCollection/Iterator:1.0","IDL:omg.org/CosCollection/OrderedIterator:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = org.omg.CosCollection.KeySortedIteratorOperations.class;
	public org.omg.CosCollection.Iterator _clone()
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			KeySortedIteratorOperations _localServant = (KeySortedIteratorOperations)_so.servant;
