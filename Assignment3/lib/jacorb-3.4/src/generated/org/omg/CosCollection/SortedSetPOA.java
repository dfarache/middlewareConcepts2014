...
public abstract class SortedSetPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosCollection.SortedSetOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "locate_previous_element", Integer.valueOf(2));
		m_opsHash.put ( "locate_or_add_element_set_iterator", Integer.valueOf(3));
		m_opsHash.put ( "number_of_different_elements", Integer.valueOf(4));
		m_opsHash.put ( "_get_element_type", Integer.valueOf(5));
		m_opsHash.put ( "create_iterator", Integer.valueOf(6));
		m_opsHash.put ( "retrieve_element_at_position", Integer.valueOf(7));
		m_opsHash.put ( "is_empty", Integer.valueOf(8));
		m_opsHash.put ( "remove_element_at_position", Integer.valueOf(9));
		m_opsHash.put ( "locate_or_add_element", Integer.valueOf(10));
		m_opsHash.put ( "remove_first_element", Integer.valueOf(11));
		m_opsHash.put ( "remove_all_occurrences", Integer.valueOf(12));
		m_opsHash.put ( "retrieve_last_element", Integer.valueOf(13));
		m_opsHash.put ( "retrieve_first_element", Integer.valueOf(14));
		m_opsHash.put ( "remove_element", Integer.valueOf(15));
		m_opsHash.put ( "locate_element", Integer.valueOf(16));
		m_opsHash.put ( "add_element", Integer.valueOf(17));
		m_opsHash.put ( "replace_element_at", Integer.valueOf(18));
		m_opsHash.put ( "locate_previous_different_element", Integer.valueOf(19));
		m_opsHash.put ( "retrieve_element_at", Integer.valueOf(20));
		m_opsHash.put ( "locate_first_element", Integer.valueOf(21));
		m_opsHash.put ( "destroy", Integer.valueOf(22));
		m_opsHash.put ( "contains_all_from", Integer.valueOf(23));
		m_opsHash.put ( "add_all_from", Integer.valueOf(24));
		m_opsHash.put ( "create_ordered_iterator", Integer.valueOf(25));
		m_opsHash.put ( "number_of_elements", Integer.valueOf(26));
		m_opsHash.put ( "remove_element_at", Integer.valueOf(27));
		m_opsHash.put ( "number_of_occurrences", Integer.valueOf(28));
		m_opsHash.put ( "remove_all", Integer.valueOf(29));
		m_opsHash.put ( "add_element_set_iterator", Integer.valueOf(30));
		m_opsHash.put ( "compare", Integer.valueOf(31));
		m_opsHash.put ( "all_elements_do", Integer.valueOf(32));
		m_opsHash.put ( "remove_last_element", Integer.valueOf(33));
		m_opsHash.put ( "locate_last_element", Integer.valueOf(34));
		m_opsHash.put ( "locate_next_different_element", Integer.valueOf(35));
	}
	private String[] ids = {"IDL:omg.org/CosCollection/SortedSet:1.0","IDL:omg.org/CosCollection/Collection:1.0","IDL:omg.org/CosCollection/OrderedCollection:1.0","IDL:omg.org/CosCollection/EqualityCollection:1.0","IDL:omg.org/CosCollection/SortedCollection:1.0","IDL:omg.org/CosCollection/EqualitySortedCollection:1.0"};
	public org.omg.CosCollection.SortedSet _this()
	{
		org.omg.CORBA.Object __o = _this_object() ;
		org.omg.CosCollection.SortedSet __r = org.omg.CosCollection.SortedSetHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 2: // locate_previous_element
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 3: // locate_or_add_element_set_iterator
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 4: // number_of_different_elements
			{
				_out = handler.createReply();
			...
			case 7: // retrieve_element_at_position
			{
			try
			{
			...
			case 9: // remove_element_at_position
			{
			try
			{
				int _arg0=_input.read_ulong();
			...
			case 12: // remove_all_occurrences
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 14: // retrieve_first_element
			{
			try
			{
				org.omg.CORBA.AnyHolder _arg0= new org.omg.CORBA.AnyHolder();
			...
			case 19: // locate_previous_different_element
			{
			try
			{
				org.omg.CosCollection.Iterator _arg0=org.omg.CosCollection.IteratorHelper.read(_input);
			...
			case 25: // create_ordered_iterator
			{
				boolean _arg0=_input.read_boolean();
			...
			case 26: // number_of_elements
			{
				_out = handler.createReply();
				_out.write_ulong(number_of_elements());
				break;
			}
			case 27: // remove_element_at
			{
			try
			{
				org.omg.CosCollection.Iterator _arg0=org.omg.CosCollection.IteratorHelper.read(_input);
			...
			case 30: // add_element_set_iterator
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 31: // compare
			{
				org.omg.CosCollection.SortedSet _arg0=org.omg.CosCollection.SortedSetHelper.read(_input);
			...
			case 35: // locate_next_different_element
			{
			try
			{
				org.omg.CosCollection.Iterator _arg0=org.omg.CosCollection.IteratorHelper.read(_input);
