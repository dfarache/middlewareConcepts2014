...
public class _SortedSetStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosCollection.SortedSet
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CosCollection.SortedSetOperations.class;
	public boolean locate_next_element(org.omg.CORBA.Any element, org.omg.CosCollection.Iterator where) throws org.omg.CosCollection.ElementInvalid,org.omg.CosCollection.IteratorInvalid
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			SortedSetOperations _localServant = (SortedSetOperations)_so.servant;
			boolean _result;
			try
			{
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					org.omg.CosCollection.SortedSetHelper.write(_os,collector);
