...
public class _SetStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosCollection.Set
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CosCollection.SetOperations.class;
	public boolean locate_or_add_element_set_iterator(org.omg.CORBA.Any element, org.omg.CosCollection.Iterator where) throws org.omg.CosCollection.ElementInvalid,org.omg.CosCollection.IteratorInvalid
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			SetOperations _localServant = (SetOperations)_so.servant;
			boolean _result;
			try
			{
