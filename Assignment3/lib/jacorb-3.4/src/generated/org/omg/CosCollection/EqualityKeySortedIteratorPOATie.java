...
public class EqualityKeySortedIteratorPOATie
	extends EqualityKeySortedIteratorPOA
{
	private EqualityKeySortedIteratorOperations _delegate;

	private POA _poa;
	public EqualityKeySortedIteratorPOATie(EqualityKeySortedIteratorOperations delegate)
	{
		_delegate = delegate;
	}
	public EqualityKeySortedIteratorPOATie(EqualityKeySortedIteratorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public EqualityKeySortedIteratorOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(EqualityKeySortedIteratorOperations delegate)
	{
		_delegate = delegate;
	}
	...
	{
		return _delegate.set_to_first_element_with_key(key,style);
	}
	...
	{
		return _delegate.set_to_last_element_with_value(element,style);
	}
...
_delegate.replace_element(element);
	...
	{
		return _delegate.set_to_previous_element_with_key(key);
	}
	...
	{
		return _delegate.set_to_last_element_with_key(key,style);
	}
...
_delegate.destroy();
	...
	{
		return _delegate.set_to_previous_element_with_value(elementally);
	}
...
_delegate.invalidate();
	...
	{
		return _delegate.retrieve_previous_n_keys(keys);
	}
	...
	{
		return _delegate.set_to_first_element_with_value(element,style);
	}
	...
	{
		return _delegate.set_to_previous_element_with_different_key();
	}
	...
	{
		return _delegate.set_to_previous_element_with_different_value();
	}
