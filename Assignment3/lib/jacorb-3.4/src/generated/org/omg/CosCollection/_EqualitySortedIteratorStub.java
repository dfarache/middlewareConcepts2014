...
public class _EqualitySortedIteratorStub
	...
	implements org.omg.CosCollection.EqualitySortedIterator
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CosCollection.EqualitySortedIteratorOperations.class;
	public org.omg.CosCollection.Iterator _clone()
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			EqualitySortedIteratorOperations _localServant = (EqualitySortedIteratorOperations)_so.servant;
