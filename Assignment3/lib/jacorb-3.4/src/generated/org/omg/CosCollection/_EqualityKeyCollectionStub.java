...
public class _EqualityKeyCollectionStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosCollection.EqualityKeyCollection
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CosCollection.EqualityKeyCollectionOperations.class;
	public int remove_all_elements_with_key(org.omg.CORBA.Any key) throws org.omg.CosCollection.KeyInvalid
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			EqualityKeyCollectionOperations _localServant = (EqualityKeyCollectionOperations)_so.servant;
			int _result;
			try
			{
