...
public class _HeapFactoryStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosCollection.HeapFactory
{
	/** Serial version UID. */
	private static final long serialVersionUID = 1L;
	private String[] ids = {"IDL:omg.org/CosCollection/HeapFactory:1.0","IDL:omg.org/CosCollection/CollectionFactory:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = org.omg.CosCollection.HeapFactoryOperations.class;
	public org.omg.CosCollection.Heap create(org.omg.CosCollection.Operations ops, int expected_size)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					_is = _invoke(_os);
					org.omg.CosCollection.Heap _result = org.omg.CosCollection.HeapHelper.read(_is);
					return _result;
				}
		...
		else
		{
			...
			if( _so == null )
				continue;
			HeapFactoryOperations _localServant = (HeapFactoryOperations)_so.servant;
			org.omg.CosCollection.Heap _result;
			try
			{
