...
public class _SortedRelationFactoryStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosCollection.SortedRelationFactory
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CosCollection.SortedRelationFactoryOperations.class;
	public org.omg.CosCollection.SortedRelation create(org.omg.CosCollection.Operations ops, int expected_size)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					_is = _invoke(_os);
					org.omg.CosCollection.SortedRelation _result = org.omg.CosCollection.SortedRelationHelper.read(_is);
					return _result;
				}
		...
		else
		{
			...
			if( _so == null )
				continue;
			SortedRelationFactoryOperations _localServant = (SortedRelationFactoryOperations)_so.servant;
			org.omg.CosCollection.SortedRelation _result;
			try
			{
