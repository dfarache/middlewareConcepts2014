...
public class _EqualitySequenceStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosCollection.EqualitySequence
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CosCollection.EqualitySequenceOperations.class;
	public boolean locate_next_element(org.omg.CORBA.Any element, org.omg.CosCollection.Iterator where) throws org.omg.CosCollection.ElementInvalid,org.omg.CosCollection.IteratorInvalid
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			EqualitySequenceOperations _localServant = (EqualitySequenceOperations)_so.servant;
			boolean _result;
			try
			{
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					org.omg.CosCollection.EqualitySequenceHelper.write(_os,collector);
					_is = _invoke(_os);
					boolean _result = _is.read_boolean();
					return _result;
				}
