...
public abstract class EqualitySortedIteratorHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(EqualitySortedIteratorHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:omg.org/CosCollection/EqualitySortedIterator:1.0", "EqualitySortedIterator");
				}
			}
		}
		return _type;
