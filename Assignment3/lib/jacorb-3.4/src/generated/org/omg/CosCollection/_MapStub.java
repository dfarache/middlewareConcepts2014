...
public class _MapStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosCollection.Map
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CosCollection.MapOperations.class;
	public int remove_all_elements_with_key(org.omg.CORBA.Any key) throws org.omg.CosCollection.KeyInvalid
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			MapOperations _localServant = (MapOperations)_so.servant;
			int _result;
			try
			{
	...
	public void add_intersection(org.omg.CosCollection.Map collector1, org.omg.CosCollection.Map collector2) throws org.omg.CosCollection.ElementInvalid
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "add_intersection", true);
					org.omg.CosCollection.MapHelper.write(_os,collector1);
					org.omg.CosCollection.MapHelper.write(_os,collector2);
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "add_intersection", _opsClass );
			if( _so == null )
				continue;
			MapOperations _localServant = (MapOperations)_so.servant;
			try
			{
				_localServant.add_intersection(collector1,collector2);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
	...
	public void difference_with(org.omg.CosCollection.Map collector) throws org.omg.CosCollection.ElementInvalid
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "difference_with", true);
					org.omg.CosCollection.MapHelper.write(_os,collector);
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "difference_with", _opsClass );
			if( _so == null )
				continue;
			MapOperations _localServant = (MapOperations)_so.servant;
			try
			{
				_localServant.difference_with(collector);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
	...
	public void intersection_with(org.omg.CosCollection.Map collector) throws org.omg.CosCollection.ElementInvalid
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "intersection_with", true);
					org.omg.CosCollection.MapHelper.write(_os,collector);
					_is = _invoke(_os);
					return;
				}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "intersection_with", _opsClass );
			if( _so == null )
				continue;
			MapOperations _localServant = (MapOperations)_so.servant;
			try
			{
				_localServant.intersection_with(collector);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
	...
	public void union_with(org.omg.CosCollection.Map collector) throws org.omg.CosCollection.ElementInvalid
	{
		while(true)
		{
			if(! this._is_local())
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "union_with", _opsClass );
			if( _so == null )
				continue;
			MapOperations _localServant = (MapOperations)_so.servant;
			try
			{
				_localServant.union_with(collector);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
	...
	public boolean equal(org.omg.CosCollection.Map collector) throws org.omg.CosCollection.ElementInvalid
	{
		while(true)
		{
			if(! this._is_local())
		...
		else
		{
			...
			try
			{
				_result = _localServant.equal(collector);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
	...
	public void add_union(org.omg.CosCollection.Map collector1, org.omg.CosCollection.Map collector2) throws org.omg.CosCollection.ElementInvalid
	{
		while(true)
		{
			if(! this._is_local())
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "add_union", _opsClass );
			if( _so == null )
				continue;
			MapOperations _localServant = (MapOperations)_so.servant;
			try
			{
				_localServant.add_union(collector1,collector2);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
	...
	public void add_difference(org.omg.CosCollection.Map collector1, org.omg.CosCollection.Map collector2) throws org.omg.CosCollection.ElementInvalid
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "add_difference", true);
					org.omg.CosCollection.MapHelper.write(_os,collector1);
					org.omg.CosCollection.MapHelper.write(_os,collector2);
					_is = _invoke(_os);
					return;
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "add_difference", _opsClass );
			if( _so == null )
				continue;
			MapOperations _localServant = (MapOperations)_so.servant;
			try
			{
				_localServant.add_difference(collector1,collector2);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
	...
	public boolean not_equal(org.omg.CosCollection.Map collector) throws org.omg.CosCollection.ElementInvalid
	{
		while(true)
		{
			if(! this._is_local())
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "not_equal", _opsClass );
			if( _so == null )
				continue;
			MapOperations _localServant = (MapOperations)_so.servant;
			boolean _result;
			try
			{
				_result = _localServant.not_equal(collector);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
