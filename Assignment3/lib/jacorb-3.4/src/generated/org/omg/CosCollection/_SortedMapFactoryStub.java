...
public class _SortedMapFactoryStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosCollection.SortedMapFactory
{
	/** Serial version UID. */
	private static final long serialVersionUID = 1L;
	private String[] ids = {"IDL:omg.org/CosCollection/SortedMapFactory:1.0","IDL:omg.org/CosCollection/CollectionFactory:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = org.omg.CosCollection.SortedMapFactoryOperations.class;
	public org.omg.CosCollection.SortedMap create(org.omg.CosCollection.Operations ops, int expected_size)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					_is = _invoke(_os);
					org.omg.CosCollection.SortedMap _result = org.omg.CosCollection.SortedMapHelper.read(_is);
					return _result;
				}
		...
		else
		{
			...
			if( _so == null )
				continue;
			SortedMapFactoryOperations _localServant = (SortedMapFactoryOperations)_so.servant;
			org.omg.CosCollection.SortedMap _result;
			try
			{
