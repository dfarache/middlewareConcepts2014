	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosCollection.KeyIteratorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "set_to_next_element_with_different_key", Integer.valueOf(7));
		m_opsHash.put ( "set_to_next_element_with_key", Integer.valueOf(8));
		m_opsHash.put ( "is_equal", Integer.valueOf(9));
		m_opsHash.put ( "clone", Integer.valueOf(10));
		m_opsHash.put ( "retrieve_element_set_to_next", Integer.valueOf(11));
		m_opsHash.put ( "set_to_first_element", Integer.valueOf(12));
		m_opsHash.put ( "is_in_between", Integer.valueOf(13));
		m_opsHash.put ( "set_to_next_nth_element", Integer.valueOf(14));
		m_opsHash.put ( "retrieve_next_n_keys", Integer.valueOf(15));
		m_opsHash.put ( "not_equal_remove_element_set_to_next", Integer.valueOf(16));
		m_opsHash.put ( "replace_element_set_to_next", Integer.valueOf(17));
		m_opsHash.put ( "not_equal_replace_element_set_to_next", Integer.valueOf(18));
		m_opsHash.put ( "invalidate", Integer.valueOf(19));
		m_opsHash.put ( "set_to_next_element", Integer.valueOf(20));
		m_opsHash.put ( "remove_element", Integer.valueOf(21));
		m_opsHash.put ( "is_for", Integer.valueOf(22));
		m_opsHash.put ( "add_element_set_iterator", Integer.valueOf(23));
		m_opsHash.put ( "is_valid", Integer.valueOf(24));
		m_opsHash.put ( "retrieve_element", Integer.valueOf(25));
		m_opsHash.put ( "is_const", Integer.valueOf(26));
		m_opsHash.put ( "set_to_element_with_key", Integer.valueOf(27));
		m_opsHash.put ( "add_n_elements_set_iterator", Integer.valueOf(28));
		m_opsHash.put ( "not_equal_retrieve_element_set_to_next", Integer.valueOf(29));
