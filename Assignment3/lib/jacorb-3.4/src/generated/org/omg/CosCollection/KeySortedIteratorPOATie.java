...
public class KeySortedIteratorPOATie
	extends KeySortedIteratorPOA
{
	private KeySortedIteratorOperations _delegate;

	private POA _poa;
	public KeySortedIteratorPOATie(KeySortedIteratorOperations delegate)
	{
		_delegate = delegate;
	}
	public KeySortedIteratorPOATie(KeySortedIteratorOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public KeySortedIteratorOperations _delegate()
	{
		return _delegate;
	}
