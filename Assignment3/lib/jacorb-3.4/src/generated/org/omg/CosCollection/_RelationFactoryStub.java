...
public class _RelationFactoryStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosCollection.RelationFactory
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CosCollection.RelationFactoryOperations.class;
	public org.omg.CosCollection.Relation create(org.omg.CosCollection.Operations ops, int expected_size)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					_is = _invoke(_os);
					org.omg.CosCollection.Relation _result = org.omg.CosCollection.RelationHelper.read(_is);
					return _result;
				}
		...
		else
		{
			...
			if( _so == null )
				continue;
			RelationFactoryOperations _localServant = (RelationFactoryOperations)_so.servant;
			org.omg.CosCollection.Relation _result;
			try
			{
