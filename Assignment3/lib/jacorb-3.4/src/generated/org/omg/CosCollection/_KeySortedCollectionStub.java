...
public class _KeySortedCollectionStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosCollection.KeySortedCollection
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CosCollection.KeySortedCollectionOperations.class;
	public int remove_all_elements_with_key(org.omg.CORBA.Any key) throws org.omg.CosCollection.KeyInvalid
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			KeySortedCollectionOperations _localServant = (KeySortedCollectionOperations)_so.servant;
			int _result;
			try
			{
