		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult1100 = collection_interface;
_os.write_string( tmpResult1100 );
					java.lang.String tmpResult1101 = impl_category;
_os.write_string( tmpResult1101 );
					java.lang.String tmpResult1102 = impl_interface;
_os.write_string( tmpResult1102 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult1103 = collection_interface;
_os.write_string( tmpResult1103 );
					java.lang.String tmpResult1104 = impl_category;
_os.write_string( tmpResult1104 );
					java.lang.String tmpResult1105 = impl_interface;
_os.write_string( tmpResult1105 );
					_is = _invoke(_os);
					boolean _result = _is.read_boolean();
					return _result;
				}
