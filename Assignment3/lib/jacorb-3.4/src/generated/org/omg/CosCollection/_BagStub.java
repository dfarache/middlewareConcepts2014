...
public class _BagStub
	...
	implements org.omg.CosCollection.Bag
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CosCollection.BagOperations.class;
	public boolean locate_or_add_element_set_iterator(org.omg.CORBA.Any element, org.omg.CosCollection.Iterator where) throws org.omg.CosCollection.ElementInvalid,org.omg.CosCollection.IteratorInvalid
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			BagOperations _localServant = (BagOperations)_so.servant;
			boolean _result;
			try
			{
