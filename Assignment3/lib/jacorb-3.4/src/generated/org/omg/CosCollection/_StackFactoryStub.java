...
public class _StackFactoryStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosCollection.StackFactory
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CosCollection.StackFactoryOperations.class;
	public org.omg.CosCollection.Stack create(org.omg.CosCollection.Operations ops, int expected_size)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					_is = _invoke(_os);
					org.omg.CosCollection.Stack _result = org.omg.CosCollection.StackHelper.read(_is);
					return _result;
				}
		...
		else
		{
			...
			if( _so == null )
				continue;
			StackFactoryOperations _localServant = (StackFactoryOperations)_so.servant;
			org.omg.CosCollection.Stack _result;
			try
			{
