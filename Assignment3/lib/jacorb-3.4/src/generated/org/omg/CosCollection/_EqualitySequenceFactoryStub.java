...
public class _EqualitySequenceFactoryStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosCollection.EqualitySequenceFactory
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CosCollection.EqualitySequenceFactoryOperations.class;
	public org.omg.CosCollection.EqualitySequence create(org.omg.CosCollection.Operations ops, int expected_size)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					_is = _invoke(_os);
					org.omg.CosCollection.EqualitySequence _result = org.omg.CosCollection.EqualitySequenceHelper.read(_is);
					return _result;
				}
		...
		else
		{
			...
			if( _so == null )
				continue;
			EqualitySequenceFactoryOperations _localServant = (EqualitySequenceFactoryOperations)_so.servant;
			org.omg.CosCollection.EqualitySequence _result;
			try
			{
