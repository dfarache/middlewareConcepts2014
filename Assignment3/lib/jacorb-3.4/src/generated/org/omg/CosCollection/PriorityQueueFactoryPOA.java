...
public abstract class PriorityQueueFactoryPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosCollection.PriorityQueueFactoryOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			case 0: // create
			{
				...
				org.omg.CosCollection.PriorityQueueHelper.write(_out,create(_arg0,_arg1));
				break;
			}
