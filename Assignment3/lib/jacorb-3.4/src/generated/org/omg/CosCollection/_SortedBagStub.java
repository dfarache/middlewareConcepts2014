...
public class _SortedBagStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosCollection.SortedBag
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CosCollection.SortedBagOperations.class;
	public boolean locate_next_element(org.omg.CORBA.Any element, org.omg.CosCollection.Iterator where) throws org.omg.CosCollection.ElementInvalid,org.omg.CosCollection.IteratorInvalid
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			SortedBagOperations _localServant = (SortedBagOperations)_so.servant;
			boolean _result;
			try
			{
	...
	public boolean locate_previous_element(org.omg.CORBA.Any element, org.omg.CosCollection.Iterator where) throws org.omg.CosCollection.ElementInvalid,org.omg.CosCollection.IteratorInvalid
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "locate_previous_element", true);
					_os.write_any(element);
					org.omg.CosCollection.IteratorHelper.write(_os,where);
					_is = _invoke(_os);
					boolean _result = _is.read_boolean();
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "locate_previous_element", _opsClass );
			if( _so == null )
				continue;
			SortedBagOperations _localServant = (SortedBagOperations)_so.servant;
			boolean _result;
			try
			{
				_result = _localServant.locate_previous_element(element,where);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
	...
	public int compare(org.omg.CosCollection.SortedBag collector, org.omg.CosCollection.Comparator comparison)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					org.omg.CosCollection.SortedBagHelper.write(_os,collector);
	...
	public boolean locate_previous_different_element(org.omg.CosCollection.Iterator where) throws org.omg.CosCollection.IteratorInvalid
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "locate_previous_different_element", true);
					org.omg.CosCollection.IteratorHelper.write(_os,where);
					_is = _invoke(_os);
					boolean _result = _is.read_boolean();
					return _result;
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "locate_previous_different_element", _opsClass );
			if( _so == null )
				continue;
			SortedBagOperations _localServant = (SortedBagOperations)_so.servant;
			boolean _result;
			try
			{
				_result = _localServant.locate_previous_different_element(where);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
	...
	public boolean locate_first_element(org.omg.CORBA.Any element, org.omg.CosCollection.Iterator where) throws org.omg.CosCollection.ElementInvalid,org.omg.CosCollection.IteratorInvalid
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "locate_first_element", true);
					_os.write_any(element);
					org.omg.CosCollection.IteratorHelper.write(_os,where);
					_is = _invoke(_os);
					boolean _result = _is.read_boolean();
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "locate_first_element", _opsClass );
			if( _so == null )
				continue;
			SortedBagOperations _localServant = (SortedBagOperations)_so.servant;
			boolean _result;
			try
			{
				_result = _localServant.locate_first_element(element,where);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
	...
	public boolean locate_last_element(org.omg.CORBA.Any element, org.omg.CosCollection.Iterator where) throws org.omg.CosCollection.ElementInvalid,org.omg.CosCollection.IteratorInvalid
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "locate_last_element", true);
					_os.write_any(element);
					org.omg.CosCollection.IteratorHelper.write(_os,where);
					_is = _invoke(_os);
					boolean _result = _is.read_boolean();
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "locate_last_element", _opsClass );
			if( _so == null )
				continue;
			SortedBagOperations _localServant = (SortedBagOperations)_so.servant;
			boolean _result;
			try
			{
				_result = _localServant.locate_last_element(element,where);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
