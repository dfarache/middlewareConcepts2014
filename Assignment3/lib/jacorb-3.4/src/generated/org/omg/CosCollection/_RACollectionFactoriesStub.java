...
public class _RACollectionFactoriesStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosCollection.RACollectionFactories
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CosCollection.RACollectionFactoriesOperations.class;
	public org.omg.CosCollection.RestrictedAccessCollection generic_create(org.omg.CosCollection.NVPair[] parameters) throws org.omg.CosCollection.ParameterInvalid
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			RACollectionFactoriesOperations _localServant = (RACollectionFactoriesOperations)_so.servant;
			...
			catch (org.omg.CosCollection.ParameterInvalid ex) 
			{
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult1106 = collection_interface;
_os.write_string( tmpResult1106 );
					java.lang.String tmpResult1107 = impl_category;
_os.write_string( tmpResult1107 );
					java.lang.String tmpResult1108 = impl_interface;
_os.write_string( tmpResult1108 );
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult1109 = collection_interface;
_os.write_string( tmpResult1109 );
					java.lang.String tmpResult1110 = impl_category;
_os.write_string( tmpResult1110 );
					java.lang.String tmpResult1111 = impl_interface;
_os.write_string( tmpResult1111 );
					org.omg.CosCollection.RACollectionFactoryHelper.write(_os,factory);
					_is = _invoke(_os);
					boolean _result = _is.read_boolean();
					return _result;
				}
