	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosCollection.EqualitySequentialIteratorOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "set_to_first_element_with_value", Integer.valueOf(5));
		m_opsHash.put ( "add_element_as_previous_set_iterator", Integer.valueOf(6));
		m_opsHash.put ( "remove_next_n_elements", Integer.valueOf(7));
		m_opsHash.put ( "set_to_next_nth_element", Integer.valueOf(8));
		m_opsHash.put ( "replace_element", Integer.valueOf(9));
		m_opsHash.put ( "add_n_elements_as_previous_set_iterator", Integer.valueOf(10));
		...
		m_opsHash.put ( "set_to_last_element_with_value", Integer.valueOf(17));
		m_opsHash.put ( "retrieve_next_n_elements", Integer.valueOf(18));
		m_opsHash.put ( "set_to_previous_element", Integer.valueOf(19));
		m_opsHash.put ( "replace_previous_n_elements", Integer.valueOf(20));
		...
		m_opsHash.put ( "add_element_as_next_set_iterator", Integer.valueOf(25));
		m_opsHash.put ( "set_to_last_element", Integer.valueOf(26));
		m_opsHash.put ( "not_equal_retrieve_element_set_to_next", Integer.valueOf(27));
		m_opsHash.put ( "set_to_previous_element_with_value", Integer.valueOf(28));
		m_opsHash.put ( "not_equal_replace_element_set_to_previous", Integer.valueOf(29));
		m_opsHash.put ( "remove_element_set_to_previous", Integer.valueOf(30));
		m_opsHash.put ( "remove_element", Integer.valueOf(31));
		m_opsHash.put ( "not_equal_remove_element_set_to_next", Integer.valueOf(32));
		m_opsHash.put ( "is_equal", Integer.valueOf(33));
		...
		m_opsHash.put ( "not_equal_replace_element_set_to_next", Integer.valueOf(41));
		m_opsHash.put ( "replace_element_set_to_next", Integer.valueOf(42));
		m_opsHash.put ( "is_for", Integer.valueOf(43));
		m_opsHash.put ( "is_first", Integer.valueOf(44));
		m_opsHash.put ( "set_to_element_with_value", Integer.valueOf(45));
		m_opsHash.put ( "add_element_set_iterator", Integer.valueOf(46));
		m_opsHash.put ( "replace_next_n_elements", Integer.valueOf(47));
		m_opsHash.put ( "set_to_next_element_with_different_value", Integer.valueOf(48));
