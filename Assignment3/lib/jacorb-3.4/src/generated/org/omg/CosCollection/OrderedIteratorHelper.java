...
public abstract class OrderedIteratorHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(OrderedIteratorHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:omg.org/CosCollection/OrderedIterator:1.0", "OrderedIterator");
				}
			}
		}
		return _type;
