...
public abstract class EqualitySequentialIteratorHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(EqualitySequentialIteratorHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:omg.org/CosCollection/EqualitySequentialIterator:1.0", "EqualitySequentialIterator");
				}
			}
		}
		return _type;
