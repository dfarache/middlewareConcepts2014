...
public class _EqualityCollectionStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosCollection.EqualityCollection
{
	/** Serial version UID. */
	private static final long serialVersionUID = 1L;
	private String[] ids = {"IDL:omg.org/CosCollection/EqualityCollection:1.0","IDL:omg.org/CosCollection/Collection:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = org.omg.CosCollection.EqualityCollectionOperations.class;
	public boolean locate_or_add_element_set_iterator(org.omg.CORBA.Any element, org.omg.CosCollection.Iterator where) throws org.omg.CosCollection.ElementInvalid,org.omg.CosCollection.IteratorInvalid
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			EqualityCollectionOperations _localServant = (EqualityCollectionOperations)_so.servant;
			boolean _result;
			try
			{
