...
public abstract class KeySortedIteratorPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosCollection.KeySortedIteratorOperations
{
	static private final java.util.HashMap<String,Integer> m_opsHash = new java.util.HashMap<String,Integer>();
	static
	{
		m_opsHash.put ( "clone", Integer.valueOf(0));
		m_opsHash.put ( "replace_element_set_to_previous", Integer.valueOf(1));
		m_opsHash.put ( "add_n_elements_set_iterator", Integer.valueOf(2));
		m_opsHash.put ( "is_valid", Integer.valueOf(3));
		m_opsHash.put ( "set_to_first_element_with_key", Integer.valueOf(4));
		m_opsHash.put ( "remove_next_n_elements", Integer.valueOf(5));
		m_opsHash.put ( "set_to_next_nth_element", Integer.valueOf(6));
		m_opsHash.put ( "replace_element", Integer.valueOf(7));
		m_opsHash.put ( "set_to_previous_element_with_key", Integer.valueOf(8));
		m_opsHash.put ( "is_for_same", Integer.valueOf(9));
		...
		m_opsHash.put ( "set_to_next_element_with_different_key", Integer.valueOf(14));
		m_opsHash.put ( "retrieve_element", Integer.valueOf(15));
		m_opsHash.put ( "set_to_first_element", Integer.valueOf(16));
		m_opsHash.put ( "retrieve_next_n_elements", Integer.valueOf(17));
		m_opsHash.put ( "set_to_previous_element", Integer.valueOf(18));
		m_opsHash.put ( "replace_previous_n_elements", Integer.valueOf(19));
		m_opsHash.put ( "is_last", Integer.valueOf(20));
		m_opsHash.put ( "set_to_next_element", Integer.valueOf(21));
		m_opsHash.put ( "set_to_nth_previous_element", Integer.valueOf(22));
		m_opsHash.put ( "destroy", Integer.valueOf(23));
		m_opsHash.put ( "set_to_last_element", Integer.valueOf(24));
		...
		m_opsHash.put ( "retrieve_next_n_keys", Integer.valueOf(32));
		m_opsHash.put ( "invalidate", Integer.valueOf(33));
		m_opsHash.put ( "remove_element_set_to_next", Integer.valueOf(34));
		m_opsHash.put ( "retrieve_previous_n_elements", Integer.valueOf(35));
		m_opsHash.put ( "remove_previous_n_elements", Integer.valueOf(36));
		m_opsHash.put ( "not_equal_remove_element_set_to_previous", Integer.valueOf(37));
		m_opsHash.put ( "set_to_element_with_key", Integer.valueOf(38));
		m_opsHash.put ( "retrieve_previous_n_keys", Integer.valueOf(39));
		m_opsHash.put ( "not_equal_replace_element_set_to_next", Integer.valueOf(40));
		m_opsHash.put ( "replace_element_set_to_next", Integer.valueOf(41));
		m_opsHash.put ( "set_to_previous_element_with_different_key", Integer.valueOf(42));
		m_opsHash.put ( "is_for", Integer.valueOf(43));
		m_opsHash.put ( "retrieve_key", Integer.valueOf(44));
		m_opsHash.put ( "is_first", Integer.valueOf(45));
		m_opsHash.put ( "set_to_next_element_with_key", Integer.valueOf(46));
		m_opsHash.put ( "add_element_set_iterator", Integer.valueOf(47));
		m_opsHash.put ( "replace_next_n_elements", Integer.valueOf(48));
		m_opsHash.put ( "not_equal_retrieve_element_set_to_previous", Integer.valueOf(49));
		m_opsHash.put ( "retrieve_element_set_to_next", Integer.valueOf(50));
		m_opsHash.put ( "is_const", Integer.valueOf(51));
		m_opsHash.put ( "set_to_position", Integer.valueOf(52));
		m_opsHash.put ( "is_in_between", Integer.valueOf(53));
	}
	...
	public org.omg.CosCollection.KeySortedIterator _this()
	{
		org.omg.CORBA.Object __o = _this_object() ;
		org.omg.CosCollection.KeySortedIterator __r = org.omg.CosCollection.KeySortedIteratorHelper.narrow(__o);
		return __r;
	}
	public org.omg.CosCollection.KeySortedIterator _this(org.omg.CORBA.ORB orb)
	{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 1: // replace_element_set_to_previous
			{
			try
			{
			...
			case 2: // add_n_elements_set_iterator
			{
			try
			{
			...
			case 4: // set_to_first_element_with_key
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 8: // set_to_previous_element_with_key
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 14: // set_to_next_element_with_different_key
			{
			try
			{
				_out = handler.createReply();
			...
			case 17: // retrieve_next_n_elements
			{
			try
			{
				int _arg0=_input.read_ulong();
			...
			case 22: // set_to_nth_previous_element
			{
			try
			{
				int _arg0=_input.read_ulong();
			...
			case 34: // remove_element_set_to_next
			{
			try
			{
				_out = handler.createReply();
			...
			case 35: // retrieve_previous_n_elements
			{
			try
			{
				int _arg0=_input.read_ulong();
			...
			case 36: // remove_previous_n_elements
			{
			try
			{
				int _arg0=_input.read_ulong();
			...
			case 37: // not_equal_remove_element_set_to_previous
			{
			try
			{
				org.omg.CosCollection.Iterator _arg0=org.omg.CosCollection.IteratorHelper.read(_input);
			...
			case 38: // set_to_element_with_key
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 39: // retrieve_previous_n_keys
			{
			try
			{
				org.omg.CosCollection.AnySequenceHolder _arg0= new org.omg.CosCollection.AnySequenceHolder();
			...
			case 40: // not_equal_replace_element_set_to_next
			{
			try
			{
				org.omg.CosCollection.Iterator _arg0=org.omg.CosCollection.IteratorHelper.read(_input);
			...
			case 41: // replace_element_set_to_next
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 42: // set_to_previous_element_with_different_key
			{
			try
			{
				_out = handler.createReply();
			...
			case 46: // set_to_next_element_with_key
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 47: // add_element_set_iterator
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 48: // replace_next_n_elements
			{
			try
			{
				org.omg.CORBA.Any[] _arg0=org.omg.CosCollection.AnySequenceHelper.read(_input);
