...
public class _KeySetStub
	...
	implements org.omg.CosCollection.KeySet
{
	/** Serial version UID. */
	private static final long serialVersionUID = 1L;
	private String[] ids = {"IDL:omg.org/CosCollection/KeySet:1.0","IDL:omg.org/CosCollection/KeyCollection:1.0","IDL:omg.org/CosCollection/Collection:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = org.omg.CosCollection.KeySetOperations.class;
	public boolean add_or_replace_element_with_key_set_iterator(org.omg.CORBA.Any element, org.omg.CosCollection.Iterator where) throws org.omg.CosCollection.ElementInvalid,org.omg.CosCollection.IteratorInvalid
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			KeySetOperations _localServant = (KeySetOperations)_so.servant;
			boolean _result;
			try
			{
