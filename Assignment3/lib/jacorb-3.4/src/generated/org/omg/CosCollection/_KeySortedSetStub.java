...
public class _KeySortedSetStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosCollection.KeySortedSet
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CosCollection.KeySortedSetOperations.class;
	public int remove_all_elements_with_key(org.omg.CORBA.Any key) throws org.omg.CosCollection.KeyInvalid
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			KeySortedSetOperations _localServant = (KeySortedSetOperations)_so.servant;
			int _result;
			try
			{
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					org.omg.CosCollection.KeySortedSetHelper.write(_os,collector);
