...
public class _SortedMapStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosCollection.SortedMap
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CosCollection.SortedMapOperations.class;
	public int remove_all_elements_with_key(org.omg.CORBA.Any key) throws org.omg.CosCollection.KeyInvalid
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			SortedMapOperations _localServant = (SortedMapOperations)_so.servant;
			int _result;
			try
			{
	...
	public int compare(org.omg.CosCollection.SortedMap collector, org.omg.CosCollection.Comparator comparison)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					org.omg.CosCollection.SortedMapHelper.write(_os,collector);
