...
public abstract class KeySortedCollectionPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosCollection.KeySortedCollectionOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "create_ordered_iterator", Integer.valueOf(27));
		m_opsHash.put ( "add_all_from", Integer.valueOf(28));
		m_opsHash.put ( "number_of_elements", Integer.valueOf(29));
		m_opsHash.put ( "locate_next_element_with_different_key", Integer.valueOf(30));
		m_opsHash.put ( "locate_last_element_with_key", Integer.valueOf(31));
		m_opsHash.put ( "remove_element_at", Integer.valueOf(32));
		m_opsHash.put ( "number_of_different_keys", Integer.valueOf(33));
		m_opsHash.put ( "remove_all", Integer.valueOf(34));
		m_opsHash.put ( "replace_element_with_key", Integer.valueOf(35));
		m_opsHash.put ( "contains_element_with_key", Integer.valueOf(36));
		m_opsHash.put ( "add_element_set_iterator", Integer.valueOf(37));
		m_opsHash.put ( "remove_last_element", Integer.valueOf(38));
		m_opsHash.put ( "all_elements_do", Integer.valueOf(39));
		m_opsHash.put ( "retrieve_element_with_key", Integer.valueOf(40));
		m_opsHash.put ( "locate_previous_element_with_key", Integer.valueOf(41));
		m_opsHash.put ( "key", Integer.valueOf(42));
	}
	private String[] ids = {"IDL:omg.org/CosCollection/KeySortedCollection:1.0","IDL:omg.org/CosCollection/KeyCollection:1.0","IDL:omg.org/CosCollection/Collection:1.0","IDL:omg.org/CosCollection/OrderedCollection:1.0","IDL:omg.org/CosCollection/SortedCollection:1.0"};
	public org.omg.CosCollection.KeySortedCollection _this()
	{
		org.omg.CORBA.Object __o = _this_object() ;
		org.omg.CosCollection.KeySortedCollection __r = org.omg.CosCollection.KeySortedCollectionHelper.narrow(__o);
		return __r;
	}
	public org.omg.CosCollection.KeySortedCollection _this(org.omg.CORBA.ORB orb)
	{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 27: // create_ordered_iterator
			{
				boolean _arg0=_input.read_boolean();
			...
			case 30: // locate_next_element_with_different_key
			{
			try
			{
				org.omg.CosCollection.Iterator _arg0=org.omg.CosCollection.IteratorHelper.read(_input);
			...
			case 31: // locate_last_element_with_key
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 33: // number_of_different_keys
			{
				_out = handler.createReply();
			...
			case 35: // replace_element_with_key
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 36: // contains_element_with_key
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 41: // locate_previous_element_with_key
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
