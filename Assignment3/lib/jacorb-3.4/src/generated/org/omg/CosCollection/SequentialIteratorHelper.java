...
public abstract class SequentialIteratorHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(SequentialIteratorHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:omg.org/CosCollection/SequentialIterator:1.0", "SequentialIterator");
				}
			}
		}
		return _type;
