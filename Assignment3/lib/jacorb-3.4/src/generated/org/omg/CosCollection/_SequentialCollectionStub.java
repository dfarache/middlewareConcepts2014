...
public class _SequentialCollectionStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosCollection.SequentialCollection
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CosCollection.SequentialCollectionOperations.class;
	public void add_element_as_last(org.omg.CORBA.Any element) throws org.omg.CosCollection.ElementInvalid
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			SequentialCollectionOperations _localServant = (SequentialCollectionOperations)_so.servant;
			try
			{
