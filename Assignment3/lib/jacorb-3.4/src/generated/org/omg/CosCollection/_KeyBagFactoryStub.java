...
public class _KeyBagFactoryStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosCollection.KeyBagFactory
{
	/** Serial version UID. */
	private static final long serialVersionUID = 1L;
	private String[] ids = {"IDL:omg.org/CosCollection/KeyBagFactory:1.0","IDL:omg.org/CosCollection/CollectionFactory:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = org.omg.CosCollection.KeyBagFactoryOperations.class;
	public org.omg.CosCollection.KeyBag create(org.omg.CosCollection.Operations ops, int expected_size)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					_is = _invoke(_os);
					org.omg.CosCollection.KeyBag _result = org.omg.CosCollection.KeyBagHelper.read(_is);
					return _result;
				}
		...
		else
		{
			...
			if( _so == null )
				continue;
			KeyBagFactoryOperations _localServant = (KeyBagFactoryOperations)_so.servant;
			org.omg.CosCollection.KeyBag _result;
			try
			{
