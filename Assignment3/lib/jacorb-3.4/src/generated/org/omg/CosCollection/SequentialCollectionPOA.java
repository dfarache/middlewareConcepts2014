...
public abstract class SequentialCollectionPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosCollection.SequentialCollectionOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "add_element", Integer.valueOf(12));
		...
		m_opsHash.put ( "create_iterator", Integer.valueOf(18));
		m_opsHash.put ( "replace_first_element", Integer.valueOf(19));
		m_opsHash.put ( "add_element_as_last_set_iterator", Integer.valueOf(20));
		m_opsHash.put ( "add_element_set_iterator", Integer.valueOf(21));
		m_opsHash.put ( "remove_last_element", Integer.valueOf(22));
		m_opsHash.put ( "add_element_as_first_set_iterator", Integer.valueOf(23));
		m_opsHash.put ( "remove_first_element", Integer.valueOf(24));
		...
		m_opsHash.put ( "retrieve_last_element", Integer.valueOf(28));
		m_opsHash.put ( "remove_element_at_position", Integer.valueOf(29));
		m_opsHash.put ( "add_all_from", Integer.valueOf(30));
		m_opsHash.put ( "replace_element_at", Integer.valueOf(31));
		m_opsHash.put ( "all_elements_do", Integer.valueOf(32));
	}
	private String[] ids = {"IDL:omg.org/CosCollection/SequentialCollection:1.0","IDL:omg.org/CosCollection/Collection:1.0","IDL:omg.org/CosCollection/OrderedCollection:1.0"};
	public org.omg.CosCollection.SequentialCollection _this()
	{
		org.omg.CORBA.Object __o = _this_object() ;
		org.omg.CosCollection.SequentialCollection __r = org.omg.CosCollection.SequentialCollectionHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 20: // add_element_as_last_set_iterator
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 23: // add_element_as_first_set_iterator
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
