...
public class _EqualitySequentialIteratorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosCollection.EqualitySequentialIterator
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CosCollection.EqualitySequentialIteratorOperations.class;
	public org.omg.CosCollection.Iterator _clone()
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			EqualitySequentialIteratorOperations _localServant = (EqualitySequentialIteratorOperations)_so.servant;
	...
	public boolean set_to_first_element_with_value(org.omg.CORBA.Any element) throws org.omg.CosCollection.ElementInvalid
	{
		...
		else
		{
			...
			try
			{
				_result = _localServant.set_to_first_element_with_value(element);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
	...
	public boolean set_to_last_element_with_value(org.omg.CORBA.Any element) throws org.omg.CosCollection.ElementInvalid
	{
		...
		else
		{
			...
			try
			{
				_result = _localServant.set_to_last_element_with_value(element);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
	...
	public boolean set_to_previous_element_with_value(org.omg.CORBA.Any element) throws org.omg.CosCollection.ElementInvalid
	{
		...
		else
		{
			...
			try
			{
				_result = _localServant.set_to_previous_element_with_value(element);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
