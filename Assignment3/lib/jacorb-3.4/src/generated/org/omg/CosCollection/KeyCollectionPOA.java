...
public abstract class KeyCollectionPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosCollection.KeyCollectionOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "number_of_elements", Integer.valueOf(3));
		m_opsHash.put ( "number_of_different_keys", Integer.valueOf(4));
		...
		m_opsHash.put ( "_get_element_type", Integer.valueOf(11));
		m_opsHash.put ( "key", Integer.valueOf(12));
		...
		m_opsHash.put ( "replace_element_with_key_set_iterator", Integer.valueOf(17));
		m_opsHash.put ( "is_empty", Integer.valueOf(18));
		m_opsHash.put ( "create_iterator", Integer.valueOf(19));
		m_opsHash.put ( "locate_next_element_with_key", Integer.valueOf(20));
		m_opsHash.put ( "locate_or_add_element_with_key_set_iterator", Integer.valueOf(21));
		m_opsHash.put ( "add_element_set_iterator", Integer.valueOf(22));
		m_opsHash.put ( "locate_element_with_key", Integer.valueOf(23));
		m_opsHash.put ( "contains_all_keys_from", Integer.valueOf(24));
		m_opsHash.put ( "remove_all", Integer.valueOf(25));
		m_opsHash.put ( "remove_all_elements_with_key", Integer.valueOf(26));
		m_opsHash.put ( "destroy", Integer.valueOf(27));
		m_opsHash.put ( "add_all_from", Integer.valueOf(28));
		m_opsHash.put ( "contains_element_with_key", Integer.valueOf(29));
		m_opsHash.put ( "all_elements_do", Integer.valueOf(30));
		m_opsHash.put ( "replace_element_at", Integer.valueOf(31));
	}
	private String[] ids = {"IDL:omg.org/CosCollection/KeyCollection:1.0","IDL:omg.org/CosCollection/Collection:1.0"};
	public org.omg.CosCollection.KeyCollection _this()
	{
		org.omg.CORBA.Object __o = _this_object() ;
		org.omg.CosCollection.KeyCollection __r = org.omg.CosCollection.KeyCollectionHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 3: // number_of_elements
			{
				_out = handler.createReply();
				_out.write_ulong(number_of_elements());
				break;
			}
			case 4: // number_of_different_keys
			{
				_out = handler.createReply();
			...
			case 17: // replace_element_with_key_set_iterator
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 20: // locate_next_element_with_key
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 22: // add_element_set_iterator
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 23: // locate_element_with_key
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 26: // remove_all_elements_with_key
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
			...
			case 29: // contains_element_with_key
			{
			try
			{
				org.omg.CORBA.Any _arg0=_input.read_any();
