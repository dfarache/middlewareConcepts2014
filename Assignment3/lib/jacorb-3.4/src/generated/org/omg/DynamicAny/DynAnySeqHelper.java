...
public abstract class DynAnySeqHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(DynAnySeqHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.DynamicAny.DynAnySeqHelper.id(), "DynAnySeq",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.omg.CORBA.ORB.init().create_local_interface_tc("IDL:omg.org/DynamicAny/DynAny:1.0", "DynAny")));
				}
			}
		}
		return _type;
	...
	public static org.omg.DynamicAny.DynAny[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new org.omg.DynamicAny.DynAny[_l_result68];
