	...
	extends _DynSequenceLocalBase
{
	...
	public void _delegate(DynSequenceOperations delegate)
	{
		_delegate = delegate;
	}
...
_delegate.insert_char(value);
	...
	{
_delegate.set_elements_as_dyn_any(value);
	}
...
_delegate.insert_boolean_seq(value);
	...
	{
		return _delegate.get_elements_as_dyn_any();
	}
