	...
	extends _DynEnumLocalBase
{
	...
	public void _delegate(DynEnumOperations delegate)
	{
		_delegate = delegate;
	}
...
_delegate.insert_float(value);
	...
	public void set_as_string(java.lang.String value) throws org.omg.DynamicAny.DynAnyPackage.InvalidValue
	{
_delegate.set_as_string(value);
	}
...
_delegate.insert_ulong(value);
	...
	{
		return _delegate.get_as_string();
	}
