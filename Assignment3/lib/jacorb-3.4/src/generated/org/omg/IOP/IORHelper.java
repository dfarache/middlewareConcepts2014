...
public abstract class IORHelper
{
	...
	public static org.omg.IOP.IOR read (final org.omg.CORBA.portable.InputStream in)
	{
		...
		int _lresult_profiles54 = in.read_long();
		try
		{
			 int x = in.available();
			 if ( x > 0 && _lresult_profiles54 > x )
				{
					throw new org.omg.CORBA.MARSHAL("Sequence length too large. Only " + x + " available and trying to assign " + _lresult_profiles54);
				}
		}
		catch (java.io.IOException e)
		{
		}
		result.profiles = new org.omg.IOP.TaggedProfile[_lresult_profiles54];
	...
	{
		java.lang.String tmpResult987 = s.type_id;
out.write_string( tmpResult987 );
