...
public abstract class SecurityContextHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(SecurityContextHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:omg.org/SecurityReplaceable/SecurityContext:1.0", "SecurityContext");
				}
			}
		}
		return _type;
