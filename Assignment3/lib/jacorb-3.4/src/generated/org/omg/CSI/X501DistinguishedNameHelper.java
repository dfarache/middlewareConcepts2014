...
public abstract class X501DistinguishedNameHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(X501DistinguishedNameHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.CSI.X501DistinguishedNameHelper.id(), "X501DistinguishedName",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.from_int(10))));
				}
			}
		}
		return _type;
	...
	public static byte[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new byte[_l_result129];
		_in.read_octet_array(_result,0,_l_result129);
		return _result;
	}
