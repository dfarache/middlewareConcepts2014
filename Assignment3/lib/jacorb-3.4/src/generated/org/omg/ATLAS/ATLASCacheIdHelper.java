...
public abstract class ATLASCacheIdHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(ATLASCacheIdHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.ATLAS.ATLASCacheIdHelper.id(), "ATLASCacheId",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.from_int(10))));
				}
			}
		}
		return _type;
	...
	{
		return "IDL:omg.org/ATLAS/ATLASCacheId:1.0";
	}
	public static byte[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new byte[_l_result146];
		_in.read_octet_array(_result,0,_l_result146);
		return _result;
	}
