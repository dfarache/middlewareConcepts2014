...
public abstract class SequencePullSupplierAckPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosNotifyCommAck.SequencePullSupplierAckOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "acknowledge", Integer.valueOf(3));
		m_opsHash.put ( "try_pull_structured_events", Integer.valueOf(4));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 4: // try_pull_structured_events
			{
			try
			{
				int _arg0=_input.read_long();
