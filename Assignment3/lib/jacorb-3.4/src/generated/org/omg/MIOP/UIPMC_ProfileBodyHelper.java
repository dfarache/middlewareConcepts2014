...
public abstract class UIPMC_ProfileBodyHelper
{
	...
	public static org.omg.MIOP.UIPMC_ProfileBody read (final org.omg.CORBA.portable.InputStream in)
	{
		...
		int _lresult_components70 = in.read_long();
		try
		{
			 int x = in.available();
			 if ( x > 0 && _lresult_components70 > x )
				{
					throw new org.omg.CORBA.MARSHAL("Sequence length too large. Only " + x + " available and trying to assign " + _lresult_components70);
				}
		}
		catch (java.io.IOException e)
		{
		}
		result.components = new org.omg.IOP.TaggedComponent[_lresult_components70];
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final org.omg.MIOP.UIPMC_ProfileBody s)
	{
		...
		java.lang.String tmpResult997 = s.the_address;
