...
public class _LocalInterfaceDefStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CORBA.LocalInterfaceDef
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CORBA.LocalInterfaceDefOperations.class;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult850 = id;
_os.write_string( tmpResult850 );
					java.lang.String tmpResult851 = name;
_os.write_string( tmpResult851 );
					java.lang.String tmpResult852 = version;
_os.write_string( tmpResult852 );
		...
		else
		{
			...
			if( _so == null )
				continue;
			LocalInterfaceDefOperations _localServant = (LocalInterfaceDefOperations)_so.servant;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult853 = interface_id;
_os.write_string( tmpResult853 );
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult854 = id;
_os.write_string( tmpResult854 );
					java.lang.String tmpResult855 = name;
_os.write_string( tmpResult855 );
					java.lang.String tmpResult856 = version;
_os.write_string( tmpResult856 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult857 = id;
_os.write_string( tmpResult857 );
					java.lang.String tmpResult858 = name;
_os.write_string( tmpResult858 );
					java.lang.String tmpResult859 = version;
_os.write_string( tmpResult859 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult860 = id;
_os.write_string( tmpResult860 );
					java.lang.String tmpResult861 = name;
_os.write_string( tmpResult861 );
					java.lang.String tmpResult862 = version;
_os.write_string( tmpResult862 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult863 = search_name;
_os.write_string( tmpResult863 );
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult864 = a;
_os.write_string( tmpResult864 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult865 = id;
_os.write_string( tmpResult865 );
					java.lang.String tmpResult866 = name;
_os.write_string( tmpResult866 );
					java.lang.String tmpResult867 = version;
_os.write_string( tmpResult867 );
					_os.write_boolean(is_custom);
					_os.write_boolean(is_abstract);
					org.omg.CORBA.ValueDefHelper.write(_os,base_value);
					_os.write_boolean(is_truncatable);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult868 = a;
_os.write_string( tmpResult868 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult869 = id;
_os.write_string( tmpResult869 );
					java.lang.String tmpResult870 = name;
_os.write_string( tmpResult870 );
					java.lang.String tmpResult871 = version;
_os.write_string( tmpResult871 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult872 = id;
_os.write_string( tmpResult872 );
					java.lang.String tmpResult873 = name;
_os.write_string( tmpResult873 );
					java.lang.String tmpResult874 = version;
_os.write_string( tmpResult874 );
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult875 = new_name;
_os.write_string( tmpResult875 );
					java.lang.String tmpResult876 = new_version;
_os.write_string( tmpResult876 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult877 = id;
_os.write_string( tmpResult877 );
					java.lang.String tmpResult878 = name;
_os.write_string( tmpResult878 );
					java.lang.String tmpResult879 = version;
_os.write_string( tmpResult879 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult880 = id;
_os.write_string( tmpResult880 );
					java.lang.String tmpResult881 = name;
_os.write_string( tmpResult881 );
					java.lang.String tmpResult882 = version;
_os.write_string( tmpResult882 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult883 = search_name;
_os.write_string( tmpResult883 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult884 = a;
_os.write_string( tmpResult884 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult885 = id;
_os.write_string( tmpResult885 );
					java.lang.String tmpResult886 = name;
_os.write_string( tmpResult886 );
					java.lang.String tmpResult887 = version;
_os.write_string( tmpResult887 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult888 = id;
_os.write_string( tmpResult888 );
					java.lang.String tmpResult889 = name;
_os.write_string( tmpResult889 );
					java.lang.String tmpResult890 = version;
_os.write_string( tmpResult890 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult891 = id;
_os.write_string( tmpResult891 );
					java.lang.String tmpResult892 = name;
_os.write_string( tmpResult892 );
					java.lang.String tmpResult893 = version;
_os.write_string( tmpResult893 );
					org.omg.CORBA.IDLTypeHelper.write(_os,type);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult894 = id;
_os.write_string( tmpResult894 );
					java.lang.String tmpResult895 = name;
_os.write_string( tmpResult895 );
					java.lang.String tmpResult896 = version;
_os.write_string( tmpResult896 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult897 = id;
_os.write_string( tmpResult897 );
					java.lang.String tmpResult898 = name;
_os.write_string( tmpResult898 );
					java.lang.String tmpResult899 = version;
_os.write_string( tmpResult899 );
					org.omg.CORBA.StructMemberSeqHelper.write(_os,members);
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult900 = id;
_os.write_string( tmpResult900 );
					java.lang.String tmpResult901 = name;
_os.write_string( tmpResult901 );
					java.lang.String tmpResult902 = version;
_os.write_string( tmpResult902 );
					org.omg.CORBA.InterfaceDefSeqHelper.write(_os,base_interfaces);
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult903 = id;
_os.write_string( tmpResult903 );
					java.lang.String tmpResult904 = name;
_os.write_string( tmpResult904 );
					java.lang.String tmpResult905 = version;
_os.write_string( tmpResult905 );
					_is = _invoke(_os);
