...
public class _ExtInterfaceDefStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CORBA.ExtInterfaceDef
{
	/** Serial version UID. */
	private static final long serialVersionUID = 1L;
	private String[] ids = {"IDL:omg.org/CORBA/ExtInterfaceDef:1.0","IDL:omg.org/CORBA/Container:1.0","IDL:omg.org/CORBA/InterfaceAttrExtension:1.0","IDL:omg.org/CORBA/Contained:1.0","IDL:omg.org/CORBA/IDLType:1.0","IDL:omg.org/CORBA/IRObject:1.0","IDL:omg.org/CORBA/InterfaceDef:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = org.omg.CORBA.ExtInterfaceDefOperations.class;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult498 = id;
_os.write_string( tmpResult498 );
					java.lang.String tmpResult499 = name;
_os.write_string( tmpResult499 );
					java.lang.String tmpResult500 = version;
_os.write_string( tmpResult500 );
		...
		else
		{
			...
			if( _so == null )
				continue;
			ExtInterfaceDefOperations _localServant = (ExtInterfaceDefOperations)_so.servant;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult501 = interface_id;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult502 = id;
_os.write_string( tmpResult502 );
					java.lang.String tmpResult503 = name;
_os.write_string( tmpResult503 );
					java.lang.String tmpResult504 = version;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult505 = id;
_os.write_string( tmpResult505 );
					java.lang.String tmpResult506 = name;
_os.write_string( tmpResult506 );
					java.lang.String tmpResult507 = version;
_os.write_string( tmpResult507 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult508 = id;
_os.write_string( tmpResult508 );
					java.lang.String tmpResult509 = name;
_os.write_string( tmpResult509 );
					java.lang.String tmpResult510 = version;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult511 = search_name;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult512 = a;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult513 = id;
_os.write_string( tmpResult513 );
					java.lang.String tmpResult514 = name;
_os.write_string( tmpResult514 );
					java.lang.String tmpResult515 = version;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult516 = a;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult517 = id;
_os.write_string( tmpResult517 );
					java.lang.String tmpResult518 = name;
_os.write_string( tmpResult518 );
					java.lang.String tmpResult519 = version;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult520 = id;
_os.write_string( tmpResult520 );
					java.lang.String tmpResult521 = name;
_os.write_string( tmpResult521 );
					java.lang.String tmpResult522 = version;
_os.write_string( tmpResult522 );
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult523 = new_name;
_os.write_string( tmpResult523 );
					java.lang.String tmpResult524 = new_version;
_os.write_string( tmpResult524 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult525 = id;
_os.write_string( tmpResult525 );
					java.lang.String tmpResult526 = name;
_os.write_string( tmpResult526 );
					java.lang.String tmpResult527 = version;
_os.write_string( tmpResult527 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult528 = id;
_os.write_string( tmpResult528 );
					java.lang.String tmpResult529 = name;
_os.write_string( tmpResult529 );
					java.lang.String tmpResult530 = version;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult531 = search_name;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult532 = a;
_os.write_string( tmpResult532 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult533 = id;
_os.write_string( tmpResult533 );
					java.lang.String tmpResult534 = name;
_os.write_string( tmpResult534 );
					java.lang.String tmpResult535 = version;
_os.write_string( tmpResult535 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult536 = id;
_os.write_string( tmpResult536 );
					java.lang.String tmpResult537 = name;
_os.write_string( tmpResult537 );
					java.lang.String tmpResult538 = version;
_os.write_string( tmpResult538 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult539 = id;
_os.write_string( tmpResult539 );
					java.lang.String tmpResult540 = name;
_os.write_string( tmpResult540 );
					java.lang.String tmpResult541 = version;
_os.write_string( tmpResult541 );
					org.omg.CORBA.IDLTypeHelper.write(_os,type);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult542 = id;
_os.write_string( tmpResult542 );
					java.lang.String tmpResult543 = name;
_os.write_string( tmpResult543 );
					java.lang.String tmpResult544 = version;
_os.write_string( tmpResult544 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult545 = id;
_os.write_string( tmpResult545 );
					java.lang.String tmpResult546 = name;
_os.write_string( tmpResult546 );
					java.lang.String tmpResult547 = version;
_os.write_string( tmpResult547 );
					org.omg.CORBA.StructMemberSeqHelper.write(_os,members);
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult548 = id;
_os.write_string( tmpResult548 );
					java.lang.String tmpResult549 = name;
_os.write_string( tmpResult549 );
					java.lang.String tmpResult550 = version;
_os.write_string( tmpResult550 );
					org.omg.CORBA.InterfaceDefSeqHelper.write(_os,base_interfaces);
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult551 = id;
_os.write_string( tmpResult551 );
					java.lang.String tmpResult552 = name;
_os.write_string( tmpResult552 );
					java.lang.String tmpResult553 = version;
_os.write_string( tmpResult553 );
					org.omg.CORBA.IDLTypeHelper.write(_os,type);
					org.omg.CORBA.AttributeModeHelper.write(_os,mode);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult554 = id;
_os.write_string( tmpResult554 );
					java.lang.String tmpResult555 = name;
_os.write_string( tmpResult555 );
					java.lang.String tmpResult556 = version;
_os.write_string( tmpResult556 );
					_is = _invoke(_os);
