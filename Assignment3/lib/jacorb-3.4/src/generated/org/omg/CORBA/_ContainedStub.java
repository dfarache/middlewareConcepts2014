	...
	implements org.omg.CORBA.Contained
{
	...
	public final static java.lang.Class _opsClass = org.omg.CORBA.ContainedOperations.class;
	public org.omg.CORBA.DefinitionKind def_kind()
	{
		while(true)
		{
			...
			else
			{
				...
				if( _so == null )
					continue;
				ContainedOperations _localServant = (ContainedOperations)_so.servant;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult6 = new_name;
_os.write_string( tmpResult6 );
					java.lang.String tmpResult7 = new_version;
