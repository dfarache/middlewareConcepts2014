...
public abstract class DomainManagerHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(DomainManagerHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:omg.org/CORBA/DomainManager:1.0", "DomainManager");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(org.omg.CORBA._DomainManagerStub.class));
	}
	...
	public static org.omg.CORBA.DomainManager narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj._is_a("IDL:omg.org/CORBA/DomainManager:1.0"))
		{
			org.omg.CORBA._DomainManagerStub stub;
			stub = new org.omg.CORBA._DomainManagerStub();
