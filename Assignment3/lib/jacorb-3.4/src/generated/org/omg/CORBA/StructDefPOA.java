...
public abstract class StructDefPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CORBA.StructDefOperations
{
	...
	public org.omg.CORBA.StructDef _this()
	{
		org.omg.CORBA.Object __o = _this_object() ;
		org.omg.CORBA.StructDef __r = org.omg.CORBA.StructDefHelper.narrow(__o);
		return __r;
	}
	public org.omg.CORBA.StructDef _this(org.omg.CORBA.ORB orb)
	{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult243 = absolute_name();
_out.write_string( tmpResult243 );
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult244 = name();
_out.write_string( tmpResult244 );
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult245 = version();
_out.write_string( tmpResult245 );
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult246 = id();
