...
public class ExtValueDefPOATie
	extends ExtValueDefPOA
{
	private ExtValueDefOperations _delegate;

	private POA _poa;
	public ExtValueDefPOATie(ExtValueDefOperations delegate)
	{
		_delegate = delegate;
	}
	public ExtValueDefPOATie(ExtValueDefOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public ExtValueDefOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(ExtValueDefOperations delegate)
	{
		_delegate = delegate;
	}
	...
	{
		return _delegate.describe_ext_value();
	}
...
_delegate.move(new_container,new_name,new_version);
	...
	{
		return _delegate.ext_initializers();
	}
