...
public class _ValueBoxDefStub
	...
	implements org.omg.CORBA.ValueBoxDef
{
	/** Serial version UID. */
	private static final long serialVersionUID = 1L;
	private String[] ids = {"IDL:omg.org/CORBA/ValueBoxDef:1.0","IDL:omg.org/CORBA/Contained:1.0","IDL:omg.org/CORBA/IDLType:1.0","IDL:omg.org/CORBA/TypedefDef:1.0","IDL:omg.org/CORBA/IRObject:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = org.omg.CORBA.ValueBoxDefOperations.class;
	public org.omg.CORBA.DefinitionKind def_kind()
	{
		while(true)
		{
			...
			else
			{
				...
				if( _so == null )
					continue;
				ValueBoxDefOperations _localServant = (ValueBoxDefOperations)_so.servant;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult718 = a;
	...
	public org.omg.CORBA.IDLType original_type_def()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request("_get_original_type_def",true);
					_is = _invoke(_os);
			...
			{
				org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "_get_original_type_def", _opsClass);
				if( _so == null )
					continue;
				ValueBoxDefOperations _localServant = (ValueBoxDefOperations)_so.servant;
				...
				try
				{
					_result = _localServant.original_type_def();
					if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
						((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
						return _result;
				}
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult719 = a;
_os.write_string( tmpResult719 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
	...
	public void original_type_def(org.omg.CORBA.IDLType a)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request("_set_original_type_def",true);
			...
			{
				org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "_set_original_type_def", _opsClass);
				if( _so == null )
					continue;
				ValueBoxDefOperations _localServant = (ValueBoxDefOperations)_so.servant;
				try
				{
					_localServant.original_type_def(a);
					if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
						((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
					return;
				}
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult720 = new_name;
_os.write_string( tmpResult720 );
					java.lang.String tmpResult721 = new_version;
_os.write_string( tmpResult721 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult722 = a;
_os.write_string( tmpResult722 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
