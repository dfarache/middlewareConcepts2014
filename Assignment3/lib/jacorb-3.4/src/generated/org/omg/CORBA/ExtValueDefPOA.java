...
public abstract class ExtValueDefPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CORBA.ExtValueDefOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "is_a", Integer.valueOf(3));
		...
		m_opsHash.put ( "describe_ext_value", Integer.valueOf(21));
		m_opsHash.put ( "_get_containing_repository", Integer.valueOf(22));
		m_opsHash.put ( "create_module", Integer.valueOf(23));
		m_opsHash.put ( "move", Integer.valueOf(24));
		m_opsHash.put ( "create_abstract_interface", Integer.valueOf(25));
		m_opsHash.put ( "_set_base_value", Integer.valueOf(26));
		m_opsHash.put ( "_get_version", Integer.valueOf(27));
		m_opsHash.put ( "_set_supported_interfaces", Integer.valueOf(28));
		m_opsHash.put ( "create_value_member", Integer.valueOf(29));
		m_opsHash.put ( "_get_ext_initializers", Integer.valueOf(30));
		m_opsHash.put ( "create_constant", Integer.valueOf(31));
		m_opsHash.put ( "destroy", Integer.valueOf(32));
		m_opsHash.put ( "lookup_name", Integer.valueOf(33));
		m_opsHash.put ( "_get_type", Integer.valueOf(34));
		m_opsHash.put ( "contents", Integer.valueOf(35));
		m_opsHash.put ( "_set_id", Integer.valueOf(36));
		m_opsHash.put ( "create_local_interface", Integer.valueOf(37));
		m_opsHash.put ( "_get_def_kind", Integer.valueOf(38));
		m_opsHash.put ( "_get_abstract_base_values", Integer.valueOf(39));
		m_opsHash.put ( "create_value_box", Integer.valueOf(40));
		m_opsHash.put ( "_set_is_custom", Integer.valueOf(41));
		m_opsHash.put ( "_set_initializers", Integer.valueOf(42));
		m_opsHash.put ( "_get_is_truncatable", Integer.valueOf(43));
		m_opsHash.put ( "create_union", Integer.valueOf(44));
		m_opsHash.put ( "create_attribute", Integer.valueOf(45));
		m_opsHash.put ( "create_exception", Integer.valueOf(46));
		m_opsHash.put ( "_get_name", Integer.valueOf(47));
		m_opsHash.put ( "_get_supported_interfaces", Integer.valueOf(48));
		m_opsHash.put ( "_set_ext_initializers", Integer.valueOf(49));
		m_opsHash.put ( "describe_value", Integer.valueOf(50));
		m_opsHash.put ( "create_interface", Integer.valueOf(51));
		m_opsHash.put ( "create_ext_attribute", Integer.valueOf(52));
		m_opsHash.put ( "_set_is_abstract", Integer.valueOf(53));
		m_opsHash.put ( "create_native", Integer.valueOf(54));
	}
	...
	public org.omg.CORBA.ExtValueDef _this()
	{
		org.omg.CORBA.Object __o = _this_object() ;
		org.omg.CORBA.ExtValueDef __r = org.omg.CORBA.ExtValueDefHelper.narrow(__o);
		return __r;
	}
	public org.omg.CORBA.ExtValueDef _this(org.omg.CORBA.ORB orb)
	{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult709 = id();
_out.write_string( tmpResult709 );
				break;
			}
			case 3: // is_a
			{
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult710 = absolute_name();
_out.write_string( tmpResult710 );
				break;
			}
			...
			case 21: // describe_ext_value
			{
				_out = handler.createReply();
				org.omg.CORBA.ExtValueDefPackage.ExtFullValueDescriptionHelper.write(_out,describe_ext_value());
				break;
			}
			case 22: // _get_containing_repository
			{
			_out = handler.createReply();
			org.omg.CORBA.RepositoryHelper.write(_out,containing_repository());
				break;
			}
			case 23: // create_module
			{
				java.lang.String _arg0=_input.read_string();
				java.lang.String _arg1=_input.read_string();
				java.lang.String _arg2=_input.read_string();
			...
			case 25: // create_abstract_interface
			{
				java.lang.String _arg0=_input.read_string();
				java.lang.String _arg1=_input.read_string();
				java.lang.String _arg2=_input.read_string();
			...
			case 26: // _set_base_value
			{
			_out = handler.createReply();
			base_value(org.omg.CORBA.ValueDefHelper.read(_input));
				break;
			}
			case 27: // _get_version
			{
			_out = handler.createReply();
			java.lang.String tmpResult711 = version();
_out.write_string( tmpResult711 );
				break;
			}
			case 28: // _set_supported_interfaces
			{
			_out = handler.createReply();
			supported_interfaces(org.omg.CORBA.InterfaceDefSeqHelper.read(_input));
				break;
			}
			case 29: // create_value_member
			{
				java.lang.String _arg0=_input.read_string();
				java.lang.String _arg1=_input.read_string();
				java.lang.String _arg2=_input.read_string();
			...
			case 30: // _get_ext_initializers
			{
			_out = handler.createReply();
			org.omg.CORBA.ExtInitializerSeqHelper.write(_out,ext_initializers());
				break;
			}
			case 31: // create_constant
			{
				java.lang.String _arg0=_input.read_string();
				java.lang.String _arg1=_input.read_string();
				java.lang.String _arg2=_input.read_string();
			...
			case 37: // create_local_interface
			{
				java.lang.String _arg0=_input.read_string();
				java.lang.String _arg1=_input.read_string();
				java.lang.String _arg2=_input.read_string();
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult712 = name();
_out.write_string( tmpResult712 );
				break;
			}
			case 48: // _get_supported_interfaces
			{
			_out = handler.createReply();
			org.omg.CORBA.InterfaceDefSeqHelper.write(_out,supported_interfaces());
				break;
			}
			case 49: // _set_ext_initializers
			{
			_out = handler.createReply();
			ext_initializers(org.omg.CORBA.ExtInitializerSeqHelper.read(_input));
				break;
			}
			case 50: // describe_value
			{
				_out = handler.createReply();
				org.omg.CORBA.ValueDefPackage.FullValueDescriptionHelper.write(_out,describe_value());
				break;
			}
			case 51: // create_interface
			{
				java.lang.String _arg0=_input.read_string();
				java.lang.String _arg1=_input.read_string();
				java.lang.String _arg2=_input.read_string();
			...
			case 53: // _set_is_abstract
			{
			_out = handler.createReply();
			is_abstract(_input.read_boolean());
				break;
			}
			case 54: // create_native
			{
				java.lang.String _arg0=_input.read_string();
				java.lang.String _arg1=_input.read_string();
				java.lang.String _arg2=_input.read_string();
