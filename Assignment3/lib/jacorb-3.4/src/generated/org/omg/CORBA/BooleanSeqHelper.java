...
public abstract class BooleanSeqHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(BooleanSeqHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.CORBA.BooleanSeqHelper.id(), "BooleanSeq",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.from_int(8))));
				}
			}
		}
		return _type;
	...
	public static boolean[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new boolean[_l_result29];
		_in.read_boolean_array(_result,0,_l_result29);
		return _result;
	}
