...
public class _ValueDefStub
	...
	implements org.omg.CORBA.ValueDef
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CORBA.ValueDefOperations.class;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult574 = id;
_os.write_string( tmpResult574 );
					java.lang.String tmpResult575 = name;
_os.write_string( tmpResult575 );
					java.lang.String tmpResult576 = version;
_os.write_string( tmpResult576 );
		...
		else
		{
			...
			if( _so == null )
				continue;
			ValueDefOperations _localServant = (ValueDefOperations)_so.servant;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult577 = id;
_os.write_string( tmpResult577 );
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult578 = id;
_os.write_string( tmpResult578 );
					java.lang.String tmpResult579 = name;
_os.write_string( tmpResult579 );
					java.lang.String tmpResult580 = version;
_os.write_string( tmpResult580 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult581 = id;
_os.write_string( tmpResult581 );
					java.lang.String tmpResult582 = name;
_os.write_string( tmpResult582 );
					java.lang.String tmpResult583 = version;
_os.write_string( tmpResult583 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult584 = id;
_os.write_string( tmpResult584 );
					java.lang.String tmpResult585 = name;
_os.write_string( tmpResult585 );
					java.lang.String tmpResult586 = version;
_os.write_string( tmpResult586 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult587 = search_name;
_os.write_string( tmpResult587 );
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult588 = a;
_os.write_string( tmpResult588 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult589 = id;
_os.write_string( tmpResult589 );
					java.lang.String tmpResult590 = name;
_os.write_string( tmpResult590 );
					java.lang.String tmpResult591 = version;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult592 = a;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult593 = id;
_os.write_string( tmpResult593 );
					java.lang.String tmpResult594 = name;
_os.write_string( tmpResult594 );
					java.lang.String tmpResult595 = version;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult596 = id;
_os.write_string( tmpResult596 );
					java.lang.String tmpResult597 = name;
_os.write_string( tmpResult597 );
					java.lang.String tmpResult598 = version;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult599 = new_name;
_os.write_string( tmpResult599 );
					java.lang.String tmpResult600 = new_version;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult601 = id;
_os.write_string( tmpResult601 );
					java.lang.String tmpResult602 = name;
_os.write_string( tmpResult602 );
					java.lang.String tmpResult603 = version;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult604 = id;
_os.write_string( tmpResult604 );
					java.lang.String tmpResult605 = name;
_os.write_string( tmpResult605 );
					java.lang.String tmpResult606 = version;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult607 = id;
_os.write_string( tmpResult607 );
					java.lang.String tmpResult608 = name;
_os.write_string( tmpResult608 );
					java.lang.String tmpResult609 = version;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult610 = search_name;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult611 = a;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult612 = id;
_os.write_string( tmpResult612 );
					java.lang.String tmpResult613 = name;
_os.write_string( tmpResult613 );
					java.lang.String tmpResult614 = version;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult615 = id;
_os.write_string( tmpResult615 );
					java.lang.String tmpResult616 = name;
_os.write_string( tmpResult616 );
					java.lang.String tmpResult617 = version;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult618 = id;
_os.write_string( tmpResult618 );
					java.lang.String tmpResult619 = name;
_os.write_string( tmpResult619 );
					java.lang.String tmpResult620 = version;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult621 = id;
_os.write_string( tmpResult621 );
					java.lang.String tmpResult622 = name;
_os.write_string( tmpResult622 );
					java.lang.String tmpResult623 = version;
_os.write_string( tmpResult623 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult624 = id;
_os.write_string( tmpResult624 );
					java.lang.String tmpResult625 = name;
_os.write_string( tmpResult625 );
					java.lang.String tmpResult626 = version;
_os.write_string( tmpResult626 );
					org.omg.CORBA.StructMemberSeqHelper.write(_os,members);
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult627 = id;
_os.write_string( tmpResult627 );
					java.lang.String tmpResult628 = name;
_os.write_string( tmpResult628 );
					java.lang.String tmpResult629 = version;
_os.write_string( tmpResult629 );
					org.omg.CORBA.InterfaceDefSeqHelper.write(_os,base_interfaces);
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult630 = id;
_os.write_string( tmpResult630 );
					java.lang.String tmpResult631 = name;
_os.write_string( tmpResult631 );
					java.lang.String tmpResult632 = version;
_os.write_string( tmpResult632 );
					_is = _invoke(_os);
