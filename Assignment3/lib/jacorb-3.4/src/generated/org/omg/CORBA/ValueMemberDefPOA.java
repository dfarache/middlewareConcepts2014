...
public abstract class ValueMemberDefPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CORBA.ValueMemberDefOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult570 = absolute_name();
_out.write_string( tmpResult570 );
				break;
			}
			case 5: // _get_name
			{
			_out = handler.createReply();
			java.lang.String tmpResult571 = name();
_out.write_string( tmpResult571 );
				break;
			}
			case 6: // _get_type
			{
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult572 = version();
_out.write_string( tmpResult572 );
				break;
			}
			case 11: // _get_access
			{
			_out = handler.createReply();
			_out.write_short(access());
				break;
			}
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult573 = id();
_out.write_string( tmpResult573 );
				break;
			}
			case 15: // move
			{
