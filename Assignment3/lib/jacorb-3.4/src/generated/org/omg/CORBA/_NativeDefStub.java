...
public class _NativeDefStub
	...
	implements org.omg.CORBA.NativeDef
{
	/** Serial version UID. */
	private static final long serialVersionUID = 1L;
	private String[] ids = {"IDL:omg.org/CORBA/NativeDef:1.0","IDL:omg.org/CORBA/Contained:1.0","IDL:omg.org/CORBA/IDLType:1.0","IDL:omg.org/CORBA/TypedefDef:1.0","IDL:omg.org/CORBA/IRObject:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = org.omg.CORBA.NativeDefOperations.class;
	public org.omg.CORBA.DefinitionKind def_kind()
	{
		while(true)
		{
			...
			else
			{
				...
				if( _so == null )
					continue;
				NativeDefOperations _localServant = (NativeDefOperations)_so.servant;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult318 = a;
_os.write_string( tmpResult318 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult319 = a;
_os.write_string( tmpResult319 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult320 = new_name;
_os.write_string( tmpResult320 );
					java.lang.String tmpResult321 = new_version;
_os.write_string( tmpResult321 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult322 = a;
_os.write_string( tmpResult322 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
