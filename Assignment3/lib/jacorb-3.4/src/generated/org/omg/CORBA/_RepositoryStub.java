...
public class _RepositoryStub
	...
	implements org.omg.CORBA.Repository
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CORBA.RepositoryOperations.class;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult66 = id;
_os.write_string( tmpResult66 );
					java.lang.String tmpResult67 = name;
_os.write_string( tmpResult67 );
					java.lang.String tmpResult68 = version;
_os.write_string( tmpResult68 );
		...
		else
		{
			...
			if( _so == null )
				continue;
			RepositoryOperations _localServant = (RepositoryOperations)_so.servant;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult69 = id;
_os.write_string( tmpResult69 );
					java.lang.String tmpResult70 = name;
_os.write_string( tmpResult70 );
					java.lang.String tmpResult71 = version;
_os.write_string( tmpResult71 );
	...
	public org.omg.CORBA.FixedDef create_fixed(short digits, short scale)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "create_fixed", true);
					_os.write_ushort(digits);
					_os.write_short(scale);
					_is = _invoke(_os);
					org.omg.CORBA.FixedDef _result = org.omg.CORBA.FixedDefHelper.read(_is);
					return _result;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "create_fixed", _opsClass );
			if( _so == null )
				continue;
			RepositoryOperations _localServant = (RepositoryOperations)_so.servant;
			...
			try
			{
				_result = _localServant.create_fixed(digits,scale);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
	...
	public org.omg.CORBA.Contained lookup_id(java.lang.String search_id)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "lookup_id", true);
					java.lang.String tmpResult72 = search_id;
_os.write_string( tmpResult72 );
					_is = _invoke(_os);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "lookup_id", _opsClass );
			if( _so == null )
				continue;
			RepositoryOperations _localServant = (RepositoryOperations)_so.servant;
			...
			try
			{
				_result = _localServant.lookup_id(search_id);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult73 = id;
_os.write_string( tmpResult73 );
					java.lang.String tmpResult74 = name;
_os.write_string( tmpResult74 );
					java.lang.String tmpResult75 = version;
	...
	public org.omg.CORBA.WstringDef create_wstring(int bound)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "create_wstring", true);
					_os.write_ulong(bound);
					_is = _invoke(_os);
					org.omg.CORBA.WstringDef _result = org.omg.CORBA.WstringDefHelper.read(_is);
					return _result;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "create_wstring", _opsClass );
			if( _so == null )
				continue;
			RepositoryOperations _localServant = (RepositoryOperations)_so.servant;
			...
			try
			{
				_result = _localServant.create_wstring(bound);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult76 = id;
_os.write_string( tmpResult76 );
					java.lang.String tmpResult77 = name;
_os.write_string( tmpResult77 );
					java.lang.String tmpResult78 = version;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult79 = search_name;
_os.write_string( tmpResult79 );
					_is = _invoke(_os);
					org.omg.CORBA.Contained _result = org.omg.CORBA.ContainedHelper.read(_is);
					return _result;
				}
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult80 = id;
_os.write_string( tmpResult80 );
					java.lang.String tmpResult81 = name;
_os.write_string( tmpResult81 );
					java.lang.String tmpResult82 = version;
_os.write_string( tmpResult82 );
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult83 = id;
_os.write_string( tmpResult83 );
					java.lang.String tmpResult84 = name;
_os.write_string( tmpResult84 );
					java.lang.String tmpResult85 = version;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult86 = id;
_os.write_string( tmpResult86 );
					java.lang.String tmpResult87 = name;
_os.write_string( tmpResult87 );
					java.lang.String tmpResult88 = version;
	...
	public org.omg.CORBA.StringDef create_string(int bound)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "create_string", true);
					_os.write_ulong(bound);
					_is = _invoke(_os);
					org.omg.CORBA.StringDef _result = org.omg.CORBA.StringDefHelper.read(_is);
					return _result;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "create_string", _opsClass );
			if( _so == null )
				continue;
			RepositoryOperations _localServant = (RepositoryOperations)_so.servant;
			...
			try
			{
				_result = _localServant.create_string(bound);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult89 = id;
_os.write_string( tmpResult89 );
					java.lang.String tmpResult90 = name;
_os.write_string( tmpResult90 );
					java.lang.String tmpResult91 = version;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult92 = search_name;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult93 = id;
_os.write_string( tmpResult93 );
					java.lang.String tmpResult94 = name;
_os.write_string( tmpResult94 );
					java.lang.String tmpResult95 = version;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult99 = id;
_os.write_string( tmpResult99 );
					java.lang.String tmpResult100 = name;
_os.write_string( tmpResult100 );
					java.lang.String tmpResult101 = version;
	...
	public org.omg.CORBA.SequenceDef create_sequence(int bound, org.omg.CORBA.IDLType element_type)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "create_sequence", true);
					_os.write_ulong(bound);
					org.omg.CORBA.IDLTypeHelper.write(_os,element_type);
					_is = _invoke(_os);
					org.omg.CORBA.SequenceDef _result = org.omg.CORBA.SequenceDefHelper.read(_is);
					return _result;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "create_sequence", _opsClass );
			if( _so == null )
				continue;
			RepositoryOperations _localServant = (RepositoryOperations)_so.servant;
			...
			try
			{
				_result = _localServant.create_sequence(bound,element_type);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
	...
	public org.omg.CORBA.PrimitiveDef get_primitive(org.omg.CORBA.PrimitiveKind kind)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "get_primitive", true);
					org.omg.CORBA.PrimitiveKindHelper.write(_os,kind);
					_is = _invoke(_os);
					org.omg.CORBA.PrimitiveDef _result = org.omg.CORBA.PrimitiveDefHelper.read(_is);
					return _result;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "get_primitive", _opsClass );
			if( _so == null )
				continue;
			RepositoryOperations _localServant = (RepositoryOperations)_so.servant;
			...
			try
			{
				_result = _localServant.get_primitive(kind);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
	...
	public org.omg.CORBA.ArrayDef create_array(int length, org.omg.CORBA.IDLType element_type)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "create_array", true);
					_os.write_ulong(length);
					org.omg.CORBA.IDLTypeHelper.write(_os,element_type);
					_is = _invoke(_os);
					org.omg.CORBA.ArrayDef _result = org.omg.CORBA.ArrayDefHelper.read(_is);
					return _result;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "create_array", _opsClass );
			if( _so == null )
				continue;
			RepositoryOperations _localServant = (RepositoryOperations)_so.servant;
			...
			try
			{
				_result = _localServant.create_array(length,element_type);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
	...
	public org.omg.CORBA.TypeCode get_canonical_typecode(org.omg.CORBA.TypeCode tc)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "get_canonical_typecode", true);
					_os.write_TypeCode(tc);
					_is = _invoke(_os);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "get_canonical_typecode", _opsClass );
			if( _so == null )
				continue;
			RepositoryOperations _localServant = (RepositoryOperations)_so.servant;
			...
			try
			{
				_result = _localServant.get_canonical_typecode(tc);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
