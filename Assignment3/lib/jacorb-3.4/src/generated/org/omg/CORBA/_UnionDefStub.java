...
public class _UnionDefStub
	...
	implements org.omg.CORBA.UnionDef
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CORBA.UnionDefOperations.class;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult247 = id;
_os.write_string( tmpResult247 );
					java.lang.String tmpResult248 = name;
_os.write_string( tmpResult248 );
					java.lang.String tmpResult249 = version;
_os.write_string( tmpResult249 );
		...
		else
		{
			...
			if( _so == null )
				continue;
			UnionDefOperations _localServant = (UnionDefOperations)_so.servant;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult250 = id;
_os.write_string( tmpResult250 );
					java.lang.String tmpResult251 = name;
_os.write_string( tmpResult251 );
					java.lang.String tmpResult252 = version;
_os.write_string( tmpResult252 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult253 = id;
_os.write_string( tmpResult253 );
					java.lang.String tmpResult254 = name;
_os.write_string( tmpResult254 );
					java.lang.String tmpResult255 = version;
_os.write_string( tmpResult255 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult256 = id;
_os.write_string( tmpResult256 );
					java.lang.String tmpResult257 = name;
_os.write_string( tmpResult257 );
					java.lang.String tmpResult258 = version;
_os.write_string( tmpResult258 );
	...
	public org.omg.CORBA.IDLType discriminator_type_def()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request("_get_discriminator_type_def",true);
					_is = _invoke(_os);
			...
			{
				org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "_get_discriminator_type_def", _opsClass);
				if( _so == null )
					continue;
				UnionDefOperations _localServant = (UnionDefOperations)_so.servant;
				...
				try
				{
					_result = _localServant.discriminator_type_def();
					if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
						((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
						return _result;
				}
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult259 = search_name;
_os.write_string( tmpResult259 );
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult260 = a;
_os.write_string( tmpResult260 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult261 = id;
_os.write_string( tmpResult261 );
					java.lang.String tmpResult262 = name;
_os.write_string( tmpResult262 );
					java.lang.String tmpResult263 = version;
_os.write_string( tmpResult263 );
					_os.write_boolean(is_custom);
					_os.write_boolean(is_abstract);
					org.omg.CORBA.ValueDefHelper.write(_os,base_value);
					_os.write_boolean(is_truncatable);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult264 = a;
_os.write_string( tmpResult264 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult265 = id;
_os.write_string( tmpResult265 );
					java.lang.String tmpResult266 = name;
_os.write_string( tmpResult266 );
					java.lang.String tmpResult267 = version;
_os.write_string( tmpResult267 );
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult268 = new_name;
_os.write_string( tmpResult268 );
					java.lang.String tmpResult269 = new_version;
_os.write_string( tmpResult269 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult270 = id;
_os.write_string( tmpResult270 );
					java.lang.String tmpResult271 = name;
_os.write_string( tmpResult271 );
					java.lang.String tmpResult272 = version;
_os.write_string( tmpResult272 );
	...
	public org.omg.CORBA.TypeCode discriminator_type()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request("_get_discriminator_type",true);
					_is = _invoke(_os);
			...
			{
				org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "_get_discriminator_type", _opsClass);
				if( _so == null )
					continue;
				UnionDefOperations _localServant = (UnionDefOperations)_so.servant;
				...
				try
				{
					_result = _localServant.discriminator_type();
					if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
						((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
						return _result;
				}
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult273 = id;
_os.write_string( tmpResult273 );
					java.lang.String tmpResult274 = name;
_os.write_string( tmpResult274 );
					java.lang.String tmpResult275 = version;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult276 = search_name;
	...
	public org.omg.CORBA.UnionMember[] members()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request("_get_members",true);
					_is = _invoke(_os);
					return org.omg.CORBA.UnionMemberSeqHelper.read(_is);
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
						continue;
			...
			{
				org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "_get_members", _opsClass);
				if( _so == null )
					continue;
				UnionDefOperations _localServant = (UnionDefOperations)_so.servant;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult277 = a;
_os.write_string( tmpResult277 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult278 = id;
_os.write_string( tmpResult278 );
					java.lang.String tmpResult279 = name;
_os.write_string( tmpResult279 );
					java.lang.String tmpResult280 = version;
_os.write_string( tmpResult280 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult281 = id;
_os.write_string( tmpResult281 );
					java.lang.String tmpResult282 = name;
_os.write_string( tmpResult282 );
					java.lang.String tmpResult283 = version;
_os.write_string( tmpResult283 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult284 = id;
_os.write_string( tmpResult284 );
					java.lang.String tmpResult285 = name;
_os.write_string( tmpResult285 );
					java.lang.String tmpResult286 = version;
_os.write_string( tmpResult286 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult287 = id;
_os.write_string( tmpResult287 );
					java.lang.String tmpResult288 = name;
_os.write_string( tmpResult288 );
					java.lang.String tmpResult289 = version;
_os.write_string( tmpResult289 );
					org.omg.CORBA.StructMemberSeqHelper.write(_os,members);
					_is = _invoke(_os);
	...
	public void members(org.omg.CORBA.UnionMember[] a)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request("_set_members",true);
					org.omg.CORBA.UnionMemberSeqHelper.write(_os,a);
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
			...
			{
				org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "_set_members", _opsClass);
				if( _so == null )
					continue;
				UnionDefOperations _localServant = (UnionDefOperations)_so.servant;
				try
				{
					_localServant.members(a);
					if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
						((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
					return;
				}
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult290 = id;
_os.write_string( tmpResult290 );
					java.lang.String tmpResult291 = name;
_os.write_string( tmpResult291 );
					java.lang.String tmpResult292 = version;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult293 = id;
_os.write_string( tmpResult293 );
					java.lang.String tmpResult294 = name;
_os.write_string( tmpResult294 );
					java.lang.String tmpResult295 = version;
	...
	public void discriminator_type_def(org.omg.CORBA.IDLType a)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request("_set_discriminator_type_def",true);
			...
			{
				org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "_set_discriminator_type_def", _opsClass);
				if( _so == null )
					continue;
				UnionDefOperations _localServant = (UnionDefOperations)_so.servant;
				try
				{
					_localServant.discriminator_type_def(a);
					if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
						((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
					return;
				}
