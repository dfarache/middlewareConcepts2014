...
public abstract class NO_MEMORYHelper
{
	...
	public static void insert (final org.omg.CORBA.Any any, final org.omg.CORBA.NO_MEMORY s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.omg.CORBA.NO_MEMORY extract (final org.omg.CORBA.Any any)
	{
	...
	public static org.omg.CORBA.NO_MEMORY read (final org.omg.CORBA.portable.InputStream in)
	{
		...
		final org.omg.CORBA.NO_MEMORY result = new org.omg.CORBA.NO_MEMORY(id, x0, x1);
		return result;
	}
	public static void write (final org.omg.CORBA.portable.OutputStream out, final org.omg.CORBA.NO_MEMORY s)
	{
		out.write_string(id());
