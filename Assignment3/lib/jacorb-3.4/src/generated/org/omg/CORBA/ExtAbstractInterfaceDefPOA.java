...
public abstract class ExtAbstractInterfaceDefPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CORBA.ExtAbstractInterfaceDefOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "describe_ext_interface", Integer.valueOf(13));
		m_opsHash.put ( "_get_defined_in", Integer.valueOf(14));
		m_opsHash.put ( "create_operation", Integer.valueOf(15));
		m_opsHash.put ( "_get_containing_repository", Integer.valueOf(16));
		m_opsHash.put ( "create_module", Integer.valueOf(17));
		m_opsHash.put ( "move", Integer.valueOf(18));
		m_opsHash.put ( "create_abstract_interface", Integer.valueOf(19));
		m_opsHash.put ( "_get_version", Integer.valueOf(20));
		m_opsHash.put ( "create_constant", Integer.valueOf(21));
		m_opsHash.put ( "destroy", Integer.valueOf(22));
		m_opsHash.put ( "lookup_name", Integer.valueOf(23));
		...
		m_opsHash.put ( "_get_base_interfaces", Integer.valueOf(29));
		m_opsHash.put ( "_set_base_interfaces", Integer.valueOf(30));
		m_opsHash.put ( "create_value_box", Integer.valueOf(31));
		m_opsHash.put ( "describe_interface", Integer.valueOf(32));
		m_opsHash.put ( "create_attribute", Integer.valueOf(33));
		m_opsHash.put ( "create_union", Integer.valueOf(34));
		m_opsHash.put ( "create_exception", Integer.valueOf(35));
		m_opsHash.put ( "_get_name", Integer.valueOf(36));
		m_opsHash.put ( "create_interface", Integer.valueOf(37));
		m_opsHash.put ( "create_ext_attribute", Integer.valueOf(38));
		m_opsHash.put ( "create_native", Integer.valueOf(39));
	}
	...
	public org.omg.CORBA.ExtAbstractInterfaceDef _this()
	{
		org.omg.CORBA.Object __o = _this_object() ;
		org.omg.CORBA.ExtAbstractInterfaceDef __r = org.omg.CORBA.ExtAbstractInterfaceDefHelper.narrow(__o);
		return __r;
	}
	public org.omg.CORBA.ExtAbstractInterfaceDef _this(org.omg.CORBA.ORB orb)
	{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult846 = id();
_out.write_string( tmpResult846 );
				break;
			}
			case 2: // is_a
			{
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult847 = absolute_name();
_out.write_string( tmpResult847 );
				break;
			}
			...
			case 13: // describe_ext_interface
			{
				_out = handler.createReply();
			...
			case 19: // create_abstract_interface
			{
				java.lang.String _arg0=_input.read_string();
				java.lang.String _arg1=_input.read_string();
				java.lang.String _arg2=_input.read_string();
			...
			case 20: // _get_version
			{
			_out = handler.createReply();
			java.lang.String tmpResult848 = version();
_out.write_string( tmpResult848 );
				break;
			}
			case 21: // create_constant
			{
				java.lang.String _arg0=_input.read_string();
				java.lang.String _arg1=_input.read_string();
				java.lang.String _arg2=_input.read_string();
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult849 = name();
_out.write_string( tmpResult849 );
				break;
			}
			case 37: // create_interface
			{
				java.lang.String _arg0=_input.read_string();
				java.lang.String _arg1=_input.read_string();
				java.lang.String _arg2=_input.read_string();
