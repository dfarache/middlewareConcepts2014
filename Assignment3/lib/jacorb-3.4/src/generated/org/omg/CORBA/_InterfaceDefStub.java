		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult423 = id;
_os.write_string( tmpResult423 );
					java.lang.String tmpResult424 = name;
_os.write_string( tmpResult424 );
					java.lang.String tmpResult425 = version;
_os.write_string( tmpResult425 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult426 = interface_id;
_os.write_string( tmpResult426 );
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult427 = id;
_os.write_string( tmpResult427 );
					java.lang.String tmpResult428 = name;
_os.write_string( tmpResult428 );
					java.lang.String tmpResult429 = version;
_os.write_string( tmpResult429 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult430 = id;
_os.write_string( tmpResult430 );
					java.lang.String tmpResult431 = name;
_os.write_string( tmpResult431 );
					java.lang.String tmpResult432 = version;
_os.write_string( tmpResult432 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult433 = id;
_os.write_string( tmpResult433 );
					java.lang.String tmpResult434 = name;
_os.write_string( tmpResult434 );
					java.lang.String tmpResult435 = version;
_os.write_string( tmpResult435 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult436 = search_name;
_os.write_string( tmpResult436 );
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult437 = a;
_os.write_string( tmpResult437 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult438 = id;
_os.write_string( tmpResult438 );
					java.lang.String tmpResult439 = name;
_os.write_string( tmpResult439 );
					java.lang.String tmpResult440 = version;
_os.write_string( tmpResult440 );
					_os.write_boolean(is_custom);
					_os.write_boolean(is_abstract);
					org.omg.CORBA.ValueDefHelper.write(_os,base_value);
					_os.write_boolean(is_truncatable);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult441 = a;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult442 = id;
_os.write_string( tmpResult442 );
					java.lang.String tmpResult443 = name;
_os.write_string( tmpResult443 );
					java.lang.String tmpResult444 = version;
_os.write_string( tmpResult444 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult445 = id;
_os.write_string( tmpResult445 );
					java.lang.String tmpResult446 = name;
_os.write_string( tmpResult446 );
					java.lang.String tmpResult447 = version;
_os.write_string( tmpResult447 );
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult448 = new_name;
_os.write_string( tmpResult448 );
					java.lang.String tmpResult449 = new_version;
_os.write_string( tmpResult449 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult450 = id;
_os.write_string( tmpResult450 );
					java.lang.String tmpResult451 = name;
_os.write_string( tmpResult451 );
					java.lang.String tmpResult452 = version;
_os.write_string( tmpResult452 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult453 = id;
_os.write_string( tmpResult453 );
					java.lang.String tmpResult454 = name;
_os.write_string( tmpResult454 );
					java.lang.String tmpResult455 = version;
_os.write_string( tmpResult455 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult456 = search_name;
_os.write_string( tmpResult456 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult457 = a;
_os.write_string( tmpResult457 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult458 = id;
_os.write_string( tmpResult458 );
					java.lang.String tmpResult459 = name;
_os.write_string( tmpResult459 );
					java.lang.String tmpResult460 = version;
_os.write_string( tmpResult460 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult461 = id;
_os.write_string( tmpResult461 );
					java.lang.String tmpResult462 = name;
_os.write_string( tmpResult462 );
					java.lang.String tmpResult463 = version;
_os.write_string( tmpResult463 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult464 = id;
_os.write_string( tmpResult464 );
					java.lang.String tmpResult465 = name;
_os.write_string( tmpResult465 );
					java.lang.String tmpResult466 = version;
_os.write_string( tmpResult466 );
					org.omg.CORBA.IDLTypeHelper.write(_os,type);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult467 = id;
_os.write_string( tmpResult467 );
					java.lang.String tmpResult468 = name;
_os.write_string( tmpResult468 );
					java.lang.String tmpResult469 = version;
_os.write_string( tmpResult469 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult470 = id;
_os.write_string( tmpResult470 );
					java.lang.String tmpResult471 = name;
_os.write_string( tmpResult471 );
					java.lang.String tmpResult472 = version;
_os.write_string( tmpResult472 );
					org.omg.CORBA.StructMemberSeqHelper.write(_os,members);
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult473 = id;
_os.write_string( tmpResult473 );
					java.lang.String tmpResult474 = name;
_os.write_string( tmpResult474 );
					java.lang.String tmpResult475 = version;
_os.write_string( tmpResult475 );
					org.omg.CORBA.InterfaceDefSeqHelper.write(_os,base_interfaces);
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult476 = id;
_os.write_string( tmpResult476 );
					java.lang.String tmpResult477 = name;
_os.write_string( tmpResult477 );
					java.lang.String tmpResult478 = version;
