...
public abstract class ULongLongSeqHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(ULongLongSeqHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.CORBA.ULongLongSeqHelper.id(), "ULongLongSeq",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.from_int(24))));
				}
			}
		}
		return _type;
	...
	public static long[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new long[_l_result38];
		_in.read_ulonglong_array(_result,0,_l_result38);
		return _result;
	}
