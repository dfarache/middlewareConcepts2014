...
public abstract class TIMEOUTHelper
{
	...
	public static void insert (final org.omg.CORBA.Any any, final org.omg.CORBA.TIMEOUT s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.omg.CORBA.TIMEOUT extract (final org.omg.CORBA.Any any)
	{
	...
	public static org.omg.CORBA.TIMEOUT read (final org.omg.CORBA.portable.InputStream in)
	{
		...
		final org.omg.CORBA.TIMEOUT result = new org.omg.CORBA.TIMEOUT(id, x0, x1);
		return result;
	}
	public static void write (final org.omg.CORBA.portable.OutputStream out, final org.omg.CORBA.TIMEOUT s)
	{
		out.write_string(id());
