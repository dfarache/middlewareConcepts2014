	...
	implements org.omg.CORBA.portable.IDLEntity
{
	...
	{
		switch (value) {
			case _pk_null: return pk_null;
			case _pk_void: return pk_void;
			case _pk_short: return pk_short;
			case _pk_long: return pk_long;
			case _pk_ushort: return pk_ushort;
			case _pk_ulong: return pk_ulong;
			case _pk_float: return pk_float;
			case _pk_double: return pk_double;
			case _pk_boolean: return pk_boolean;
			case _pk_char: return pk_char;
			case _pk_octet: return pk_octet;
			case _pk_any: return pk_any;
			case _pk_TypeCode: return pk_TypeCode;
			case _pk_Principal: return pk_Principal;
			case _pk_string: return pk_string;
			case _pk_objref: return pk_objref;
			case _pk_longlong: return pk_longlong;
			case _pk_ulonglong: return pk_ulonglong;
			case _pk_longdouble: return pk_longdouble;
			case _pk_wchar: return pk_wchar;
			case _pk_wstring: return pk_wstring;
			case _pk_value_base: return pk_value_base;
