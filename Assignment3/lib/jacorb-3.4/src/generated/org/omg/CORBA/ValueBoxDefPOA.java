...
public abstract class ValueBoxDefPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CORBA.ValueBoxDefOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult723 = absolute_name();
_out.write_string( tmpResult723 );
				break;
			}
			case 3: // _set_id
			{
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult724 = name();
_out.write_string( tmpResult724 );
				break;
			}
			case 5: // _get_version
			{
			_out = handler.createReply();
			java.lang.String tmpResult725 = version();
_out.write_string( tmpResult725 );
				break;
			}
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult726 = id();
_out.write_string( tmpResult726 );
				break;
			}
