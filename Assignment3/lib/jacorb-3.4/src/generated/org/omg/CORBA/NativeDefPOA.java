...
public abstract class NativeDefPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CORBA.NativeDefOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult323 = absolute_name();
_out.write_string( tmpResult323 );
				break;
			}
			case 3: // _set_id
			{
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult324 = name();
_out.write_string( tmpResult324 );
				break;
			}
			case 5: // _get_version
			{
			_out = handler.createReply();
			java.lang.String tmpResult325 = version();
_out.write_string( tmpResult325 );
				break;
			}
			case 6: // describe
			{
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult326 = id();
_out.write_string( tmpResult326 );
				break;
			}
