...
public class _EnumDefStub
	...
	implements org.omg.CORBA.EnumDef
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CORBA.EnumDefOperations.class;
	public org.omg.CORBA.DefinitionKind def_kind()
	{
		while(true)
		{
			...
			else
			{
				...
				if( _so == null )
					continue;
				EnumDefOperations _localServant = (EnumDefOperations)_so.servant;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult300 = a;
_os.write_string( tmpResult300 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult301 = a;
_os.write_string( tmpResult301 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult302 = new_name;
_os.write_string( tmpResult302 );
					java.lang.String tmpResult303 = new_version;
_os.write_string( tmpResult303 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult304 = a;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					_is = _invoke(_os);
					return org.omg.CORBA.EnumMemberSeqHelper.read(_is);
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
						continue;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					org.omg.CORBA.EnumMemberSeqHelper.write(_os,a);
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
