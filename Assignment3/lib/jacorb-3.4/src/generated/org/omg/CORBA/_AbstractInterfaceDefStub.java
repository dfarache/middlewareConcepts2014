...
public class _AbstractInterfaceDefStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CORBA.AbstractInterfaceDef
{
	/** Serial version UID. */
	private static final long serialVersionUID = 1L;
	private String[] ids = {"IDL:omg.org/CORBA/AbstractInterfaceDef:1.0","IDL:omg.org/CORBA/Container:1.0","IDL:omg.org/CORBA/Contained:1.0","IDL:omg.org/CORBA/IDLType:1.0","IDL:omg.org/CORBA/IRObject:1.0","IDL:omg.org/CORBA/InterfaceDef:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = org.omg.CORBA.AbstractInterfaceDefOperations.class;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult727 = id;
_os.write_string( tmpResult727 );
					java.lang.String tmpResult728 = name;
_os.write_string( tmpResult728 );
					java.lang.String tmpResult729 = version;
_os.write_string( tmpResult729 );
		...
		else
		{
			...
			if( _so == null )
				continue;
			AbstractInterfaceDefOperations _localServant = (AbstractInterfaceDefOperations)_so.servant;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult730 = interface_id;
_os.write_string( tmpResult730 );
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult731 = id;
_os.write_string( tmpResult731 );
					java.lang.String tmpResult732 = name;
_os.write_string( tmpResult732 );
					java.lang.String tmpResult733 = version;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult734 = id;
_os.write_string( tmpResult734 );
					java.lang.String tmpResult735 = name;
_os.write_string( tmpResult735 );
					java.lang.String tmpResult736 = version;
_os.write_string( tmpResult736 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult737 = id;
_os.write_string( tmpResult737 );
					java.lang.String tmpResult738 = name;
_os.write_string( tmpResult738 );
					java.lang.String tmpResult739 = version;
_os.write_string( tmpResult739 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult740 = search_name;
_os.write_string( tmpResult740 );
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult741 = a;
_os.write_string( tmpResult741 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult742 = id;
_os.write_string( tmpResult742 );
					java.lang.String tmpResult743 = name;
_os.write_string( tmpResult743 );
					java.lang.String tmpResult744 = version;
_os.write_string( tmpResult744 );
					_os.write_boolean(is_custom);
					_os.write_boolean(is_abstract);
					org.omg.CORBA.ValueDefHelper.write(_os,base_value);
					_os.write_boolean(is_truncatable);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult745 = a;
_os.write_string( tmpResult745 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult746 = id;
_os.write_string( tmpResult746 );
					java.lang.String tmpResult747 = name;
_os.write_string( tmpResult747 );
					java.lang.String tmpResult748 = version;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult749 = id;
_os.write_string( tmpResult749 );
					java.lang.String tmpResult750 = name;
_os.write_string( tmpResult750 );
					java.lang.String tmpResult751 = version;
_os.write_string( tmpResult751 );
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult752 = new_name;
_os.write_string( tmpResult752 );
					java.lang.String tmpResult753 = new_version;
_os.write_string( tmpResult753 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult754 = id;
_os.write_string( tmpResult754 );
					java.lang.String tmpResult755 = name;
_os.write_string( tmpResult755 );
					java.lang.String tmpResult756 = version;
_os.write_string( tmpResult756 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult757 = id;
_os.write_string( tmpResult757 );
					java.lang.String tmpResult758 = name;
_os.write_string( tmpResult758 );
					java.lang.String tmpResult759 = version;
_os.write_string( tmpResult759 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult760 = search_name;
_os.write_string( tmpResult760 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult761 = a;
_os.write_string( tmpResult761 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult762 = id;
_os.write_string( tmpResult762 );
					java.lang.String tmpResult763 = name;
_os.write_string( tmpResult763 );
					java.lang.String tmpResult764 = version;
_os.write_string( tmpResult764 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult765 = id;
_os.write_string( tmpResult765 );
					java.lang.String tmpResult766 = name;
_os.write_string( tmpResult766 );
					java.lang.String tmpResult767 = version;
_os.write_string( tmpResult767 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult768 = id;
_os.write_string( tmpResult768 );
					java.lang.String tmpResult769 = name;
_os.write_string( tmpResult769 );
					java.lang.String tmpResult770 = version;
_os.write_string( tmpResult770 );
					org.omg.CORBA.IDLTypeHelper.write(_os,type);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult771 = id;
_os.write_string( tmpResult771 );
					java.lang.String tmpResult772 = name;
_os.write_string( tmpResult772 );
					java.lang.String tmpResult773 = version;
_os.write_string( tmpResult773 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult774 = id;
_os.write_string( tmpResult774 );
					java.lang.String tmpResult775 = name;
_os.write_string( tmpResult775 );
					java.lang.String tmpResult776 = version;
_os.write_string( tmpResult776 );
					org.omg.CORBA.StructMemberSeqHelper.write(_os,members);
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult777 = id;
_os.write_string( tmpResult777 );
					java.lang.String tmpResult778 = name;
_os.write_string( tmpResult778 );
					java.lang.String tmpResult779 = version;
_os.write_string( tmpResult779 );
					org.omg.CORBA.InterfaceDefSeqHelper.write(_os,base_interfaces);
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult780 = id;
_os.write_string( tmpResult780 );
					java.lang.String tmpResult781 = name;
_os.write_string( tmpResult781 );
					java.lang.String tmpResult782 = version;
_os.write_string( tmpResult782 );
					_is = _invoke(_os);
