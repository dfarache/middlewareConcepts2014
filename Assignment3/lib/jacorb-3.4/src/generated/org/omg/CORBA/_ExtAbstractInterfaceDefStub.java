...
public class _ExtAbstractInterfaceDefStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CORBA.ExtAbstractInterfaceDef
{
	/** Serial version UID. */
	private static final long serialVersionUID = 1L;
	private String[] ids = {"IDL:omg.org/CORBA/ExtAbstractInterfaceDef:1.0","IDL:omg.org/CORBA/Container:1.0","IDL:omg.org/CORBA/InterfaceAttrExtension:1.0","IDL:omg.org/CORBA/Contained:1.0","IDL:omg.org/CORBA/IDLType:1.0","IDL:omg.org/CORBA/IRObject:1.0","IDL:omg.org/CORBA/InterfaceDef:1.0","IDL:omg.org/CORBA/AbstractInterfaceDef:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = org.omg.CORBA.ExtAbstractInterfaceDefOperations.class;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult787 = id;
_os.write_string( tmpResult787 );
					java.lang.String tmpResult788 = name;
_os.write_string( tmpResult788 );
					java.lang.String tmpResult789 = version;
_os.write_string( tmpResult789 );
		...
		else
		{
			...
			if( _so == null )
				continue;
			ExtAbstractInterfaceDefOperations _localServant = (ExtAbstractInterfaceDefOperations)_so.servant;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult790 = interface_id;
_os.write_string( tmpResult790 );
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult791 = id;
_os.write_string( tmpResult791 );
					java.lang.String tmpResult792 = name;
_os.write_string( tmpResult792 );
					java.lang.String tmpResult793 = version;
_os.write_string( tmpResult793 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult794 = id;
_os.write_string( tmpResult794 );
					java.lang.String tmpResult795 = name;
_os.write_string( tmpResult795 );
					java.lang.String tmpResult796 = version;
_os.write_string( tmpResult796 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult797 = id;
_os.write_string( tmpResult797 );
					java.lang.String tmpResult798 = name;
_os.write_string( tmpResult798 );
					java.lang.String tmpResult799 = version;
_os.write_string( tmpResult799 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult800 = search_name;
_os.write_string( tmpResult800 );
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult801 = a;
_os.write_string( tmpResult801 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult802 = id;
_os.write_string( tmpResult802 );
					java.lang.String tmpResult803 = name;
_os.write_string( tmpResult803 );
					java.lang.String tmpResult804 = version;
_os.write_string( tmpResult804 );
					_os.write_boolean(is_custom);
					_os.write_boolean(is_abstract);
					org.omg.CORBA.ValueDefHelper.write(_os,base_value);
					_os.write_boolean(is_truncatable);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult805 = a;
_os.write_string( tmpResult805 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult806 = id;
_os.write_string( tmpResult806 );
					java.lang.String tmpResult807 = name;
_os.write_string( tmpResult807 );
					java.lang.String tmpResult808 = version;
_os.write_string( tmpResult808 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult809 = id;
_os.write_string( tmpResult809 );
					java.lang.String tmpResult810 = name;
_os.write_string( tmpResult810 );
					java.lang.String tmpResult811 = version;
_os.write_string( tmpResult811 );
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult812 = new_name;
_os.write_string( tmpResult812 );
					java.lang.String tmpResult813 = new_version;
_os.write_string( tmpResult813 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult814 = id;
_os.write_string( tmpResult814 );
					java.lang.String tmpResult815 = name;
_os.write_string( tmpResult815 );
					java.lang.String tmpResult816 = version;
_os.write_string( tmpResult816 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult817 = id;
_os.write_string( tmpResult817 );
					java.lang.String tmpResult818 = name;
_os.write_string( tmpResult818 );
					java.lang.String tmpResult819 = version;
_os.write_string( tmpResult819 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult820 = search_name;
_os.write_string( tmpResult820 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult821 = a;
_os.write_string( tmpResult821 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult822 = id;
_os.write_string( tmpResult822 );
					java.lang.String tmpResult823 = name;
_os.write_string( tmpResult823 );
					java.lang.String tmpResult824 = version;
_os.write_string( tmpResult824 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult825 = id;
_os.write_string( tmpResult825 );
					java.lang.String tmpResult826 = name;
_os.write_string( tmpResult826 );
					java.lang.String tmpResult827 = version;
_os.write_string( tmpResult827 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult828 = id;
_os.write_string( tmpResult828 );
					java.lang.String tmpResult829 = name;
_os.write_string( tmpResult829 );
					java.lang.String tmpResult830 = version;
_os.write_string( tmpResult830 );
					org.omg.CORBA.IDLTypeHelper.write(_os,type);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult831 = id;
_os.write_string( tmpResult831 );
					java.lang.String tmpResult832 = name;
_os.write_string( tmpResult832 );
					java.lang.String tmpResult833 = version;
_os.write_string( tmpResult833 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult834 = id;
_os.write_string( tmpResult834 );
					java.lang.String tmpResult835 = name;
_os.write_string( tmpResult835 );
					java.lang.String tmpResult836 = version;
_os.write_string( tmpResult836 );
					org.omg.CORBA.StructMemberSeqHelper.write(_os,members);
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult837 = id;
_os.write_string( tmpResult837 );
					java.lang.String tmpResult838 = name;
_os.write_string( tmpResult838 );
					java.lang.String tmpResult839 = version;
_os.write_string( tmpResult839 );
					org.omg.CORBA.InterfaceDefSeqHelper.write(_os,base_interfaces);
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult840 = id;
_os.write_string( tmpResult840 );
					java.lang.String tmpResult841 = name;
_os.write_string( tmpResult841 );
					java.lang.String tmpResult842 = version;
_os.write_string( tmpResult842 );
					org.omg.CORBA.IDLTypeHelper.write(_os,type);
					org.omg.CORBA.AttributeModeHelper.write(_os,mode);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult843 = id;
_os.write_string( tmpResult843 );
					java.lang.String tmpResult844 = name;
_os.write_string( tmpResult844 );
					java.lang.String tmpResult845 = version;
_os.write_string( tmpResult845 );
					_is = _invoke(_os);
