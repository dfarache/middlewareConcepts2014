...
public class _FixedDefStub
	...
	implements org.omg.CORBA.FixedDef
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CORBA.FixedDefOperations.class;
	public void scale(short a)
	{
		while(true)
		{
			...
			{
				org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "_set_scale", _opsClass);
				if( _so == null )
					continue;
				FixedDefOperations _localServant = (FixedDefOperations)_so.servant;
				try
				{
					_localServant.scale(a);
	...
	public void digits(short a)
	{
		while(true)
		{
			...
			{
				org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "_set_digits", _opsClass);
				if( _so == null )
					continue;
				FixedDefOperations _localServant = (FixedDefOperations)_so.servant;
				try
				{
					_localServant.digits(a);
					if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
						((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
					return;
				}
	...
	public short digits()
	{
		while(true)
		{
			...
			{
				org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "_get_digits", _opsClass);
				if( _so == null )
					continue;
				FixedDefOperations _localServant = (FixedDefOperations)_so.servant;
				short _result;
	...
	public short scale()
	{
		while(true)
		{
			...
			{
				org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "_get_scale", _opsClass);
				if( _so == null )
					continue;
				FixedDefOperations _localServant = (FixedDefOperations)_so.servant;
				short _result;
