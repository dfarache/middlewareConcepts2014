...
public abstract class ExtFullInterfaceDescriptionHelper
{
	...
	public static void insert (final org.omg.CORBA.Any any, final org.omg.CORBA.InterfaceAttrExtensionPackage.ExtFullInterfaceDescription s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.omg.CORBA.InterfaceAttrExtensionPackage.ExtFullInterfaceDescription extract (final org.omg.CORBA.Any any)
	{
	...
	{
		return "IDL:omg.org/CORBA/InterfaceAttrExtension/ExtFullInterfaceDescription:1.0";
	}
	public static org.omg.CORBA.InterfaceAttrExtensionPackage.ExtFullInterfaceDescription read (final org.omg.CORBA.portable.InputStream in)
	{
		org.omg.CORBA.InterfaceAttrExtensionPackage.ExtFullInterfaceDescription result = new org.omg.CORBA.InterfaceAttrExtensionPackage.ExtFullInterfaceDescription();
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final org.omg.CORBA.InterfaceAttrExtensionPackage.ExtFullInterfaceDescription s)
	{
		java.lang.String tmpResult494 = s.name;
out.write_string( tmpResult494 );
		java.lang.String tmpResult495 = s.id;
out.write_string( tmpResult495 );
		java.lang.String tmpResult496 = s.defined_in;
out.write_string( tmpResult496 );
		java.lang.String tmpResult497 = s.version;
out.write_string( tmpResult497 );
