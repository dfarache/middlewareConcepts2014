...
public class _StringDefStub
	...
	implements org.omg.CORBA.StringDef
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CORBA.StringDefOperations.class;
	public void bound(int a)
	{
		while(true)
		{
			...
			else
			{
				...
				if( _so == null )
					continue;
				StringDefOperations _localServant = (StringDefOperations)_so.servant;
				try
				{
