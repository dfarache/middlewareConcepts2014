...
public class _AttributeDefStub
	...
	implements org.omg.CORBA.AttributeDef
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CORBA.AttributeDefOperations.class;
	public org.omg.CORBA.IDLType type_def()
	{
		while(true)
		{
			...
			else
			{
				...
				if( _so == null )
					continue;
				AttributeDefOperations _localServant = (AttributeDefOperations)_so.servant;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult380 = a;
_os.write_string( tmpResult380 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult381 = a;
_os.write_string( tmpResult381 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult382 = new_name;
_os.write_string( tmpResult382 );
					java.lang.String tmpResult383 = new_version;
_os.write_string( tmpResult383 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult384 = a;
_os.write_string( tmpResult384 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
