...
public abstract class AbstractInterfaceDefPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CORBA.AbstractInterfaceDefOperations
{
	...
	public org.omg.CORBA.AbstractInterfaceDef _this()
	{
		org.omg.CORBA.Object __o = _this_object() ;
		org.omg.CORBA.AbstractInterfaceDef __r = org.omg.CORBA.AbstractInterfaceDefHelper.narrow(__o);
		return __r;
	}
	public org.omg.CORBA.AbstractInterfaceDef _this(org.omg.CORBA.ORB orb)
	{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult783 = id();
_out.write_string( tmpResult783 );
				break;
			}
			case 2: // is_a
			{
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult784 = absolute_name();
_out.write_string( tmpResult784 );
				break;
			}
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult785 = version();
_out.write_string( tmpResult785 );
				break;
			}
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult786 = name();
_out.write_string( tmpResult786 );
				break;
			}
