...
public abstract class ObjectIdListHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(ObjectIdListHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.CORBA.ORBPackage.ObjectIdListHelper.id(), "ObjectIdList",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.omg.CORBA.ORBPackage.ObjectIdHelper.type()));
				}
			}
		}
		return _type;
	...
	public static void write (final org.omg.CORBA.portable.OutputStream _out, java.lang.String[] _s)
	{
		...
		{
			java.lang.String tmpResult980 = _s[i];
_out.write_string( tmpResult980 );
		}
