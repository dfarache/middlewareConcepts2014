...
public abstract class ExtInterfaceDefPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CORBA.ExtInterfaceDefOperations
{
	...
	public org.omg.CORBA.ExtInterfaceDef _this()
	{
		org.omg.CORBA.Object __o = _this_object() ;
		org.omg.CORBA.ExtInterfaceDef __r = org.omg.CORBA.ExtInterfaceDefHelper.narrow(__o);
		return __r;
	}
	public org.omg.CORBA.ExtInterfaceDef _this(org.omg.CORBA.ORB orb)
	{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult557 = id();
_out.write_string( tmpResult557 );
				break;
			}
			case 2: // is_a
			{
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult558 = absolute_name();
_out.write_string( tmpResult558 );
				break;
			}
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult559 = version();
_out.write_string( tmpResult559 );
				break;
			}
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult560 = name();
_out.write_string( tmpResult560 );
				break;
			}
