...
public abstract class ExtLocalInterfaceDefPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CORBA.ExtLocalInterfaceDefOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult969 = id();
_out.write_string( tmpResult969 );
				break;
			}
			case 2: // is_a
			{
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult970 = absolute_name();
_out.write_string( tmpResult970 );
				break;
			}
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult971 = version();
_out.write_string( tmpResult971 );
				break;
			}
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult972 = name();
_out.write_string( tmpResult972 );
				break;
			}
