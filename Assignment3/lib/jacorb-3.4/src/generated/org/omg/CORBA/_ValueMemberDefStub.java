...
public class _ValueMemberDefStub
	...
	implements org.omg.CORBA.ValueMemberDef
{
	/** Serial version UID. */
	private static final long serialVersionUID = 1L;
	private String[] ids = {"IDL:omg.org/CORBA/ValueMemberDef:1.0","IDL:omg.org/CORBA/Contained:1.0","IDL:omg.org/CORBA/IRObject:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = org.omg.CORBA.ValueMemberDefOperations.class;
	public org.omg.CORBA.IDLType type_def()
	{
		while(true)
		{
			...
			else
			{
				...
				if( _so == null )
					continue;
				ValueMemberDefOperations _localServant = (ValueMemberDefOperations)_so.servant;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult565 = a;
_os.write_string( tmpResult565 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
	...
	public void access(short a)
	{
		while(true)
		{
			...
			{
				org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "_set_access", _opsClass);
				if( _so == null )
					continue;
				ValueMemberDefOperations _localServant = (ValueMemberDefOperations)_so.servant;
				try
				{
					_localServant.access(a);
					if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
						((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
					return;
				}
	...
	public short access()
	{
		while(true)
		{
			...
			{
				org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "_get_access", _opsClass);
				if( _so == null )
					continue;
				ValueMemberDefOperations _localServant = (ValueMemberDefOperations)_so.servant;
				short _result;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult566 = a;
_os.write_string( tmpResult566 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult567 = new_name;
_os.write_string( tmpResult567 );
					java.lang.String tmpResult568 = new_version;
_os.write_string( tmpResult568 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult569 = a;
_os.write_string( tmpResult569 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
