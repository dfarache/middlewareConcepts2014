...
public class _ExtLocalInterfaceDefStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CORBA.ExtLocalInterfaceDef
{
	/** Serial version UID. */
	private static final long serialVersionUID = 1L;
	private String[] ids = {"IDL:omg.org/CORBA/ExtLocalInterfaceDef:1.0","IDL:omg.org/CORBA/Container:1.0","IDL:omg.org/CORBA/InterfaceAttrExtension:1.0","IDL:omg.org/CORBA/Contained:1.0","IDL:omg.org/CORBA/IDLType:1.0","IDL:omg.org/CORBA/LocalInterfaceDef:1.0","IDL:omg.org/CORBA/IRObject:1.0","IDL:omg.org/CORBA/InterfaceDef:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = org.omg.CORBA.ExtLocalInterfaceDefOperations.class;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult910 = id;
_os.write_string( tmpResult910 );
					java.lang.String tmpResult911 = name;
_os.write_string( tmpResult911 );
					java.lang.String tmpResult912 = version;
_os.write_string( tmpResult912 );
		...
		else
		{
			...
			if( _so == null )
				continue;
			ExtLocalInterfaceDefOperations _localServant = (ExtLocalInterfaceDefOperations)_so.servant;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult913 = interface_id;
_os.write_string( tmpResult913 );
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult914 = id;
_os.write_string( tmpResult914 );
					java.lang.String tmpResult915 = name;
_os.write_string( tmpResult915 );
					java.lang.String tmpResult916 = version;
_os.write_string( tmpResult916 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult917 = id;
_os.write_string( tmpResult917 );
					java.lang.String tmpResult918 = name;
_os.write_string( tmpResult918 );
					java.lang.String tmpResult919 = version;
_os.write_string( tmpResult919 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult920 = id;
_os.write_string( tmpResult920 );
					java.lang.String tmpResult921 = name;
_os.write_string( tmpResult921 );
					java.lang.String tmpResult922 = version;
_os.write_string( tmpResult922 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult923 = search_name;
_os.write_string( tmpResult923 );
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult924 = a;
_os.write_string( tmpResult924 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult925 = id;
_os.write_string( tmpResult925 );
					java.lang.String tmpResult926 = name;
_os.write_string( tmpResult926 );
					java.lang.String tmpResult927 = version;
_os.write_string( tmpResult927 );
					_os.write_boolean(is_custom);
					_os.write_boolean(is_abstract);
					org.omg.CORBA.ValueDefHelper.write(_os,base_value);
					_os.write_boolean(is_truncatable);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult928 = a;
_os.write_string( tmpResult928 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult929 = id;
_os.write_string( tmpResult929 );
					java.lang.String tmpResult930 = name;
_os.write_string( tmpResult930 );
					java.lang.String tmpResult931 = version;
_os.write_string( tmpResult931 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult932 = id;
_os.write_string( tmpResult932 );
					java.lang.String tmpResult933 = name;
_os.write_string( tmpResult933 );
					java.lang.String tmpResult934 = version;
_os.write_string( tmpResult934 );
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult935 = new_name;
_os.write_string( tmpResult935 );
					java.lang.String tmpResult936 = new_version;
_os.write_string( tmpResult936 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult937 = id;
_os.write_string( tmpResult937 );
					java.lang.String tmpResult938 = name;
_os.write_string( tmpResult938 );
					java.lang.String tmpResult939 = version;
_os.write_string( tmpResult939 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult940 = id;
_os.write_string( tmpResult940 );
					java.lang.String tmpResult941 = name;
_os.write_string( tmpResult941 );
					java.lang.String tmpResult942 = version;
_os.write_string( tmpResult942 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult943 = search_name;
_os.write_string( tmpResult943 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult944 = a;
_os.write_string( tmpResult944 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult945 = id;
_os.write_string( tmpResult945 );
					java.lang.String tmpResult946 = name;
_os.write_string( tmpResult946 );
					java.lang.String tmpResult947 = version;
_os.write_string( tmpResult947 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult948 = id;
_os.write_string( tmpResult948 );
					java.lang.String tmpResult949 = name;
_os.write_string( tmpResult949 );
					java.lang.String tmpResult950 = version;
_os.write_string( tmpResult950 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult951 = id;
_os.write_string( tmpResult951 );
					java.lang.String tmpResult952 = name;
_os.write_string( tmpResult952 );
					java.lang.String tmpResult953 = version;
_os.write_string( tmpResult953 );
					org.omg.CORBA.IDLTypeHelper.write(_os,type);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult954 = id;
_os.write_string( tmpResult954 );
					java.lang.String tmpResult955 = name;
_os.write_string( tmpResult955 );
					java.lang.String tmpResult956 = version;
_os.write_string( tmpResult956 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult957 = id;
_os.write_string( tmpResult957 );
					java.lang.String tmpResult958 = name;
_os.write_string( tmpResult958 );
					java.lang.String tmpResult959 = version;
_os.write_string( tmpResult959 );
					org.omg.CORBA.StructMemberSeqHelper.write(_os,members);
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult960 = id;
_os.write_string( tmpResult960 );
					java.lang.String tmpResult961 = name;
_os.write_string( tmpResult961 );
					java.lang.String tmpResult962 = version;
_os.write_string( tmpResult962 );
					org.omg.CORBA.InterfaceDefSeqHelper.write(_os,base_interfaces);
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult963 = id;
_os.write_string( tmpResult963 );
					java.lang.String tmpResult964 = name;
_os.write_string( tmpResult964 );
					java.lang.String tmpResult965 = version;
_os.write_string( tmpResult965 );
					org.omg.CORBA.IDLTypeHelper.write(_os,type);
					org.omg.CORBA.AttributeModeHelper.write(_os,mode);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult966 = id;
_os.write_string( tmpResult966 );
					java.lang.String tmpResult967 = name;
_os.write_string( tmpResult967 );
					java.lang.String tmpResult968 = version;
_os.write_string( tmpResult968 );
					_is = _invoke(_os);
