...
public class _ExtAttributeDefStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CORBA.ExtAttributeDef
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CORBA.ExtAttributeDefOperations.class;
	public org.omg.CORBA.IDLType type_def()
	{
		while(true)
		{
			...
			else
			{
				...
				if( _so == null )
					continue;
				ExtAttributeDefOperations _localServant = (ExtAttributeDefOperations)_so.servant;
	...
	public org.omg.CORBA.ExceptionDescription[] set_exceptions()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request("_get_set_exceptions",true);
					_is = _invoke(_os);
					return org.omg.CORBA.ExcDescriptionSeqHelper.read(_is);
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
						continue;
			...
			{
				org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "_get_set_exceptions", _opsClass);
				if( _so == null )
					continue;
				ExtAttributeDefOperations _localServant = (ExtAttributeDefOperations)_so.servant;
				...
				try
				{
					_result = _localServant.set_exceptions();
					if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
						((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
						return _result;
				}
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult397 = a;
_os.write_string( tmpResult397 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					org.omg.CORBA.AttributeModeHelper.write(_os,a);
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
	...
	public void get_exceptions(org.omg.CORBA.ExceptionDescription[] a)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request("_set_get_exceptions",true);
					org.omg.CORBA.ExcDescriptionSeqHelper.write(_os,a);
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
			...
			{
				org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "_set_get_exceptions", _opsClass);
				if( _so == null )
					continue;
				ExtAttributeDefOperations _localServant = (ExtAttributeDefOperations)_so.servant;
				try
				{
					_localServant.get_exceptions(a);
					if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
						((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
					return;
				}
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					_is = _invoke(_os);
					return org.omg.CORBA.AttributeModeHelper.read(_is);
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
						continue;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult398 = a;
	...
	public org.omg.CORBA.ExtAttributeDescription describe_attribute()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "describe_attribute", true);
					_is = _invoke(_os);
					org.omg.CORBA.ExtAttributeDescription _result = org.omg.CORBA.ExtAttributeDescriptionHelper.read(_is);
					return _result;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "describe_attribute", _opsClass );
			if( _so == null )
				continue;
			ExtAttributeDefOperations _localServant = (ExtAttributeDefOperations)_so.servant;
			...
			try
			{
				_result = _localServant.describe_attribute();
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult399 = new_name;
_os.write_string( tmpResult399 );
					java.lang.String tmpResult400 = new_version;
	...
	public org.omg.CORBA.ExceptionDescription[] get_exceptions()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request("_get_get_exceptions",true);
					_is = _invoke(_os);
					return org.omg.CORBA.ExcDescriptionSeqHelper.read(_is);
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
			...
			{
				org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "_get_get_exceptions", _opsClass);
				if( _so == null )
					continue;
				ExtAttributeDefOperations _localServant = (ExtAttributeDefOperations)_so.servant;
				org.omg.CORBA.ExceptionDescription[] _result;
				try
				{
					_result = _localServant.get_exceptions();
					if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
						((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
						return _result;
				}
	...
	public void set_exceptions(org.omg.CORBA.ExceptionDescription[] a)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request("_set_set_exceptions",true);
					org.omg.CORBA.ExcDescriptionSeqHelper.write(_os,a);
					_is = _invoke(_os);
					return;
				}
			...
			{
				org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "_set_set_exceptions", _opsClass);
				if( _so == null )
					continue;
				ExtAttributeDefOperations _localServant = (ExtAttributeDefOperations)_so.servant;
				try
				{
					_localServant.set_exceptions(a);
					if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
						((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
					return;
				}
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult401 = a;
