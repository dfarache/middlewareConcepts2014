...
public class _ExceptionDefStub
	...
	implements org.omg.CORBA.ExceptionDef
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CORBA.ExceptionDefOperations.class;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult327 = id;
_os.write_string( tmpResult327 );
					java.lang.String tmpResult328 = name;
_os.write_string( tmpResult328 );
					java.lang.String tmpResult329 = version;
_os.write_string( tmpResult329 );
		...
		else
		{
			...
			if( _so == null )
				continue;
			ExceptionDefOperations _localServant = (ExceptionDefOperations)_so.servant;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult330 = id;
_os.write_string( tmpResult330 );
					java.lang.String tmpResult331 = name;
_os.write_string( tmpResult331 );
					java.lang.String tmpResult332 = version;
_os.write_string( tmpResult332 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult333 = id;
_os.write_string( tmpResult333 );
					java.lang.String tmpResult334 = name;
_os.write_string( tmpResult334 );
					java.lang.String tmpResult335 = version;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult336 = a;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult337 = id;
_os.write_string( tmpResult337 );
					java.lang.String tmpResult338 = name;
_os.write_string( tmpResult338 );
					java.lang.String tmpResult339 = version;
_os.write_string( tmpResult339 );
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult340 = search_name;
_os.write_string( tmpResult340 );
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult341 = id;
_os.write_string( tmpResult341 );
					java.lang.String tmpResult342 = name;
_os.write_string( tmpResult342 );
					java.lang.String tmpResult343 = version;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult344 = id;
_os.write_string( tmpResult344 );
					java.lang.String tmpResult345 = name;
_os.write_string( tmpResult345 );
					java.lang.String tmpResult346 = version;
_os.write_string( tmpResult346 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult347 = id;
_os.write_string( tmpResult347 );
					java.lang.String tmpResult348 = name;
_os.write_string( tmpResult348 );
					java.lang.String tmpResult349 = version;
_os.write_string( tmpResult349 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult350 = id;
_os.write_string( tmpResult350 );
					java.lang.String tmpResult351 = name;
_os.write_string( tmpResult351 );
					java.lang.String tmpResult352 = version;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult353 = search_name;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult354 = a;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult355 = id;
_os.write_string( tmpResult355 );
					java.lang.String tmpResult356 = name;
_os.write_string( tmpResult356 );
					java.lang.String tmpResult357 = version;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult358 = id;
_os.write_string( tmpResult358 );
					java.lang.String tmpResult359 = name;
_os.write_string( tmpResult359 );
					java.lang.String tmpResult360 = version;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult361 = id;
_os.write_string( tmpResult361 );
					java.lang.String tmpResult362 = name;
_os.write_string( tmpResult362 );
					java.lang.String tmpResult363 = version;
_os.write_string( tmpResult363 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult364 = new_name;
_os.write_string( tmpResult364 );
					java.lang.String tmpResult365 = new_version;
_os.write_string( tmpResult365 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult366 = id;
_os.write_string( tmpResult366 );
					java.lang.String tmpResult367 = name;
_os.write_string( tmpResult367 );
					java.lang.String tmpResult368 = version;
_os.write_string( tmpResult368 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult369 = id;
_os.write_string( tmpResult369 );
					java.lang.String tmpResult370 = name;
_os.write_string( tmpResult370 );
					java.lang.String tmpResult371 = version;
_os.write_string( tmpResult371 );
					org.omg.CORBA.InterfaceDefSeqHelper.write(_os,base_interfaces);
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult372 = id;
_os.write_string( tmpResult372 );
					java.lang.String tmpResult373 = name;
_os.write_string( tmpResult373 );
					java.lang.String tmpResult374 = version;
_os.write_string( tmpResult374 );
					org.omg.CORBA.StructMemberSeqHelper.write(_os,members);
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult375 = a;
_os.write_string( tmpResult375 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
