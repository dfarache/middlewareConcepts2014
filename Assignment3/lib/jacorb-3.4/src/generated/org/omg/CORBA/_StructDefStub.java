...
public class _StructDefStub
	...
	implements org.omg.CORBA.StructDef
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CORBA.StructDefOperations.class;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult194 = id;
_os.write_string( tmpResult194 );
					java.lang.String tmpResult195 = name;
_os.write_string( tmpResult195 );
					java.lang.String tmpResult196 = version;
_os.write_string( tmpResult196 );
		...
		else
		{
			...
			if( _so == null )
				continue;
			StructDefOperations _localServant = (StructDefOperations)_so.servant;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					org.omg.CORBA.StructMemberSeqHelper.write(_os,a);
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult197 = id;
_os.write_string( tmpResult197 );
					java.lang.String tmpResult198 = name;
_os.write_string( tmpResult198 );
					java.lang.String tmpResult199 = version;
_os.write_string( tmpResult199 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult200 = id;
_os.write_string( tmpResult200 );
					java.lang.String tmpResult201 = name;
_os.write_string( tmpResult201 );
					java.lang.String tmpResult202 = version;
_os.write_string( tmpResult202 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult203 = a;
_os.write_string( tmpResult203 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult204 = id;
_os.write_string( tmpResult204 );
					java.lang.String tmpResult205 = name;
_os.write_string( tmpResult205 );
					java.lang.String tmpResult206 = version;
_os.write_string( tmpResult206 );
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult207 = search_name;
_os.write_string( tmpResult207 );
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult208 = id;
_os.write_string( tmpResult208 );
					java.lang.String tmpResult209 = name;
_os.write_string( tmpResult209 );
					java.lang.String tmpResult210 = version;
_os.write_string( tmpResult210 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult211 = id;
_os.write_string( tmpResult211 );
					java.lang.String tmpResult212 = name;
_os.write_string( tmpResult212 );
					java.lang.String tmpResult213 = version;
_os.write_string( tmpResult213 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult214 = id;
_os.write_string( tmpResult214 );
					java.lang.String tmpResult215 = name;
_os.write_string( tmpResult215 );
					java.lang.String tmpResult216 = version;
_os.write_string( tmpResult216 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult217 = id;
_os.write_string( tmpResult217 );
					java.lang.String tmpResult218 = name;
_os.write_string( tmpResult218 );
					java.lang.String tmpResult219 = version;
_os.write_string( tmpResult219 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult220 = search_name;
_os.write_string( tmpResult220 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult221 = a;
_os.write_string( tmpResult221 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult222 = id;
_os.write_string( tmpResult222 );
					java.lang.String tmpResult223 = name;
_os.write_string( tmpResult223 );
					java.lang.String tmpResult224 = version;
_os.write_string( tmpResult224 );
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult225 = id;
_os.write_string( tmpResult225 );
					java.lang.String tmpResult226 = name;
_os.write_string( tmpResult226 );
					java.lang.String tmpResult227 = version;
_os.write_string( tmpResult227 );
					_os.write_boolean(is_custom);
					_os.write_boolean(is_abstract);
					org.omg.CORBA.ValueDefHelper.write(_os,base_value);
					_os.write_boolean(is_truncatable);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult228 = id;
_os.write_string( tmpResult228 );
					java.lang.String tmpResult229 = name;
_os.write_string( tmpResult229 );
					java.lang.String tmpResult230 = version;
_os.write_string( tmpResult230 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult231 = new_name;
_os.write_string( tmpResult231 );
					java.lang.String tmpResult232 = new_version;
_os.write_string( tmpResult232 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult233 = id;
_os.write_string( tmpResult233 );
					java.lang.String tmpResult234 = name;
_os.write_string( tmpResult234 );
					java.lang.String tmpResult235 = version;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult236 = id;
_os.write_string( tmpResult236 );
					java.lang.String tmpResult237 = name;
_os.write_string( tmpResult237 );
					java.lang.String tmpResult238 = version;
_os.write_string( tmpResult238 );
					org.omg.CORBA.InterfaceDefSeqHelper.write(_os,base_interfaces);
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult239 = id;
_os.write_string( tmpResult239 );
					java.lang.String tmpResult240 = name;
_os.write_string( tmpResult240 );
					java.lang.String tmpResult241 = version;
_os.write_string( tmpResult241 );
					org.omg.CORBA.StructMemberSeqHelper.write(_os,members);
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					_is = _invoke(_os);
					return org.omg.CORBA.StructMemberSeqHelper.read(_is);
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
						continue;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult242 = a;
_os.write_string( tmpResult242 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
