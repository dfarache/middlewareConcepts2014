	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CORBA.InterfaceDefOperations
{
	...
	public org.omg.CORBA.InterfaceDef _this()
	{
		...
		org.omg.CORBA.InterfaceDef __r = org.omg.CORBA.InterfaceDefHelper.narrow(__o);
		return __r;
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult479 = id();
_out.write_string( tmpResult479 );
				break;
			}
			case 2: // is_a
			{
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult480 = absolute_name();
_out.write_string( tmpResult480 );
				break;
			}
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult481 = version();
_out.write_string( tmpResult481 );
			...
			{
			_out = handler.createReply();
			java.lang.String tmpResult482 = name();
