		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult1159 = supported_interface;
_os.write_string( tmpResult1159 );
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult1160 = uses_interface;
_os.write_string( tmpResult1160 );
					_is = _invoke(_os);
