...
public abstract class TypedProxyPullSupplierPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosTypedEventChannelAdmin.TypedProxyPullSupplierOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "connect_pull_consumer", Integer.valueOf(3));
		m_opsHash.put ( "try_pull", Integer.valueOf(4));
	}
