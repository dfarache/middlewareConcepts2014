		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult1157 = supported_interface;
_os.write_string( tmpResult1157 );
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult1158 = uses_interface;
_os.write_string( tmpResult1158 );
					_is = _invoke(_os);
					org.omg.CosEventChannelAdmin.ProxyPullConsumer _result = org.omg.CosEventChannelAdmin.ProxyPullConsumerHelper.read(_is);
					return _result;
				}
