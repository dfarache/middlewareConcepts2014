...
public abstract class UnknownServiceTypeHelper
{
	...
	public static org.omg.CosTrading.UnknownServiceType read (final org.omg.CORBA.portable.InputStream in)
	{
		...
		java.lang.String x0;
		x0=in.read_string();
		final org.omg.CosTrading.UnknownServiceType result = new org.omg.CosTrading.UnknownServiceType(id, x0);
		return result;
	}
	public static void write (final org.omg.CORBA.portable.OutputStream out, final org.omg.CosTrading.UnknownServiceType s)
	{
		out.write_string(id());
		java.lang.String tmpResult1044 = s.type;
