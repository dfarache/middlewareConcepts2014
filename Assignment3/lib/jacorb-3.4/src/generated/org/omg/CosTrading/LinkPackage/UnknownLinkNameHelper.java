...
public abstract class UnknownLinkNameHelper
{
	...
	public static org.omg.CosTrading.LinkPackage.UnknownLinkName read (final org.omg.CORBA.portable.InputStream in)
	{
		...
		java.lang.String x0;
		x0=in.read_string();
		final org.omg.CosTrading.LinkPackage.UnknownLinkName result = new org.omg.CosTrading.LinkPackage.UnknownLinkName(id, x0);
		return result;
	}
	...
	{
		out.write_string(id());
		java.lang.String tmpResult1083 = s.name;
out.write_string( tmpResult1083 );
	}
}
