...
public abstract class DuplicatePolicyNameHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(DuplicatePolicyNameHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_exception_tc(org.omg.CosTrading.DuplicatePolicyNameHelper.id(),"DuplicatePolicyName",new org.omg.CORBA.StructMember[]{new org.omg.CORBA.StructMember("name", org.omg.CORBA.ORB.init().create_alias_tc(org.omg.CosTrading.PolicyNameHelper.id(), "PolicyName",org.omg.CORBA.ORB.init().create_string_tc(0)), null)});
				}
			}
		}
		return _type;
	...
	public static org.omg.CosTrading.DuplicatePolicyName read (final org.omg.CORBA.portable.InputStream in)
	{
		...
		java.lang.String x0;
		x0=in.read_string();
		final org.omg.CosTrading.DuplicatePolicyName result = new org.omg.CosTrading.DuplicatePolicyName(id, x0);
		return result;
	}
	public static void write (final org.omg.CORBA.portable.OutputStream out, final org.omg.CosTrading.DuplicatePolicyName s)
	{
		out.write_string(id());
		java.lang.String tmpResult1055 = s.name;
out.write_string( tmpResult1055 );
	}
}
