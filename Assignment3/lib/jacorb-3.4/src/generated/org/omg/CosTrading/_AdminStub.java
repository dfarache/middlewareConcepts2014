	...
	public int set_max_match_card(int value)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "set_max_match_card", true);
	...
	public org.omg.CosTrading.FollowOption set_max_link_follow_policy(org.omg.CosTrading.FollowOption policy)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "set_max_link_follow_policy", true);
	...
	public int set_max_list(int value)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "set_max_list", true);
					_os.write_ulong(value);
					_is = _invoke(_os);
					int _result = _is.read_ulong();
					return _result;
	...
	public byte[] request_id_stem()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request("_get_request_id_stem",true);
					_is = _invoke(_os);
	...
	public int set_def_search_card(int value)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "set_def_search_card", true);
					_os.write_ulong(value);
					_is = _invoke(_os);
					int _result = _is.read_ulong();
					return _result;
	...
	public int set_def_hop_count(int value)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "set_def_hop_count", true);
					_os.write_ulong(value);
					_is = _invoke(_os);
					int _result = _is.read_ulong();
					return _result;
	...
	public boolean set_supports_dynamic_properties(boolean value)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "set_supports_dynamic_properties", true);
	...
	public int set_max_hop_count(int value)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "set_max_hop_count", true);
					_os.write_ulong(value);
					_is = _invoke(_os);
					int _result = _is.read_ulong();
					return _result;
	...
	public int set_def_match_card(int value)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "set_def_match_card", true);
					_os.write_ulong(value);
					_is = _invoke(_os);
					int _result = _is.read_ulong();
					return _result;
	...
	public boolean set_supports_modifiable_properties(boolean value)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "set_supports_modifiable_properties", true);
					_os.write_boolean(value);
					_is = _invoke(_os);
					boolean _result = _is.read_boolean();
					return _result;
	...
	public org.omg.CosTrading.FollowOption set_def_follow_policy(org.omg.CosTrading.FollowOption policy)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "set_def_follow_policy", true);
					org.omg.CosTrading.FollowOptionHelper.write(_os,policy);
					_is = _invoke(_os);
					org.omg.CosTrading.FollowOption _result = org.omg.CosTrading.FollowOptionHelper.read(_is);
					return _result;
	...
	public org.omg.CosTrading.FollowOption set_max_follow_policy(org.omg.CosTrading.FollowOption policy)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "set_max_follow_policy", true);
					org.omg.CosTrading.FollowOptionHelper.write(_os,policy);
					_is = _invoke(_os);
					org.omg.CosTrading.FollowOption _result = org.omg.CosTrading.FollowOptionHelper.read(_is);
					return _result;
	...
	public int set_max_return_card(int value)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "set_max_return_card", true);
					_os.write_ulong(value);
					_is = _invoke(_os);
					int _result = _is.read_ulong();
					return _result;
	...
	public org.omg.CORBA.Object set_type_repos(org.omg.CORBA.Object repository)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "set_type_repos", true);
	...
	public byte[] set_request_id_stem(byte[] stem)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "set_request_id_stem", true);
	...
	public void list_proxies(int how_many, org.omg.CosTrading.OfferIdSeqHolder ids, org.omg.CosTrading.OfferIdIteratorHolder id_itr) throws org.omg.CosTrading.NotImplemented
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "list_proxies", true);
	...
	public int set_max_search_card(int value)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "set_max_search_card", true);
					_os.write_ulong(value);
					_is = _invoke(_os);
					int _result = _is.read_ulong();
					return _result;
	...
	public boolean set_supports_proxy_offers(boolean value)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "set_supports_proxy_offers", true);
					_os.write_boolean(value);
					_is = _invoke(_os);
					boolean _result = _is.read_boolean();
					return _result;
	...
	public int set_def_return_card(int value)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "set_def_return_card", true);
					_os.write_ulong(value);
					_is = _invoke(_os);
					int _result = _is.read_ulong();
					return _result;
