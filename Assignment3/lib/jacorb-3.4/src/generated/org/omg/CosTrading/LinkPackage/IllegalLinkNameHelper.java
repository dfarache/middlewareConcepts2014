...
public abstract class IllegalLinkNameHelper
{
	...
	public static org.omg.CosTrading.LinkPackage.IllegalLinkName read (final org.omg.CORBA.portable.InputStream in)
	{
		...
		java.lang.String x0;
		x0=in.read_string();
		final org.omg.CosTrading.LinkPackage.IllegalLinkName result = new org.omg.CosTrading.LinkPackage.IllegalLinkName(id, x0);
		return result;
	}
	...
	{
		out.write_string(id());
		java.lang.String tmpResult1082 = s.name;
out.write_string( tmpResult1082 );
	}
}
