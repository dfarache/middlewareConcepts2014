...
public abstract class ReadonlyPropertyHelper
{
	...
	{
		out.write_string(id());
		java.lang.String tmpResult1075 = s.type;
out.write_string( tmpResult1075 );
		java.lang.String tmpResult1076 = s.name;
out.write_string( tmpResult1076 );
	}
}
