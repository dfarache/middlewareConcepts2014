...
public abstract class LinkAttributesHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(LinkAttributesHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:omg.org/CosTrading/LinkAttributes:1.0", "LinkAttributes");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(org.omg.CosTrading._LinkAttributesStub.class));
	}
	...
	public static org.omg.CosTrading.LinkAttributes narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof org.omg.CosTrading.LinkAttributes)
		{
			return (org.omg.CosTrading.LinkAttributes)obj;
		}
		else if (obj._is_a("IDL:omg.org/CosTrading/LinkAttributes:1.0"))
		{
