...
public abstract class ReadonlyDynamicPropertyHelper
{
	...
	{
		out.write_string(id());
		java.lang.String tmpResult1050 = s.type;
out.write_string( tmpResult1050 );
		java.lang.String tmpResult1051 = s.name;
