...
public abstract class PropertyNameSeqHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(PropertyNameSeqHelper.class)
			{
				if (_type == null)
				{
	...
	public static java.lang.String[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new java.lang.String[_l_result84];
	...
	public static void write (final org.omg.CORBA.portable.OutputStream _out, java.lang.String[] _s)
	{
		...
		{
			java.lang.String tmpResult1032 = _s[i];
_out.write_string( tmpResult1032 );
		}
