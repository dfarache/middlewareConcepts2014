...
public abstract class AdminHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(AdminHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:omg.org/CosTrading/Admin:1.0", "Admin");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(org.omg.CosTrading._AdminStub.class));
	}
	...
	public static org.omg.CosTrading.Admin narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof org.omg.CosTrading.Admin)
		{
			return (org.omg.CosTrading.Admin)obj;
		}
		else if (obj._is_a("IDL:omg.org/CosTrading/Admin:1.0"))
		{
