		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult1085 = id;
_os.write_string( tmpResult1085 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult1086 = id;
_os.write_string( tmpResult1086 );
					_is = _invoke(_os);
		...
		else
		{
			...
			if( _so == null )
				continue;
			ProxyOperations _localServant = (ProxyOperations)_so.servant;
			org.omg.CosTrading.ProxyPackage.ProxyInfo _result;
			try
			{
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult1087 = type;
_os.write_string( tmpResult1087 );
					org.omg.CosTrading.PropertySeqHelper.write(_os,properties);
					_os.write_boolean(if_match_all);
					java.lang.String tmpResult1088 = recipe;
_os.write_string( tmpResult1088 );
				...
				catch( org.omg.CORBA.portable.ApplicationException _ax )
				{
					...
					try
					{
						...
						if( _id.equals("IDL:omg.org/CosTrading/Proxy/IllegalRecipe:1.0"))
						{
		...
		else
		{
			...
			catch (org.omg.CosTrading.ProxyPackage.IllegalRecipe ex) 
			{
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).exceptionalCompletion(ex);
				throw ex;
