...
public abstract class UnknownOfferIdHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(UnknownOfferIdHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_exception_tc(org.omg.CosTrading.UnknownOfferIdHelper.id(),"UnknownOfferId",new org.omg.CORBA.StructMember[]{new org.omg.CORBA.StructMember("id", org.omg.CORBA.ORB.init().create_alias_tc(org.omg.CosTrading.OfferIdHelper.id(), "OfferId",org.omg.CORBA.ORB.init().create_string_tc(0)), null)});
				}
			}
		}
		return _type;
	...
	{
		out.write_string(id());
		java.lang.String tmpResult1054 = s.id;
out.write_string( tmpResult1054 );
	}
}
