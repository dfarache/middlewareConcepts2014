...
public abstract class NoMatchingOffersHelper
{
	...
	{
		out.write_string(id());
		java.lang.String tmpResult1077 = s.constr;
out.write_string( tmpResult1077 );
	}
}
