...
public abstract class IllegalPropertyNameHelper
{
	...
	public static org.omg.CosTrading.IllegalPropertyName read (final org.omg.CORBA.portable.InputStream in)
	{
		...
		java.lang.String x0;
		x0=in.read_string();
		final org.omg.CosTrading.IllegalPropertyName result = new org.omg.CosTrading.IllegalPropertyName(id, x0);
		return result;
	}
	public static void write (final org.omg.CORBA.portable.OutputStream out, final org.omg.CosTrading.IllegalPropertyName s)
	{
		out.write_string(id());
		java.lang.String tmpResult1045 = s.name;
