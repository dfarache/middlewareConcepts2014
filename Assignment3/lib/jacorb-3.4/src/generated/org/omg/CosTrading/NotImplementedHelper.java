...
/**
 * Generated from IDL exception "NotImplemented".
 *
 * @author JacORB IDL compiler V @project.version@
 * @version generated at 27-May-2014 20:14:30
 */

public abstract class NotImplementedHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(NotImplementedHelper.class)
			{
				if (_type == null)
				{
	...
	public static org.omg.CosTrading.NotImplemented read (final org.omg.CORBA.portable.InputStream in)
	{
		...
		final org.omg.CosTrading.NotImplemented result = new org.omg.CosTrading.NotImplemented(id);
		return result;
	}
