...
public abstract class SupportAttributesHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(SupportAttributesHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:omg.org/CosTrading/SupportAttributes:1.0", "SupportAttributes");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(org.omg.CosTrading._SupportAttributesStub.class));
	}
	...
	public static org.omg.CosTrading.SupportAttributes narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof org.omg.CosTrading.SupportAttributes)
		{
			return (org.omg.CosTrading.SupportAttributes)obj;
		}
		else if (obj._is_a("IDL:omg.org/CosTrading/SupportAttributes:1.0"))
		{
