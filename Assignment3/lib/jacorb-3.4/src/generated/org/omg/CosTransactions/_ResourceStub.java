	...
	implements org.omg.CosTransactions.Resource
{
	...
	public final static java.lang.Class _opsClass = org.omg.CosTransactions.ResourceOperations.class;
	public void rollback() throws org.omg.CosTransactions.HeuristicHazard,org.omg.CosTransactions.HeuristicMixed,org.omg.CosTransactions.HeuristicCommit
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			ResourceOperations _localServant = (ResourceOperations)_so.servant;
			try
			{
