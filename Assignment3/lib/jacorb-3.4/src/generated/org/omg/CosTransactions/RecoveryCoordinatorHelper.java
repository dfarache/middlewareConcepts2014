...
public abstract class RecoveryCoordinatorHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(RecoveryCoordinatorHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:omg.org/CosTransactions/RecoveryCoordinator:1.0", "RecoveryCoordinator");
				}
			}
		}
		return _type;
