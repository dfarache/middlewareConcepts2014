...
public abstract class PropagationContextHelper
{
	...
	public static org.omg.CosTransactions.PropagationContext read (final org.omg.CORBA.portable.InputStream in)
	{
		...
		int _lresult_parents93 = in.read_long();
		try
		{
			 int x = in.available();
			 if ( x > 0 && _lresult_parents93 > x )
				{
					throw new org.omg.CORBA.MARSHAL("Sequence length too large. Only " + x + " available and trying to assign " + _lresult_parents93);
				}
		}
		catch (java.io.IOException e)
		{
		}
		result.parents = new org.omg.CosTransactions.TransIdentity[_lresult_parents93];
