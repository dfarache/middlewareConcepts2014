...
/**
 * Generated from IDL alias "MsgType_1_2".
 *
 * @author JacORB IDL compiler V @project.version@
 * @version generated at 27-May-2014 20:14:30
 */

public abstract class MsgType_1_2Helper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(MsgType_1_2Helper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.GIOP.MsgType_1_2Helper.id(), "MsgType_1_2",org.omg.CORBA.ORB.init().create_enum_tc(org.omg.GIOP.MsgType_1_1Helper.id(),"MsgType_1_1",new String[]{"Request","Reply","CancelRequest","LocateRequest","LocateReply","CloseConnection","MessageError","Fragment"}));
				}
			}
		}
		return _type;
