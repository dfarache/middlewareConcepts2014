...
public abstract class IDsHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(IDsHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.PortableGroup.IDsHelper.id(), "IDs",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.omg.PortableServer.ObjectIdHelper.type()));
				}
			}
		}
		return _type;
	...
	{
		return "IDL:omg.org/PortableGroup/IDs:1.0";
	}
	public static byte[][] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new byte[_l_result75][];
		for (int i=0;i<_result.length;i++)
		{
			_result[i] = org.omg.CORBA.OctetSeqHelper.read(_in);
		}
	...
	public static void write (final org.omg.CORBA.portable.OutputStream _out, byte[][] _s)
	{
		...
		{
			org.omg.CORBA.OctetSeqHelper.write(_out,_s[i]);
		}
