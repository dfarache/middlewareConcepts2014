...
/**
 * Generated from IDL alias "Criteria".
 *
...
public abstract class CriteriaHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(CriteriaHelper.class)
			{
				if (_type == null)
				{
	...
	{
		return "IDL:omg.org/PortableGroup/Criteria:1.0";
	}
	public static org.omg.PortableGroup.Property[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = org.omg.PortableGroup.PropertiesHelper.read(_in);
		return _result;
	}

	public static void write (final org.omg.CORBA.portable.OutputStream _out, org.omg.PortableGroup.Property[] _s)
	{
		org.omg.PortableGroup.PropertiesHelper.write(_out,_s);
	}
}
