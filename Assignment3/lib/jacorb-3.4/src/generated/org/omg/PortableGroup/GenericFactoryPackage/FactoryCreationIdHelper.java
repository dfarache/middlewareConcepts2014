package org.omg.PortableGroup.GenericFactoryPackage;

/**
 * Generated from IDL alias "FactoryCreationId".
 *
 * @author JacORB IDL compiler V @project.version@
 * @version generated at 27-May-2014 20:14:30
 */

public abstract class FactoryCreationIdHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(FactoryCreationIdHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.PortableGroup.GenericFactoryPackage.FactoryCreationIdHelper.id(), "FactoryCreationId",org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.from_int(11)));
				}
			}
		}
		return _type;
