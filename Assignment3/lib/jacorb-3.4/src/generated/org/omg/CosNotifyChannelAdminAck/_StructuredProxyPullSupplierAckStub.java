...
public class _StructuredProxyPullSupplierAckStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosNotifyChannelAdminAck.StructuredProxyPullSupplierAck
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CosNotifyChannelAdminAck.StructuredProxyPullSupplierAckOperations.class;
	public int[] get_all_filters()
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			StructuredProxyPullSupplierAckOperations _localServant = (StructuredProxyPullSupplierAckOperations)_so.servant;
			int[] _result;
			try
			{
	...
	public void disconnect_structured_pull_supplier()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "disconnect_structured_pull_supplier", true);
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
	...
	public org.omg.CosNotification.StructuredEvent pull_structured_event() throws org.omg.CosEventComm.Disconnected
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "pull_structured_event", true);
					_is = _invoke(_os);
	...
	public void connect_structured_pull_consumer(org.omg.CosNotifyComm.StructuredPullConsumer pull_consumer) throws org.omg.CosEventChannelAdmin.AlreadyConnected
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "connect_structured_pull_consumer", true);
	...
	public org.omg.CosNotification.StructuredEvent try_pull_structured_event(org.omg.CORBA.BooleanHolder has_event) throws org.omg.CosEventComm.Disconnected
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "try_pull_structured_event", true);
					_is = _invoke(_os);
					org.omg.CosNotification.StructuredEvent _result = org.omg.CosNotification.StructuredEventHelper.read(_is);
