...
public class StructuredProxyPushSupplierAckPOATie
	extends StructuredProxyPushSupplierAckPOA
{
	private StructuredProxyPushSupplierAckOperations _delegate;

	private POA _poa;
	public StructuredProxyPushSupplierAckPOATie(StructuredProxyPushSupplierAckOperations delegate)
	{
		_delegate = delegate;
	}
	public StructuredProxyPushSupplierAckPOATie(StructuredProxyPushSupplierAckOperations delegate, POA poa)
	{
		_delegate = delegate;
		_poa = poa;
	}
	...
	public StructuredProxyPushSupplierAckOperations _delegate()
	{
		return _delegate;
	}
	public void _delegate(StructuredProxyPushSupplierAckOperations delegate)
	{
		_delegate = delegate;
	}
