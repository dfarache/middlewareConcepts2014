...
public abstract class SequenceProxyPullSupplierAckHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(SequenceProxyPullSupplierAckHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:omg.org/CosNotifyChannelAdminAck/SequenceProxyPullSupplierAck:1.0", "SequenceProxyPullSupplierAck");
				}
			}
		}
		return _type;
