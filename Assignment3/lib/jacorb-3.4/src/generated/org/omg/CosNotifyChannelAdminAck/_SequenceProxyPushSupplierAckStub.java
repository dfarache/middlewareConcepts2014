...
public class _SequenceProxyPushSupplierAckStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosNotifyChannelAdminAck.SequenceProxyPushSupplierAck
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CosNotifyChannelAdminAck.SequenceProxyPushSupplierAckOperations.class;
	public int[] get_all_filters()
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			SequenceProxyPushSupplierAckOperations _localServant = (SequenceProxyPushSupplierAckOperations)_so.servant;
			int[] _result;
			try
			{
	...
	public void connect_sequence_push_consumer(org.omg.CosNotifyComm.SequencePushConsumer push_consumer) throws org.omg.CosEventChannelAdmin.AlreadyConnected,org.omg.CosEventChannelAdmin.TypeError
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "connect_sequence_push_consumer", true);
