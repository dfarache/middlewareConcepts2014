...
public class _StructuredProxyPushSupplierAckStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosNotifyChannelAdminAck.StructuredProxyPushSupplierAck
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = org.omg.CosNotifyChannelAdminAck.StructuredProxyPushSupplierAckOperations.class;
	public int[] get_all_filters()
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			StructuredProxyPushSupplierAckOperations _localServant = (StructuredProxyPushSupplierAckOperations)_so.servant;
			int[] _result;
			try
			{
	...
	public void connect_structured_push_consumer(org.omg.CosNotifyComm.StructuredPushConsumer push_consumer) throws org.omg.CosEventChannelAdmin.AlreadyConnected,org.omg.CosEventChannelAdmin.TypeError
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "connect_structured_push_consumer", true);
