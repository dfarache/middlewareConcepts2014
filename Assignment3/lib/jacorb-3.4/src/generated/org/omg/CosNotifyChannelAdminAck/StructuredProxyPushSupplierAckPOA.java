...
public abstract class StructuredProxyPushSupplierAckPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosNotifyChannelAdminAck.StructuredProxyPushSupplierAckOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "connect_structured_push_consumer", Integer.valueOf(16));
		m_opsHash.put ( "remove_all_filters", Integer.valueOf(17));
		m_opsHash.put ( "_set_lifetime_filter", Integer.valueOf(18));
		m_opsHash.put ( "validate_qos", Integer.valueOf(19));
		m_opsHash.put ( "acknowledge", Integer.valueOf(20));
		m_opsHash.put ( "_get_MyAdmin", Integer.valueOf(21));
	}
	private String[] ids = {"IDL:omg.org/CosNotifyChannelAdminAck/StructuredProxyPushSupplierAck:1.0","IDL:omg.org/CosNotifyChannelAdmin/StructuredProxyPushSupplier:1.0","IDL:omg.org/CosNotifyChannelAdmin/ProxySupplier:1.0","IDL:omg.org/CosNotifyComm/StructuredPushSupplier:1.0","IDL:omg.org/CosNotifyComm/NotifySubscribe:1.0","IDL:omg.org/CosNotifyFilter/FilterAdmin:1.0","IDL:omg.org/CosNotification/QoSAdmin:1.0"};
	public org.omg.CosNotifyChannelAdminAck.StructuredProxyPushSupplierAck _this()
	{
		org.omg.CORBA.Object __o = _this_object() ;
		org.omg.CosNotifyChannelAdminAck.StructuredProxyPushSupplierAck __r = org.omg.CosNotifyChannelAdminAck.StructuredProxyPushSupplierAckHelper.narrow(__o);
		return __r;
	}
	public org.omg.CosNotifyChannelAdminAck.StructuredProxyPushSupplierAck _this(org.omg.CORBA.ORB orb)
	{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 16: // connect_structured_push_consumer
			{
			try
			{
