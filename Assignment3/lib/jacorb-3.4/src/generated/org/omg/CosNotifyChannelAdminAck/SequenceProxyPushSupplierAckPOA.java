	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosNotifyChannelAdminAck.SequenceProxyPushSupplierAckOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "disconnect_sequence_push_supplier", Integer.valueOf(7));
		m_opsHash.put ( "set_qos", Integer.valueOf(8));
		m_opsHash.put ( "connect_sequence_push_consumer", Integer.valueOf(9));
		m_opsHash.put ( "resume_connection", Integer.valueOf(10));
	...
	public org.omg.CosNotifyChannelAdminAck.SequenceProxyPushSupplierAck _this()
	{
		...
		org.omg.CosNotifyChannelAdminAck.SequenceProxyPushSupplierAck __r = org.omg.CosNotifyChannelAdminAck.SequenceProxyPushSupplierAckHelper.narrow(__o);
		return __r;
	}
