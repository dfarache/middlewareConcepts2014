...
public abstract class ProxyPushSupplierHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(ProxyPushSupplierHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:omg.org/CosNotifyChannelAdmin/ProxyPushSupplier:1.0", "ProxyPushSupplier");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(org.omg.CosNotifyChannelAdmin._ProxyPushSupplierStub.class));
	}
	...
	public static org.omg.CosNotifyChannelAdmin.ProxyPushSupplier narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof org.omg.CosNotifyChannelAdmin.ProxyPushSupplier)
		{
			return (org.omg.CosNotifyChannelAdmin.ProxyPushSupplier)obj;
		}
		else if (obj._is_a("IDL:omg.org/CosNotifyChannelAdmin/ProxyPushSupplier:1.0"))
		{
