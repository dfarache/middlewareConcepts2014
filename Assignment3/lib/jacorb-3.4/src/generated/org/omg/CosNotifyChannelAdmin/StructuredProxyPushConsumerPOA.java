	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosNotifyChannelAdmin.StructuredProxyPushConsumerOperations
{
	...
	static
	{
		m_opsHash.put ( "connect_structured_push_supplier", Integer.valueOf(0));
		m_opsHash.put ( "_get_MyType", Integer.valueOf(1));
		m_opsHash.put ( "set_qos", Integer.valueOf(2));
		m_opsHash.put ( "validate_event_qos", Integer.valueOf(3));
		m_opsHash.put ( "push_structured_event", Integer.valueOf(4));
		m_opsHash.put ( "offer_change", Integer.valueOf(5));
		m_opsHash.put ( "obtain_subscription_types", Integer.valueOf(6));
		m_opsHash.put ( "add_filter", Integer.valueOf(7));
		m_opsHash.put ( "disconnect_structured_push_consumer", Integer.valueOf(8));
		m_opsHash.put ( "remove_filter", Integer.valueOf(9));
		m_opsHash.put ( "remove_all_filters", Integer.valueOf(10));
	...
	public org.omg.CosNotifyChannelAdmin.StructuredProxyPushConsumer _this()
	{
		...
		org.omg.CosNotifyChannelAdmin.StructuredProxyPushConsumer __r = org.omg.CosNotifyChannelAdmin.StructuredProxyPushConsumerHelper.narrow(__o);
		return __r;
	}
