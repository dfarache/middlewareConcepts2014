	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosNotifyChannelAdmin.SequenceProxyPushConsumerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "disconnect_sequence_push_consumer", Integer.valueOf(2));
		m_opsHash.put ( "validate_event_qos", Integer.valueOf(3));
		m_opsHash.put ( "connect_sequence_push_supplier", Integer.valueOf(4));
		...
		m_opsHash.put ( "push_structured_events", Integer.valueOf(9));
	...
	public org.omg.CosNotifyChannelAdmin.SequenceProxyPushConsumer _this()
	{
		...
		org.omg.CosNotifyChannelAdmin.SequenceProxyPushConsumer __r = org.omg.CosNotifyChannelAdmin.SequenceProxyPushConsumerHelper.narrow(__o);
		return __r;
	}
