	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosNotifyChannelAdmin.ProxyPushSupplierOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "resume_connection", Integer.valueOf(8));
		m_opsHash.put ( "disconnect_push_supplier", Integer.valueOf(9));
		m_opsHash.put ( "connect_any_push_consumer", Integer.valueOf(10));
	...
	public org.omg.CosNotifyChannelAdmin.ProxyPushSupplier _this()
	{
		...
		org.omg.CosNotifyChannelAdmin.ProxyPushSupplier __r = org.omg.CosNotifyChannelAdmin.ProxyPushSupplierHelper.narrow(__o);
		return __r;
	}
