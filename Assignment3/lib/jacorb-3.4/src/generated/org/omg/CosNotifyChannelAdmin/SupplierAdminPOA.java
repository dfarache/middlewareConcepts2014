	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosNotifyChannelAdmin.SupplierAdminOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "_get_pull_consumers", Integer.valueOf(2));
		m_opsHash.put ( "_get_MyID", Integer.valueOf(3));
		m_opsHash.put ( "get_qos", Integer.valueOf(4));
		m_opsHash.put ( "obtain_push_consumer", Integer.valueOf(5));
		m_opsHash.put ( "get_filter", Integer.valueOf(6));
		m_opsHash.put ( "_get_push_consumers", Integer.valueOf(7));
		m_opsHash.put ( "_get_MyOperator", Integer.valueOf(8));
		m_opsHash.put ( "obtain_notification_pull_consumer", Integer.valueOf(9));
		m_opsHash.put ( "set_qos", Integer.valueOf(10));
		m_opsHash.put ( "get_proxy_consumer", Integer.valueOf(11));
		m_opsHash.put ( "add_filter", Integer.valueOf(12));
		m_opsHash.put ( "obtain_notification_push_consumer", Integer.valueOf(13));
		m_opsHash.put ( "remove_filter", Integer.valueOf(14));
		m_opsHash.put ( "remove_all_filters", Integer.valueOf(15));
		m_opsHash.put ( "offer_change", Integer.valueOf(16));
		m_opsHash.put ( "validate_qos", Integer.valueOf(17));
		m_opsHash.put ( "_get_MyChannel", Integer.valueOf(18));
	...
	public org.omg.CosNotifyChannelAdmin.SupplierAdmin _this()
	{
		...
		org.omg.CosNotifyChannelAdmin.SupplierAdmin __r = org.omg.CosNotifyChannelAdmin.SupplierAdminHelper.narrow(__o);
		return __r;
	}
