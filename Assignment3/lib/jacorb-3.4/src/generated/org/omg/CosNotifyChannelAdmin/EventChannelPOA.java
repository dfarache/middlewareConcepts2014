	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosNotifyChannelAdmin.EventChannelOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "new_for_suppliers", Integer.valueOf(6));
		...
		m_opsHash.put ( "new_for_consumers", Integer.valueOf(13));
	...
	public org.omg.CosNotifyChannelAdmin.EventChannel _this()
	{
		...
		org.omg.CosNotifyChannelAdmin.EventChannel __r = org.omg.CosNotifyChannelAdmin.EventChannelHelper.narrow(__o);
		return __r;
	}
