	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosNotifyChannelAdmin.ProxyPullConsumerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "connect_any_pull_supplier", Integer.valueOf(2));
		...
		m_opsHash.put ( "disconnect_pull_consumer", Integer.valueOf(8));
	...
	public org.omg.CosNotifyChannelAdmin.ProxyPullConsumer _this()
	{
		...
		org.omg.CosNotifyChannelAdmin.ProxyPullConsumer __r = org.omg.CosNotifyChannelAdmin.ProxyPullConsumerHelper.narrow(__o);
		return __r;
	}
