...
public abstract class ProxyConsumerHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(ProxyConsumerHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:omg.org/CosNotifyChannelAdmin/ProxyConsumer:1.0", "ProxyConsumer");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(org.omg.CosNotifyChannelAdmin._ProxyConsumerStub.class));
	}
	...
	public static org.omg.CosNotifyChannelAdmin.ProxyConsumer narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof org.omg.CosNotifyChannelAdmin.ProxyConsumer)
		{
			return (org.omg.CosNotifyChannelAdmin.ProxyConsumer)obj;
		}
		else if (obj._is_a("IDL:omg.org/CosNotifyChannelAdmin/ProxyConsumer:1.0"))
		{
