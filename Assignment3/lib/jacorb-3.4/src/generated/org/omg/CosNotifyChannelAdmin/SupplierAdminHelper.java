...
public abstract class SupplierAdminHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(SupplierAdminHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:omg.org/CosNotifyChannelAdmin/SupplierAdmin:1.0", "SupplierAdmin");
				}
			}
		}
		return _type;
	...
	{
		return narrow(in.read_Object(org.omg.CosNotifyChannelAdmin._SupplierAdminStub.class));
	}
	...
	public static org.omg.CosNotifyChannelAdmin.SupplierAdmin narrow(final org.omg.CORBA.Object obj)
	{
		...
		else if (obj instanceof org.omg.CosNotifyChannelAdmin.SupplierAdmin)
		{
			return (org.omg.CosNotifyChannelAdmin.SupplierAdmin)obj;
		}
		else if (obj._is_a("IDL:omg.org/CosNotifyChannelAdmin/SupplierAdmin:1.0"))
		{
