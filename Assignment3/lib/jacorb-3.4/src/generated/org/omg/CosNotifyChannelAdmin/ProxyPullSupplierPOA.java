	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosNotifyChannelAdmin.ProxyPullSupplierOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "pull", Integer.valueOf(9));
		m_opsHash.put ( "connect_any_pull_consumer", Integer.valueOf(10));
	...
	public org.omg.CosNotifyChannelAdmin.ProxyPullSupplier _this()
	{
		...
		org.omg.CosNotifyChannelAdmin.ProxyPullSupplier __r = org.omg.CosNotifyChannelAdmin.ProxyPullSupplierHelper.narrow(__o);
		return __r;
	}
