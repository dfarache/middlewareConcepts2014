...
public abstract class AdminNotFoundHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(AdminNotFoundHelper.class)
			{
				if (_type == null)
				{
	...
	public static org.omg.CosNotifyChannelAdmin.AdminNotFound read (final org.omg.CORBA.portable.InputStream in)
	{
		...
		final org.omg.CosNotifyChannelAdmin.AdminNotFound result = new org.omg.CosNotifyChannelAdmin.AdminNotFound(id);
		return result;
	}
