...
public abstract class ReceivedCredentialsHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(ReceivedCredentialsHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:omg.org/SecurityLevel2/ReceivedCredentials:1.0", "ReceivedCredentials");
				}
			}
		}
		return _type;
