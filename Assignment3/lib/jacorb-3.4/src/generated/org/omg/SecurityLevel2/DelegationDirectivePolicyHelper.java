...
public abstract class DelegationDirectivePolicyHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(DelegationDirectivePolicyHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:omg.org/SecurityLevel2/DelegationDirectivePolicy:1.0", "DelegationDirectivePolicy");
				}
			}
		}
		return _type;
