...
public abstract class EstablishTrustPolicyHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(EstablishTrustPolicyHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:omg.org/SecurityLevel2/EstablishTrustPolicy:1.0", "EstablishTrustPolicy");
				}
			}
		}
		return _type;
