...
public abstract class SecureInvocationPolicyHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(SecureInvocationPolicyHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:omg.org/SecurityAdmin/SecureInvocationPolicy:1.0", "SecureInvocationPolicy");
				}
			}
		}
		return _type;
