...
public abstract class DelegationPolicyHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(DelegationPolicyHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:omg.org/SecurityAdmin/DelegationPolicy:1.0", "DelegationPolicy");
				}
			}
		}
		return _type;
