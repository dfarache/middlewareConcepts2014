...
public abstract class DomainAccessPolicyHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(DomainAccessPolicyHelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_interface_tc("IDL:omg.org/SecurityAdmin/DomainAccessPolicy:1.0", "DomainAccessPolicy");
				}
			}
		}
		return _type;
