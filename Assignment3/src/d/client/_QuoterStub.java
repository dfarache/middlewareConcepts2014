	...
	implements Quoter
{
	...
	public final static java.lang.Class _opsClass = QuoterOperations.class;
	public Quote getQuote(java.lang.String quoteInfo) throws Invalid_Stock
	{
		while(true)
		{
			if(! this._is_local())
...
_os.write_string( tmpResult3 );
					_is = _invoke(_os);
					Quote _result = QuoteHelper.read(_is);
					return _result;
				}
				...
				catch( org.omg.CORBA.portable.ApplicationException _ax )
				{
					...
					try
					{
						if( _id.equals("IDL:StockExchange/Invalid_Stock:1.0"))
						{
							throw Invalid_StockHelper.read(_ax.getInputStream());
						}
						else 
						{
