...
public abstract class QuoterPOA extends org.omg.PortableServer.Servant
 implements a.server.QuoterOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // a.server/Quoter/getQuoteByName
       {
         try {
         ...
         } catch (QuoterPackage.InvalidStockName $ex) {
           out = $rh.createExceptionReply ();
           QuoterPackage.InvalidStockNameHelper.write (out, $ex);
         }
         break;
       }

       case 1:  // a.server/Quoter/getQuoteByID
       {
         try {
           ...
           out = $rh.createReply();
           out.write_float ($result);
         } catch (QuoterPackage.InvalidStockID $ex) {
           out = $rh.createExceptionReply ();
           QuoterPackage.InvalidStockIDHelper.write (out, $ex);
         }
         break;
       }
