...
public class _AMI_QuoterHandlerStub
	...
	implements StockExchangeD.AMI_QuoterHandler
{
	/** Serial version UID. */
	private static final long serialVersionUID = 1L;
	private String[] ids = {"IDL:StockExchangeD/AMI_QuoterHandler:1.0","IDL:omg.org/Messaging/ReplyHandler:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = StockExchangeD.AMI_QuoterHandlerOperations.class;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					StockExchangeD.QuoteHelper.write(_os,ami_return_val);
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
